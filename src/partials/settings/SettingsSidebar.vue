        ...
        <router-link v-slot="{ href, navigate, isExactActive }" to="/dashboard/settings/account" custom>
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-slate-600" :class="isExactActive ? 'text-indigo-500' : 'hover:text-slate-700'">My Account</span>
            </a>
          </li>
        </router-link>
        ...
        <router-link v-slot="{ href, navigate, isExactActive }" to="/dashboard/settings/plans" custom>
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-slate-600" :class="isExactActive ? 'text-indigo-500' : 'hover:text-slate-700'">Plans</span>
            </a>
          </li>
        </router-link>
        <router-link v-slot="{ href, navigate, isExactActive }" to="/dashboard/settings/billing" custom>
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-indigo-50'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-slate-600" :class="isExactActive ? 'text-indigo-500' : 'hover:text-slate-700'">Billing & Invoices</span>
            </a>
          </li>
        </router-link>
      </ul>
