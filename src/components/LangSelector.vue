...
<template>
  <div ref="dropdown" class="dropdown">
    <button tabindex="0" class="m-1 btn btn-outline border-gray-300 dark:border-gray-600 btn-sm text-slate-800 dark:text-white">
    ...
    <ul tabindex="0" class="dropdown-content menu dark:bg-base-200 bg-white rounded-box z-1 w-52 p-2 shadow">
