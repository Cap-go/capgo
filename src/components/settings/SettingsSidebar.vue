        ...
        <router-link v-slot="{ href, navigate, isExactActive }" to="/dashboard/settings/account" custom>
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-blue-50 dark:bg-gray-900'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-slate-600 dark:text-white" :class="isExactActive ? 'text-blue-500' : 'hover:text-slate-700 dark:hover:text-slate-300'">Account</span>
            </a>
          </li>
        </router-link>
        <router-link v-slot="{ href, navigate, isExactActive }" to="/dashboard/settings/notifications" custom>
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-blue-50 dark:bg-gray-900'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-slate-600 dark:text-white" :class="isExactActive ? 'text-blue-500' : 'hover:text-slate-700 dark:hover:text-slate-300'">Notifications</span>
            </a>
          </li>
        </router-link>
        <router-link v-if="!isMobile" v-slot="{ href, navigate, isExactActive }" to="/dashboard/settings/plans" custom>
          <li class="mr-0.5 md:mr-0 md:mb-0.5">
            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap" :class="isExactActive && 'bg-blue-50 dark:bg-gray-900'" :href="href" @click="navigate">
              ...
              <span class="text-sm font-medium text-slate-600 dark:text-white" :class="isExactActive ? 'text-blue-500' : 'hover:text-slate-700 dark:hover:text-slate-300'">Plans</span>
            </a>
          </li>
        </router-link>
