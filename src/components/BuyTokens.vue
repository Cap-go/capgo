...
<template>
  <div class="w-full h-full bg-white dark:bg-base-100 border border-gray-200 dark:border-gray-600 flex flex-col rounded-lg shadow-sm">
    <div class="flex flex-col mt-[10%]">
      <div class="flex items-center justify-center h-fit">
        ...
        <component :is="props.icon" class="ml-1 w-6 h-6 text-gray-700 dark:text-gray-300" />
      </div>
