  ...
  <footer class="bg-white">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
        ...
        <div class="px-5 py-2">
          <a href="#" class="text-base text-gray-500 hover:text-gray-900" @click="openChat"> Support </a>
        </div>
      ...
      <div class="mt-8 flex justify-center space-x-6">
        ...
        <a href="https://github.com/Cap-go" target="_blank" alt="Open GitHub" class="text-gray-400 hover:text-gray-500">
