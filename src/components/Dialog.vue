...
<template>
  ...
  >
    <div class="relative h-full max-w-2xl w-full md:h-auto">
      <!-- Modal content -->
      <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
        <!-- Modal header -->
        <div class="flex items-start justify-between border-b rounded-t p-4 dark:border-gray-600">
        ...
        <!-- Modal footer -->
        <div class="flex items-center border-t border-gray-200 rounded-b p-6 space-x-2 dark:border-gray-600">
          <button
