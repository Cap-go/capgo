...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/settings/organization/Credits': RouteRecordInfo<'/settings/organization/Credits', '/settings/organization/Credits', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/settings/organization/Credits.vue': {
      routes: '/settings/organization/Credits'
      views: never
    }
