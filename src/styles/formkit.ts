export default {
  ...
  'global': {
    ...
    // block w-full py-4 pl-10 pr-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-hidden focus:border-muted-blue-600 caret-muted-blue-600
    input: 'appearance-none py-4 w-full bg-transparent focus:outline-hidden focus:ring-0 focus:shadow-none',
    ...
    prefixIcon: 'w-10 flex self-stretch grow-0 shrink-0 rounded-tl rounded-bl [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto',
    suffixIcon: 'w-7 pr-3 flex self-stretch grow-0 shrink-0 [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto',
  },

  // Family styles apply to all inputs that share a common family
  'family:box': {
    decorator: 'block relative h-5 w-5 mr-2 rounded-sm bg-white bg-linear-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-blue-500 text-transparent peer-checked:text-blue-500',
  ...
  'family:button': {
    input: '$reset inline-flex items-center bg-blue-600 text-white text-sm font-normal py-3 px-6 rounded-sm',
    wrapper: 'mb-1',
    prefixIcon: '$reset block w-4 -ml-2 mr-2 stretch',
    suffixIcon: '$reset block w-4 ml-2 stretch',
  },
  'family:dropdown': {
    dropdownWrapper: 'my-2 w-full drop-shadow-lg rounded-sm [&::-webkit-scrollbar]:hidden',
    inner: 'max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 rounded-sm mb-1 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 focus-within:[&>span:first-child]:text-blue-500',
    input: 'w-full px-3 py-2',
    listbox: 'bg-white drop-shadow-lg rounded-sm overflow-hidden',
  ...
  'family:text': {
    inner: 'flex items-center ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 focus-within:[&>label:first-child]:text-blue-500 rounded-sm mb-1',
    input: 'w-full px-3 py-2 border-none text-base dark:text-gray-300 text-gray-700 placeholder-gray-400',
  },
  'family:date': {
    inner: 'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 focus-within:[&>label:first-child]:text-blue-500 rounded-sm mb-1',
  ...
  'color': {
    ...
    input: '$reset appearance-none w-full cursor-pointer border-none rounded-sm p-0 m-0 bg-transparent [&::-webkit-color-swatch-wrapper]:p-0 [&::-webkit-color-swatch]:border-none',
  ...
  'select': {
    inner: 'flex relative items-center rounded-sm mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 focus-within:[&>span:first-child]:text-blue-500',
  ...
  'textarea': {
    inner: 'flex rounded-sm mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:[&>label:first-child]:text-blue-500',
  ...
  'autocomplete': {
    ...
    selection: 'static flex left-0 top-0 right-0 bottom-0 mt-0 mb-2 rounded-sm bg-gray-100',
  },
  'datepicker': {
    inner: 'relative',
    ...
    next: 'ml-auto px-3 py-1 hover:bg-gray-100 hover:rounded-sm col-start-3 col-end-3',
    nextLabel: 'hidden',
    nextIcon: 'flex w-3 select-none [&>svg]:w-full',
    openButton: `
        appearance-none border-0 bg-transparent flex p-0 self-stretch cursor-pointer
        focus-visible:outline-hidden focus-visible:text-white focus-visible:bg-blue-500
      `,
  ...
  'repeater': {
    ...
    fieldset: 'py-4 px-5',
    help: 'mb-2 mt-1.5',
    item: 'flex w-full mb-1 rounded-sm border border-gray-200',
  ...
  'taglist': {
    ...
    tagWrapper: 'mr-1 focus:outline-hidden focus:text-white focus:[&>div]:bg-blue-500 focus:[&>div>button]:text-white',
    tagLabel: 'pl-2 pr-1',
  ...
  'toggle': {
    ...
    track: 'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-blue-500 [&>div:last-child]:peer-checked:left-full [&>div:last-child]:peer-checked:-translate-x-full [&>div:first-child:not(:last-child)]:peer-checked:left-0 [&>div:first-child:not(:last-child)]:peer-checked:translate-x-0',
  ...
  'transferlist': {
    ...
    help: 'pb-2',
    transferlist: 'sm:w-3/5 shadow-md flex flex-col min-h-[350px] max-h-[350px] border rounded-sm overflow-hidden select-none bg-gray-50',
    ...
    transferControls: 'flex sm:flex-col justify-center mx-auto my-2 sm:mx-2 sm:my-auto border rounded-sm',
    transferlistButton: 'text-sm disabled:cursor-not-allowed disabled:bg-gray-200 disabled:opacity-50 first:rounded-l last:rounded-r sm:first:rounded-t sm:last:rounded-b appearance-none p-2 m-0 cursor-pointer h-10 border-none rounded-none bg-gray-50 hover:outline disabled:hover:outline-hidden hover:outline-1 hover:outline-black hover:text-blue-500 disabled:hover:text-current hover:z-10',
    ...
    transferlistSearch: 'flex border rounded-sm items-center',
