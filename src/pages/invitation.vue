      ...
      <div v-if="!isLoading" class="relative max-w-md mx-auto mt-8 md:mt-4 pb-[10vh]">
          ...
          <div class="overflow-hidden bg-white rounded-md shadow-md dark:bg-slate-800">
            <div class="px-4 py-6 text-gray-500 sm:px-8 sm:py-7">
              <div class="space-y-5">
                ...
                <div class="mb-6">
                  <h2 class="mb-3 text-lg font-medium text-center text-gray-700 dark:text-gray-300">Organization</h2>
                  <div class="flex flex-col items-center mb-4">
                    ...
                    <p class="font-medium text-gray-800 dark:text-gray-200">{{ t('organization-name') }}: {{ inviteRow.org_name }}</p>
                    <p class="text-gray-600 dark:text-gray-400">{{ t('your-role-in-org') }}: {{ inviteRow.role.replace('_', ' ') }}</p>
                  </div>
                </div>
                ...
                <div class="mb-6">
                  <h2 class="mb-3 text-lg font-medium text-center text-gray-700 dark:text-gray-300">Your login details</h2>
                  ...
                  <div class="mb-4">
                    ...
                    <div class="mt-3 p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
                      <h3 class="text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Password Requirements:</h3>
                ...
                <div class="mb-4">
                  <div class="flex items-center mb-4">
                    <Toggle :value="acceptTerms" @update:value="acceptTerms = !acceptTerms" class="mr-2" />
                    <span class="text-sm text-gray-700 dark:text-gray-300">
                      {{ t('accept-terms-of-service-and-privacy-policy') }} 
                      <a @click="openTos" class="text-blue-600 hover:underline cursor-pointer">{{ t('terms-of-service') }}</a> 
                      {{ t('and') }} 
                      <a @click="openPrivacy" class="text-blue-600 hover:underline cursor-pointer">{{ t('privacy-policy') }}</a>
                    </span>
                  </div>
                </div>
                ...
                <div class="mb-6">
                  <div class="flex items-center">
                    <Toggle :value="acceptMarketing" @update:value="acceptMarketing = !acceptMarketing" class="mr-2" />
                    <span class="text-sm text-gray-700 dark:text-gray-300">
        ...
        <div v-else>
          <div class="flex flex-col items-center justify-center h-full mt-12">
            <p class="text-xl text-center">{{ t('invitation-page-not-found') }}</p>
            <p class="text-md mt-2 text-center">{{ t('you-can-still-join-capgo') }}</p>
            <p v-if="isError" class="text-md mt-2 text-center">{{ t('error-message-invitation') }}: {{ isError }}</p>
