...
<template>
  <div class="min-h-screen bg-gray-900 text-white camera-modal">
    ...
    <div class="flex items-center justify-between p-4 bg-gray-800">
      <button @click="goBack" class="p-2 rounded-lg hover:bg-gray-700">
        <IconClose class="w-6 h-6" />
      </button>
      <h1 class="text-lg font-semibold">QR Code Scanner</h1>
      <div class="w-10"></div>
    </div>
    ...
    <div class="relative flex-1">
      ...
      <div v-if="isLoading" class="absolute inset-0 bg-black bg-opacity-75 flex flex-col items-center justify-center z-10">
        ...
        <h3 class="text-xl font-semibold mb-2">Downloading Update</h3>
        <p class="text-gray-400 mb-4">{{ Math.round(downloadProgress) }}%</p>
