...
const skippedPlugins: PluginNote[] = [
  ...
  { packageName: '@capgo/capacitor-age-range', reason: 'Requires Apple declared age range entitlement.' },
  { packageName: '@capgo/capacitor-alarm', reason: 'Current iOS AlarmKit bridge does not compile against the installed iOS 26.4 SDK.' },
  { packageName: '@capgo/capacitor-app-attest', reason: 'Requires platform attestation service setup.' },
  { packageName: '@capgo/capacitor-app-tracking-transparency', reason: 'Requires native tracking usage text.' },
  { packageName: '@capgo/capacitor-background-task', reason: 'Requires native background task identifiers and modes.' },
  ...
  { packageName: '@capgo/capacitor-native-biometric', reason: 'Requires native Face ID usage text before identity prompts.' },
  { packageName: '@capgo/native-purchases', reason: 'Requires store billing platform setup and Android billing manifest changes.' },
  { packageName: '@capgo/capacitor-nfc', reason: 'Requires NFC usage text and iOS NFC entitlements.' },
  ...
  { packageName: '@capgo/capacitor-pedometer', reason: 'Requires native motion usage text.' },
  ...
  { packageName: '@capgo/capacitor-pretty-toast', reason: 'Catalog entry is not published as an installable runtime package.' },
  ...
  { packageName: '@capgo/capacitor-speech-recognition', reason: 'Requires speech recognition usage text.' },
  ...
  { packageName: '@capgo/capacitor-widget-kit', reason: 'Requires widget extension and app group setup.' },
