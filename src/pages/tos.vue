...
<template>
  <div class="prose prose-sm m-auto text-left">
    ...
    <ul>
      <li>
        <p>
          ...
          on any electronic device, named Capgo
        </p>
      </li>
      <li>
        <p>
          <strong>Application Store</strong> means the digital distribution service operated and developed
      ...
      <li>
        <p>
          ...
          or &quot;Our&quot; in this Agreement) refers to Digital shift OU, Sepapaja 6, 15551 , Tallinn,
          Estonia.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Free Trial</strong> refers to a limited period of time that may be free when purchasing
          a Subscription.
        </p>
      </li>
      <li>
        <p>
          ...
          made through the Application and subject to these Terms and Conditions and/or the Application Store's
      ...
      <li>
        <p>
          <strong>Subscriptions</strong> refer to the services or access to the Service offered on a subscription
    ...
    <p>
      ...
      and granted at the sole discretion of the Company.
    </p>
    <p>
    ...
    <p>
      ...
      by the Company until the Free Trial has expired. On the last day of the Free Trial period, unless
      You cancelled Your Subscription, You will be automatically charged the applicable Subscription
    ...
    <p>
      More information about how you may be able to manage In-app Purchases using your Device may be set
      out in the Application Store's own terms and conditions or in your Device's Help settings.
    </p>
    <p>
      In-app Purchases can only be consumed within the Application. If you make a In-app Purchase, that
      In-app Purchase cannot be cancelled after you have initiated its download. In-app Purchases cannot
      be redeemed for cash or other consideration or otherwise transferred.
    </p>
    <p>
    ...
    <p>
      ...
      Application Store from where you downloaded the Application and are governed by that Application
    ...
    <p>
      ...
      or alleged to be caused by or in connection with the use of or reliance on any such content, goods
    ...
    <p>
      ...
      shall be limited to the amount actually paid by You through the Service or 100 USD if You haven't
    ...
    <p>
      ...
      the Service, its servers, the content, or e-mails sent from or on behalf of the Company are free
    ...
    <ul>
      <li>
        By visiting this page on our website: <a
          href="https://capgo.app#support"
          rel="external nofollow noopener"
          target="_blank"
        >https://capgo.app#support</a>
      </li>
    </ul>
  </div>
</template>
