...
<template>
  <div class="prose prose-sm m-auto text-left">
    ...
    <ul>
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Disclaimer) refers to Digital Shift OU, 6 sepapaja, 15510 Tallinn.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device named Capgo.</p>
      </li>
    </ul>
    <h2>Disclaimer</h2>
    ...
    <ul>
      <li>By visiting this page on our website: <a href="https://capgo.app#support" rel="external nofollow noopener" target="_blank">https://capgo.app#support</a></li>
    </ul>
  </div>
</template>
