  ...
  <section class="py-12 bg-gray-50 sm:py-16 lg:py-20">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="max-w-2xl mx-auto mt-12 sm:px-10">
        ...
        <div class="bg-gray-200 w-2px h-10 mx-auto" />
        ...
        <div :class="[step < 2 ? 'opacity-30' : '']" class="relative p-5 overflow-hidden bg-white border border-gray-200 rounded-2xl">
          <div class="flex items-start sm:items-center">
            ...
            <p class="ml-6 text-xl font-medium text-gray-900 font-pj">
              ...
              <code class="text-pumpkin-orange-700 text-lg cursor-pointer" @click="copyToast(`npx @capgo/cli@latest login ${app!.key}`, 2)">npx @capgo/cli@latest login <span class="font-bold">[API key]</span></code>
            </p>
          </div>
        </div>
        ...
        <div :class="[step < 3 ? 'opacity-30' : '']" class="relative p-5 overflow-hidden bg-white border border-gray-200 rounded-2xl">
          <div class="flex items-start sm:items-center">
            ...
            <p class="ml-6 text-xl font-medium text-gray-900 font-pj">
              ...
              <code class="text-pumpkin-orange-700 text-lg cursor-pointer" @click="copyToast('npx @capgo/cli@latest add [appId]', 3)">npx @capgo/cli@latest add [appId]</code>
              <br>
          ...
          <div :class="[step < 4 ? 'opacity-30' : '']" class="relative p-5 overflow-hidden bg-white border border-gray-200 rounded-2xl">
            <div class="flex items-start sm:items-center">
              ...
              <p class="ml-6 text-xl font-medium text-gray-900 font-pj">
                ...
                <code class="text-pumpkin-orange-700 text-lg cursor-pointer" @click="copyToast(`npx @capgo/cli@latest upload --channel production`, 3)">npx @capgo/cli@latest upload --channel production</code>
              </p>
            </div>
          </div>
        </div>
