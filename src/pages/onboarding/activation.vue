...
<template>
  ...
  <section class="flex w-full h-full py-10 my-auto overflow-y-scroll lg:py-16 sm:py-8">
        ...
        <div class="overflow-hidden bg-white rounded-md shadow-md">
          <div class="px-4 py-6 sm:px-8 sm:py-7">
            <form @submit.prevent="submit">
              ...
              <button :disabled="isLoading || !form.legal" type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 mt-10 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-muted-blue-700 disabled:bg-muted-blue-50 focus:bg-blue-700 hover:bg-blue-700 focus:outline-none">
                <span v-if="!isLoading">
