...
import { availableLocales, i18n, loadLanguageAsync, languages } from '~/modules/i18n'
      ...
      <div class="p-6 space-y-6">
        ...
        <section class="flex flex-col md:flex-row md:items-center items-left">
          ...
          <div class="md:ml-6">
            ...
            <!-- Dropdown menu -->
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 h-72 overflow-y-scroll">
