...
--     s.storage_added AS storage_added,
--     s.storage_deleted AS storage_deleted
--     FROM mau m
--     INNER JOIN logs_daily l ON m.date = l.date AND m.app_id = l.app_id
--     INNER JOIN app_storage_daily s ON l.date = s.date AND l.app_id = s.app_id)'
--   );
