...
ALTER FUNCTION "public"."apikey_permission_for_keymode"("keymode" "public"."key_mode"[], "scope_type" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."app_versions_has_app_permission"("p_min_right" "public"."user_min_right", "p_owner_org" "uuid", "p_app_id" character varying, "p_user_id" "uuid", "p_apikey" "text") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."app_versions_has_app_permission"("p_min_right" "public"."user_min_right", "p_owner_org" "uuid", "p_app_id" character varying, "p_user_id" "uuid", "p_apikey" "text") IS 'Checks app_versions access for one target app. Used by app_versions RLS write/read paths so broad API keys with many app bindings do not materialize every linked app during bundle upload finalization.';
...
ALTER FUNCTION "public"."rbac_org_role_for_legacy_right"("legacy_right" "public"."user_min_right") OWNER TO "postgres";
...
CREATE POLICY "Allow admin to delete webhooks" ON "public"."webhooks" FOR DELETE TO "authenticated", "anon" USING ("public"."check_min_rights"('admin'::"public"."user_min_right",
CASE
...
CREATE POLICY "Allow admin to insert webhook_deliveries" ON "public"."webhook_deliveries" FOR INSERT TO "authenticated", "anon" WITH CHECK ("public"."check_min_rights"('admin'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
END, "org_id", NULL::character varying, NULL::bigint));
...
CREATE POLICY "Allow admin to insert webhooks" ON "public"."webhooks" FOR INSERT TO "authenticated", "anon" WITH CHECK ("public"."check_min_rights"('admin'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
END, "org_id", NULL::character varying, NULL::bigint));
...
CREATE POLICY "Allow admin to select webhooks" ON "public"."webhooks" FOR SELECT TO "authenticated", "anon" USING ("public"."check_min_rights"('admin'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
END, "org_id", NULL::character varying, NULL::bigint));
...
CREATE POLICY "Allow admin to update webhook_deliveries" ON "public"."webhook_deliveries" FOR UPDATE TO "authenticated", "anon" USING ("public"."check_min_rights"('admin'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
...
CREATE POLICY "Allow admin to update webhooks" ON "public"."webhooks" FOR UPDATE TO "authenticated", "anon" USING ("public"."check_min_rights"('admin'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
END, "org_id", NULL::character varying, NULL::bigint)) WITH CHECK ("public"."check_min_rights"('admin'::"public"."user_min_right",
...
CREATE POLICY "Allow all for auth (super_admin+)" ON "public"."app_versions" FOR DELETE TO "authenticated", "anon" USING ("public"."check_min_rights"('super_admin'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
END, "owner_org", "app_id", NULL::bigint));



CREATE POLICY "Allow all for auth (super_admin+)" ON "public"."apps" FOR DELETE TO "authenticated", "anon" USING ("public"."check_min_rights"('super_admin'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
END, "owner_org", "app_id", NULL::bigint));
...
CREATE POLICY "Allow for auth, api keys (read+)" ON "public"."app_versions" FOR SELECT TO "authenticated", "anon" USING ((((( SELECT "auth"."uid"() AS "uid") IS NOT NULL) OR (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL)) AND (EXISTS ( SELECT 1
   FROM ( SELECT "auth"."uid"() AS "uid",
            "public"."get_apikey_header"() AS "apikey") "identity"
  WHERE ((("identity"."uid" IS NOT NULL) AND "public"."app_versions_has_app_permission"('read'::"public"."user_min_right", "app_versions"."owner_org", "app_versions"."app_id", "identity"."uid", NULL::"text")) OR (("identity"."uid" IS NULL) AND ("identity"."apikey" IS NOT NULL) AND "public"."app_versions_has_app_permission"('read'::"public"."user_min_right", "app_versions"."owner_org", "app_versions"."app_id", NULL::"uuid", "identity"."apikey")))))));
...
CREATE POLICY "Allow insert for api keys (write,all,upload) (upload+)" ON "public"."app_versions" FOR INSERT TO "anon" WITH CHECK ((EXISTS ( SELECT 1
   FROM ( SELECT "public"."get_apikey_header"() AS "apikey") "identity"
  WHERE (("identity"."apikey" IS NOT NULL) AND "public"."app_versions_has_app_permission"('upload'::"public"."user_min_right", "app_versions"."owner_org", "app_versions"."app_id", NULL::"uuid", "identity"."apikey")))));



CREATE POLICY "Allow insert for apikey (write,all) (admin+)" ON "public"."apps" FOR INSERT TO "authenticated", "anon" WITH CHECK ("public"."rbac_check_permission_request"("public"."rbac_perm_org_create_app"(), "owner_org", NULL::character varying, NULL::bigint));



CREATE POLICY "Allow insert for auth (write+)" ON "public"."channel_devices" FOR INSERT TO "authenticated" WITH CHECK ("public"."check_min_rights"('write'::"public"."user_min_right", ( SELECT "auth"."uid"() AS "uid"), "owner_org", "app_id", NULL::bigint));
...
CREATE POLICY "Allow org members to select webhook_deliveries" ON "public"."webhook_deliveries" FOR SELECT TO "authenticated", "anon" USING ("public"."check_min_rights"('read'::"public"."user_min_right",
CASE
    WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
    ELSE ( SELECT "auth"."uid"() AS "uid")
END, "org_id", NULL::character varying, NULL::bigint));
...
CREATE POLICY "Allow owner to update own apikeys" ON "public"."apikeys" FOR UPDATE TO "authenticated", "anon" USING (("user_id" = ( SELECT "public"."get_identity_for_apikey_creation"() AS "get_identity_for_apikey_creation"))) WITH CHECK (("user_id" = ( SELECT "public"."get_identity_for_apikey_creation"() AS "get_identity_for_apikey_creation")));
...
CREATE POLICY "Allow read for auth (read+)" ON "public"."daily_bandwidth" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."apps"
  WHERE ((("apps"."app_id")::"text" = ("daily_bandwidth"."app_id")::"text") AND "public"."check_min_rights"('read'::"public"."user_min_right",
        CASE
            WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
            ELSE ( SELECT "auth"."uid"() AS "uid")
        END, "apps"."owner_org", "daily_bandwidth"."app_id", NULL::bigint)))));



CREATE POLICY "Allow read for auth (read+)" ON "public"."daily_mau" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."apps"
  WHERE ((("apps"."app_id")::"text" = ("daily_mau"."app_id")::"text") AND "public"."check_min_rights"('read'::"public"."user_min_right",
        CASE
            WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
            ELSE ( SELECT "auth"."uid"() AS "uid")
        END, "apps"."owner_org", "daily_mau"."app_id", NULL::bigint)))));



CREATE POLICY "Allow read for auth (read+)" ON "public"."daily_storage" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."apps"
  WHERE ((("apps"."app_id")::"text" = ("daily_storage"."app_id")::"text") AND "public"."check_min_rights"('read'::"public"."user_min_right",
        CASE
            WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
            ELSE ( SELECT "auth"."uid"() AS "uid")
        END, "apps"."owner_org", "daily_storage"."app_id", NULL::bigint)))));



CREATE POLICY "Allow read for auth (read+)" ON "public"."daily_storage_hourly" FOR SELECT TO "authenticated", "anon" USING ("public"."check_min_rights"('read'::"public"."user_min_right", "public"."get_identity_org_appid"('{read,upload,write,all}'::"public"."key_mode"[], "owner_org", "app_id"), "owner_org", "app_id", NULL::bigint));



CREATE POLICY "Allow read for auth (read+)" ON "public"."daily_version" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."apps"
  WHERE ((("apps"."app_id")::"text" = ("daily_version"."app_id")::"text") AND "public"."check_min_rights"('read'::"public"."user_min_right",
        CASE
            WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
            ELSE ( SELECT "auth"."uid"() AS "uid")
        END, "apps"."owner_org", "daily_version"."app_id", NULL::bigint)))));



CREATE POLICY "Allow read for auth (read+)" ON "public"."stats" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."apps"
  WHERE ((("apps"."app_id")::"text" = ("stats"."app_id")::"text") AND "public"."check_min_rights"('read'::"public"."user_min_right",
        CASE
            WHEN (( SELECT "public"."get_apikey_header"() AS "get_apikey_header") IS NOT NULL) THEN NULL::"uuid"
            ELSE ( SELECT "auth"."uid"() AS "uid")
        END, "apps"."owner_org", "stats"."app_id", NULL::bigint)))));
...
CREATE POLICY "Allow select for auth, api keys (read+)" ON "public"."manifest" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "public"."app_versions" "av"
...
CREATE POLICY "Allow select for auth, api keys (super_admin+)" ON "public"."audit_logs" FOR SELECT TO "authenticated", "anon" USING (("org_id" = ANY (COALESCE(( SELECT "public"."audit_logs_allowed_orgs"() AS "audit_logs_allowed_orgs"), '{}'::"uuid"[]))));
...
CREATE POLICY "Allow update for auth and api keys" ON "public"."app_versions" FOR UPDATE TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM ( SELECT "auth"."uid"() AS "uid",
            "public"."get_apikey_header"() AS "apikey") "identity"
  WHERE ((("identity"."uid" IS NOT NULL) AND "public"."app_versions_has_app_permission"('write'::"public"."user_min_right", "app_versions"."owner_org", "app_versions"."app_id", "identity"."uid", NULL::"text")) OR (("identity"."uid" IS NULL) AND ("identity"."apikey" IS NOT NULL) AND "public"."app_versions_has_app_permission"('upload'::"public"."user_min_right", "app_versions"."owner_org", "app_versions"."app_id", NULL::"uuid", "identity"."apikey")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ( SELECT "auth"."uid"() AS "uid",
            "public"."get_apikey_header"() AS "apikey") "identity"
  WHERE ((("identity"."uid" IS NOT NULL) AND "public"."app_versions_has_app_permission"('write'::"public"."user_min_right", "app_versions"."owner_org", "app_versions"."app_id", "identity"."uid", NULL::"text")) OR (("identity"."uid" IS NULL) AND ("identity"."apikey" IS NOT NULL) AND "public"."app_versions_has_app_permission"('upload'::"public"."user_min_right", "app_versions"."owner_org", "app_versions"."app_id", NULL::"uuid", "identity"."apikey"))))));
...
CREATE POLICY "Prevent users from updating manifest entries" ON "public"."manifest" AS RESTRICTIVE FOR UPDATE TO "authenticated", "anon" USING (false) WITH CHECK (false);
...
CREATE POLICY "compatibility_events_deny_delete" ON "public"."compatibility_events" AS RESTRICTIVE FOR DELETE TO "authenticated", "anon" USING (false);



CREATE POLICY "compatibility_events_deny_insert" ON "public"."compatibility_events" AS RESTRICTIVE FOR INSERT TO "authenticated", "anon" WITH CHECK (false);



CREATE POLICY "compatibility_events_deny_update" ON "public"."compatibility_events" AS RESTRICTIVE FOR UPDATE TO "authenticated", "anon" USING (false) WITH CHECK (false);
...
REVOKE ALL ON FUNCTION "public"."apikey_permission_for_keymode"("keymode" "public"."key_mode"[], "scope_type" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."apikey_permission_for_keymode"("keymode" "public"."key_mode"[], "scope_type" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."apikey_permission_for_keymode"("keymode" "public"."key_mode"[], "scope_type" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."apikey_permission_for_keymode"("keymode" "public"."key_mode"[], "scope_type" "text") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."app_versions_has_app_permission"("p_min_right" "public"."user_min_right", "p_owner_org" "uuid", "p_app_id" character varying, "p_user_id" "uuid", "p_apikey" "text") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."get_identity"("keymode" "public"."key_mode"[]) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."get_identity_org_allowed_apikey_only"("keymode" "public"."key_mode"[], "org_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_identity_org_allowed_apikey_only"("keymode" "public"."key_mode"[], "org_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_identity_org_appid"("keymode" "public"."key_mode"[], "org_id" "uuid", "app_id" character varying) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."has_app_right_apikey"("appid" character varying, "right" "public"."user_min_right", "userid" "uuid", "apikey" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."is_allowed_capgkey"("apikey" "text", "keymode" "public"."key_mode"[]) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."is_allowed_capgkey"("apikey" "text", "keymode" "public"."key_mode"[], "app_id" character varying) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rbac_org_role_for_legacy_right"("legacy_right" "public"."user_min_right") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."rbac_org_role_for_legacy_right"("legacy_right" "public"."user_min_right") TO "service_role";
...
GRANT ALL ON TABLE "public"."compatibility_events" TO "anon";
GRANT ALL ON TABLE "public"."compatibility_events" TO "authenticated";
GRANT ALL ON TABLE "public"."compatibility_events" TO "service_role";
...
CREATE OR REPLACE TRIGGER "trg_enforce_email_otp_for_mfa" BEFORE INSERT OR UPDATE ON "auth"."mfa_factors" FOR EACH ROW EXECUTE FUNCTION "public"."enforce_email_otp_for_mfa"();
...
CREATE POLICY "Allow user or apikey to delete they own folder in images" ON "storage"."objects" FOR DELETE TO "authenticated", "anon" USING ((("bucket_id" = 'images'::"text") AND (
CASE
...
CREATE POLICY "Allow user or apikey to insert they own folder in images" ON "storage"."objects" FOR INSERT TO "authenticated", "anon" WITH CHECK ((("bucket_id" = 'images'::"text") AND (
CASE
...
CREATE POLICY "Allow user or apikey to read they own folder in images" ON "storage"."objects" FOR SELECT TO "authenticated", "anon" USING ((("bucket_id" = 'images'::"text") AND ((("storage"."foldername"("name"))[1] = 'public'::"text") OR
CASE
...
CREATE POLICY "Allow user or apikey to update they own folder in images" ON "storage"."objects" FOR UPDATE TO "authenticated", "anon" USING ((("bucket_id" = 'images'::"text") AND (
CASE
    WHEN ((("storage"."foldername"("name"))[1] = 'org'::"text") AND (("storage"."foldername"("name"))[3] IS NOT NULL) AND (("storage"."foldername"("name"))[3] <> 'logo'::"text")) THEN "public"."check_min_rights"('write'::"public"."user_min_right", "public"."get_identity_org_appid"('{write,all}'::"public"."key_mode"[], (("storage"."foldername"("name"))[2])::"uuid", (("storage"."foldername"("name"))[3])::character varying), (("storage"."foldername"("name"))[2])::"uuid", (("storage"."foldername"("name"))[3])::character varying, NULL::bigint)
    ELSE false
END OR ((("storage"."foldername"("name"))[1] = 'org'::"text") AND (("storage"."foldername"("name"))[3] = 'logo'::"text") AND "public"."check_min_rights"('write'::"public"."user_min_right", "public"."get_identity_org_allowed"('{write,all}'::"public"."key_mode"[], (("storage"."foldername"("name"))[2])::"uuid"), (("storage"."foldername"("name"))[2])::"uuid", NULL::character varying, NULL::bigint)) OR (EXISTS ( SELECT 1
...
--
-- ACL parity from historical migrations.
-- Supabase migration squash restores schema, but public/default ACL changes
...
REVOKE ALL ON FUNCTION public.accept_invitation_to_org(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.accept_invitation_to_org(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.accept_invitation_to_org(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.accept_invitation_to_org(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.acknowledge_compatibility_event(bigint,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.acknowledge_compatibility_event(bigint,text) FROM "anon";
REVOKE ALL ON FUNCTION public.acknowledge_compatibility_event(bigint,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.acknowledge_compatibility_event(bigint,text) FROM "service_role";
GRANT ALL ON FUNCTION public.acknowledge_compatibility_event(bigint,text) TO "authenticated";
GRANT ALL ON FUNCTION public.acknowledge_compatibility_event(bigint,text) TO "service_role";

REVOKE ALL ON FUNCTION public.apikey_has_current_org_create_capability(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.apikey_has_current_org_create_capability(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.apikey_has_current_org_create_capability(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.apikey_has_current_org_create_capability(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.apikey_has_current_org_create_capability(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.apikey_has_global_permission(text,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.apikey_has_global_permission(text,text) FROM "anon";
REVOKE ALL ON FUNCTION public.apikey_has_global_permission(text,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.apikey_has_global_permission(text,text) FROM "service_role";
GRANT ALL ON FUNCTION public.apikey_has_global_permission(text,text) TO "service_role";

REVOKE ALL ON FUNCTION public.apikeys_force_server_key() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.apikeys_force_server_key() FROM "anon";
REVOKE ALL ON FUNCTION public.apikeys_force_server_key() FROM "authenticated";
REVOKE ALL ON FUNCTION public.apikeys_force_server_key() FROM "service_role";
GRANT ALL ON FUNCTION public.apikeys_force_server_key() TO "service_role";

REVOKE ALL ON FUNCTION public.apikeys_strip_plain_key_for_hashed() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.apikeys_strip_plain_key_for_hashed() FROM "anon";
REVOKE ALL ON FUNCTION public.apikeys_strip_plain_key_for_hashed() FROM "authenticated";
REVOKE ALL ON FUNCTION public.apikeys_strip_plain_key_for_hashed() FROM "service_role";
GRANT ALL ON FUNCTION public.apikeys_strip_plain_key_for_hashed() TO "service_role";

REVOKE ALL ON FUNCTION public.apply_usage_overage(uuid,public.credit_metric_type,numeric,timestamp with time zone,timestamp with time zone,jsonb) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.apply_usage_overage(uuid,public.credit_metric_type,numeric,timestamp with time zone,timestamp with time zone,jsonb) FROM "anon";
REVOKE ALL ON FUNCTION public.apply_usage_overage(uuid,public.credit_metric_type,numeric,timestamp with time zone,timestamp with time zone,jsonb) FROM "authenticated";
REVOKE ALL ON FUNCTION public.apply_usage_overage(uuid,public.credit_metric_type,numeric,timestamp with time zone,timestamp with time zone,jsonb) FROM "service_role";
GRANT ALL ON FUNCTION public.apply_usage_overage(uuid,public.credit_metric_type,numeric,timestamp with time zone,timestamp with time zone,jsonb) TO "service_role";
...
REVOKE ALL ON FUNCTION public.bind_creating_apikey_to_org_on_create() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.bind_creating_apikey_to_org_on_create() FROM "anon";
REVOKE ALL ON FUNCTION public.bind_creating_apikey_to_org_on_create() FROM "authenticated";
REVOKE ALL ON FUNCTION public.bind_creating_apikey_to_org_on_create() FROM "service_role";
GRANT ALL ON FUNCTION public.bind_creating_apikey_to_org_on_create() TO "service_role";

REVOKE ALL ON FUNCTION public.calculate_credit_cost(public.credit_metric_type,numeric) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.calculate_credit_cost(public.credit_metric_type,numeric) FROM "anon";
REVOKE ALL ON FUNCTION public.calculate_credit_cost(public.credit_metric_type,numeric) FROM "authenticated";
REVOKE ALL ON FUNCTION public.calculate_credit_cost(public.credit_metric_type,numeric) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.check_apikey_hashed_key_enforcement(public.apikeys) FROM "anon";
REVOKE ALL ON FUNCTION public.check_apikey_hashed_key_enforcement(public.apikeys) FROM "authenticated";
REVOKE ALL ON FUNCTION public.check_apikey_hashed_key_enforcement(public.apikeys) FROM "service_role";
GRANT ALL ON FUNCTION public.check_apikey_hashed_key_enforcement(public.apikeys) TO "service_role";

REVOKE ALL ON FUNCTION public.check_encrypted_bundle_on_insert() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.check_encrypted_bundle_on_insert() FROM "anon";
REVOKE ALL ON FUNCTION public.check_encrypted_bundle_on_insert() FROM "authenticated";
REVOKE ALL ON FUNCTION public.check_encrypted_bundle_on_insert() FROM "service_role";
GRANT ALL ON FUNCTION public.check_encrypted_bundle_on_insert() TO "service_role";
...
REVOKE ALL ON FUNCTION public.check_min_rights_legacy_no_password_policy(public.user_min_right,uuid,uuid,character varying,bigint) FROM "service_role";
GRANT ALL ON FUNCTION public.check_min_rights_legacy_no_password_policy(public.user_min_right,uuid,uuid,character varying,bigint) TO "service_role";

REVOKE ALL ON FUNCTION public.check_org_hashed_key_enforcement(uuid,public.apikeys) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.check_org_hashed_key_enforcement(uuid,public.apikeys) FROM "anon";
REVOKE ALL ON FUNCTION public.check_org_hashed_key_enforcement(uuid,public.apikeys) FROM "authenticated";
REVOKE ALL ON FUNCTION public.check_org_hashed_key_enforcement(uuid,public.apikeys) FROM "service_role";
GRANT ALL ON FUNCTION public.check_org_hashed_key_enforcement(uuid,public.apikeys) TO "service_role";
...
REVOKE ALL ON FUNCTION public.check_org_members_2fa_enabled(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.check_org_members_2fa_enabled(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.check_org_members_2fa_enabled(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.check_org_members_2fa_enabled(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.check_org_members_password_policy(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.check_org_members_password_policy(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.check_org_members_password_policy(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.check_org_members_password_policy(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.claim_legacy_onboarding_demo_data(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.claim_legacy_onboarding_demo_data(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.cleanup_apikey_role_bindings() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.cleanup_apikey_role_bindings() FROM "anon";
REVOKE ALL ON FUNCTION public.cleanup_apikey_role_bindings() FROM "authenticated";
REVOKE ALL ON FUNCTION public.cleanup_apikey_role_bindings() FROM "service_role";
GRANT ALL ON FUNCTION public.cleanup_apikey_role_bindings() TO "service_role";
...
REVOKE ALL ON FUNCTION public.cleanup_expired_demo_apps() FROM "service_role";
GRANT ALL ON FUNCTION public.cleanup_expired_demo_apps() TO "service_role";
...
REVOKE ALL ON FUNCTION public.cleanup_onboarding_app_data_on_complete() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.cleanup_onboarding_app_data_on_complete() FROM "anon";
REVOKE ALL ON FUNCTION public.cleanup_onboarding_app_data_on_complete() FROM "authenticated";
REVOKE ALL ON FUNCTION public.cleanup_onboarding_app_data_on_complete() FROM "service_role";
GRANT ALL ON FUNCTION public.cleanup_onboarding_app_data_on_complete() TO "service_role";
...
REVOKE ALL ON FUNCTION public.cleanup_tmp_users() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.cleanup_tmp_users() FROM "anon";
REVOKE ALL ON FUNCTION public.cleanup_tmp_users() FROM "authenticated";
REVOKE ALL ON FUNCTION public.cleanup_tmp_users() FROM "service_role";
GRANT ALL ON FUNCTION public.cleanup_tmp_users() TO "service_role";
...
REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid,bigint) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid,bigint) FROM "anon";
REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid,bigint) FROM "authenticated";
REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid,bigint) FROM "service_role";
GRANT ALL ON FUNCTION public.clear_onboarding_app_data(uuid,bigint) TO "service_role";

REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.clear_onboarding_app_data(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.clear_onboarding_app_data(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.count_all_need_upgrade() FROM "service_role";
GRANT ALL ON FUNCTION public.count_all_need_upgrade() TO "service_role";
...
REVOKE ALL ON FUNCTION public.count_all_onboarded() FROM "service_role";
GRANT ALL ON FUNCTION public.count_all_onboarded() TO "service_role";
...
REVOKE ALL ON FUNCTION public.count_all_plans_v2() FROM "service_role";
GRANT ALL ON FUNCTION public.count_all_plans_v2() TO "service_role";

REVOKE ALL ON FUNCTION public.count_non_compliant_bundles(uuid,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.count_non_compliant_bundles(uuid,text) FROM "anon";
REVOKE ALL ON FUNCTION public.count_non_compliant_bundles(uuid,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.count_non_compliant_bundles(uuid,text) FROM "service_role";
GRANT ALL ON FUNCTION public.count_non_compliant_bundles(uuid,text) TO "authenticated";
GRANT ALL ON FUNCTION public.count_non_compliant_bundles(uuid,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.delete_accounts_marked_for_deletion() FROM "service_role";
GRANT ALL ON FUNCTION public.delete_accounts_marked_for_deletion() TO "service_role";

REVOKE ALL ON FUNCTION public.delete_group_with_bindings(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.delete_group_with_bindings(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.delete_group_with_bindings(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.delete_group_with_bindings(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.delete_group_with_bindings(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.delete_group_with_bindings(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.delete_http_response(bigint) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.delete_http_response(bigint) FROM "anon";
REVOKE ALL ON FUNCTION public.delete_http_response(bigint) FROM "authenticated";
REVOKE ALL ON FUNCTION public.delete_http_response(bigint) FROM "service_role";

REVOKE ALL ON FUNCTION public.delete_non_compliant_bundles(uuid,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.delete_non_compliant_bundles(uuid,text) FROM "anon";
REVOKE ALL ON FUNCTION public.delete_non_compliant_bundles(uuid,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.delete_non_compliant_bundles(uuid,text) FROM "service_role";
GRANT ALL ON FUNCTION public.delete_non_compliant_bundles(uuid,text) TO "authenticated";
GRANT ALL ON FUNCTION public.delete_non_compliant_bundles(uuid,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.delete_old_deleted_versions() FROM "service_role";
GRANT ALL ON FUNCTION public.delete_old_deleted_versions() TO "service_role";
...
REVOKE ALL ON FUNCTION public.delete_org_member_role(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.delete_org_member_role(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.delete_org_member_role(uuid,uuid) TO "authenticated";
...
REVOKE ALL ON FUNCTION public.delete_user() FROM "service_role";
GRANT ALL ON FUNCTION public.delete_user() TO "authenticated";
GRANT ALL ON FUNCTION public.delete_user() TO "service_role";

REVOKE ALL ON FUNCTION public.enforce_apikey_expiration_policy() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.enforce_apikey_expiration_policy() FROM "anon";
REVOKE ALL ON FUNCTION public.enforce_apikey_expiration_policy() FROM "authenticated";
REVOKE ALL ON FUNCTION public.enforce_apikey_expiration_policy() FROM "service_role";
GRANT ALL ON FUNCTION public.enforce_apikey_expiration_policy() TO "service_role";

REVOKE ALL ON FUNCTION public.enforce_apikey_role_binding_expiration_policy() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.enforce_apikey_role_binding_expiration_policy() FROM "anon";
REVOKE ALL ON FUNCTION public.enforce_apikey_role_binding_expiration_policy() FROM "authenticated";
REVOKE ALL ON FUNCTION public.enforce_apikey_role_binding_expiration_policy() FROM "service_role";
GRANT ALL ON FUNCTION public.enforce_apikey_role_binding_expiration_policy() TO "service_role";

REVOKE ALL ON FUNCTION public.enforce_channel_version_promotion_permission() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.enforce_channel_version_promotion_permission() FROM "anon";
REVOKE ALL ON FUNCTION public.enforce_channel_version_promotion_permission() FROM "authenticated";
REVOKE ALL ON FUNCTION public.enforce_channel_version_promotion_permission() FROM "service_role";
GRANT ALL ON FUNCTION public.enforce_channel_version_promotion_permission() TO "service_role";
...
REVOKE ALL ON FUNCTION public.find_apikey_by_value(text) FROM "anon";
REVOKE ALL ON FUNCTION public.find_apikey_by_value(text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.find_apikey_by_value(text) FROM "service_role";
GRANT ALL ON FUNCTION public.find_apikey_by_value(text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.generate_org_user_stripe_info_on_org_create() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.generate_org_user_stripe_info_on_org_create() FROM "anon";
REVOKE ALL ON FUNCTION public.generate_org_user_stripe_info_on_org_create() FROM "authenticated";
REVOKE ALL ON FUNCTION public.generate_org_user_stripe_info_on_org_create() FROM "service_role";
GRANT ALL ON FUNCTION public.generate_org_user_stripe_info_on_org_create() TO "service_role";

REVOKE ALL ON FUNCTION public.get_account_removal_date() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_account_removal_date() FROM "anon";
REVOKE ALL ON FUNCTION public.get_account_removal_date() FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_account_removal_date() FROM "service_role";
GRANT ALL ON FUNCTION public.get_account_removal_date() TO "authenticated";
GRANT ALL ON FUNCTION public.get_account_removal_date() TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_apikey() FROM "service_role";
GRANT ALL ON FUNCTION public.get_apikey() TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_app_access_rbac(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_app_access_rbac(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_app_access_rbac(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.get_app_access_rbac(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_app_metrics(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_app_metrics(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_app_metrics(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.get_app_metrics(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_current_plan_max_org(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_current_plan_max_org(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_current_plan_name_org(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_current_plan_name_org(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_cycle_info_org(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_cycle_info_org(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_identity_apikey_only(public.key_mode[]) FROM "anon";
REVOKE ALL ON FUNCTION public.get_identity_apikey_only(public.key_mode[]) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_identity_apikey_only(public.key_mode[]) FROM "service_role";
GRANT ALL ON FUNCTION public.get_identity_apikey_only(public.key_mode[]) TO "service_role";

REVOKE ALL ON FUNCTION public.get_identity_org_allowed_apikey_only(public.key_mode[],uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_identity_org_allowed_apikey_only(public.key_mode[],uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.get_identity_org_allowed_apikey_only(public.key_mode[],uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_identity_org_allowed_apikey_only(public.key_mode[],uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_identity_org_allowed_apikey_only(public.key_mode[],uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_org_apikeys(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_org_apikeys(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.get_org_apikeys(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_org_members_rbac(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_org_members_rbac(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_org_members_rbac(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.get_org_members_rbac(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_org_members(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_org_members(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_org_members(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.get_org_members(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_org_perm_for_apikey_v2(text,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_org_perm_for_apikey_v2(text,text) FROM "service_role";
GRANT ALL ON FUNCTION public.get_org_perm_for_apikey_v2(text,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_org_perm_for_apikey(text,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_org_perm_for_apikey(text,text) FROM "service_role";
GRANT ALL ON FUNCTION public.get_org_perm_for_apikey(text,text) TO "authenticated";
GRANT ALL ON FUNCTION public.get_org_perm_for_apikey(text,text) TO "service_role";

REVOKE ALL ON FUNCTION public.get_org_user_access_rbac(uuid,uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_org_user_access_rbac(uuid,uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.get_org_user_access_rbac(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_org_user_access_rbac(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_org_user_access_rbac(uuid,uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.get_org_user_access_rbac(uuid,uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_orgs_v6(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_orgs_v7(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_orgs_v7(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.get_owner_org_by_app_id_internal(text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_owner_org_by_app_id_internal(text) FROM "anon";
REVOKE ALL ON FUNCTION public.get_owner_org_by_app_id_internal(text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_owner_org_by_app_id_internal(text) FROM "service_role";
GRANT ALL ON FUNCTION public.get_owner_org_by_app_id_internal(text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_plan_usage_and_fit_uncached(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_plan_usage_and_fit(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_plan_usage_percent_detailed(uuid,date,date) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_plan_usage_percent_detailed(uuid,date,date) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_plan_usage_percent_detailed(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_plan_usage_percent_detailed(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_total_metrics() FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_total_metrics() FROM "service_role";
GRANT ALL ON FUNCTION public.get_total_metrics() TO "authenticated";
GRANT ALL ON FUNCTION public.get_total_metrics() TO "service_role";
...
REVOKE ALL ON FUNCTION public.get_total_metrics(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.get_user_id(text,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_user_id(text,text) FROM "service_role";
GRANT ALL ON FUNCTION public.get_user_id(text,text) TO "authenticated";
GRANT ALL ON FUNCTION public.get_user_id(text,text) TO "service_role";

REVOKE ALL ON FUNCTION public.get_user_id(text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_user_id(text) FROM "anon";
REVOKE ALL ON FUNCTION public.get_user_id(text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_user_id(text) FROM "service_role";
GRANT ALL ON FUNCTION public.get_user_id(text) TO "authenticated";
GRANT ALL ON FUNCTION public.get_user_id(text) TO "service_role";

REVOKE ALL ON FUNCTION public.get_user_main_org_id(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_user_main_org_id(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.get_user_main_org_id(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.get_user_main_org_id(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.get_user_main_org_id(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.get_user_main_org_id(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.has_2fa_enabled(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.has_2fa_enabled(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.has_2fa_enabled(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.has_2fa_enabled(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.has_2fa_enabled(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.has_seeded_demo_data(text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.has_seeded_demo_data(text) FROM "anon";
REVOKE ALL ON FUNCTION public.has_seeded_demo_data(text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.has_seeded_demo_data(text) FROM "service_role";
GRANT ALL ON FUNCTION public.has_seeded_demo_data(text) TO "service_role";

REVOKE ALL ON FUNCTION public.internal_request_db_user_names() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.internal_request_db_user_names() FROM "anon";
REVOKE ALL ON FUNCTION public.internal_request_db_user_names() FROM "authenticated";
REVOKE ALL ON FUNCTION public.internal_request_db_user_names() FROM "service_role";
GRANT ALL ON FUNCTION public.internal_request_db_user_names() TO "service_role";

REVOKE ALL ON FUNCTION public.internal_request_role_names() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.internal_request_role_names() FROM "anon";
REVOKE ALL ON FUNCTION public.internal_request_role_names() FROM "authenticated";
REVOKE ALL ON FUNCTION public.internal_request_role_names() FROM "service_role";
GRANT ALL ON FUNCTION public.internal_request_role_names() TO "service_role";

REVOKE ALL ON FUNCTION public.is_account_disabled(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.is_account_disabled(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.is_account_disabled(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.is_account_disabled(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.is_account_disabled(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.is_account_disabled(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.is_internal_request_role(text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.is_internal_request_role(text) FROM "anon";
REVOKE ALL ON FUNCTION public.is_internal_request_role(text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.is_internal_request_role(text) FROM "service_role";
GRANT ALL ON FUNCTION public.is_internal_request_role(text) TO "service_role";

REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[],character varying) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[],character varying) FROM "anon";
REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[],character varying) FROM "authenticated";
REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[],character varying) FROM "service_role";
GRANT ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[],character varying) TO "authenticated";
GRANT ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[],character varying) TO "service_role";

REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[]) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[]) FROM "anon";
REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[]) FROM "authenticated";
REVOKE ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[]) FROM "service_role";
GRANT ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[]) TO "authenticated";
GRANT ALL ON FUNCTION public.is_paying_and_good_plan_org_action(uuid,public.action_type[]) TO "service_role";
...
GRANT ALL ON FUNCTION public.is_platform_admin(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.is_user_app_admin(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.is_user_app_admin(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.is_user_app_admin(uuid,uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.is_user_app_admin(uuid,uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.is_user_org_admin(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.is_user_org_admin(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.is_user_org_admin(uuid,uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.is_user_org_admin(uuid,uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.mark_app_stats_refreshed(character varying) FROM "service_role";
GRANT ALL ON FUNCTION public.mark_app_stats_refreshed(character varying) TO "service_role";

REVOKE ALL ON FUNCTION public.mass_edit_queue_messages_cf_ids(public.message_update[]) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.mass_edit_queue_messages_cf_ids(public.message_update[]) FROM "anon";
REVOKE ALL ON FUNCTION public.mass_edit_queue_messages_cf_ids(public.message_update[]) FROM "authenticated";
REVOKE ALL ON FUNCTION public.mass_edit_queue_messages_cf_ids(public.message_update[]) FROM "service_role";

REVOKE ALL ON FUNCTION public.modify_permissions_tmp(text,uuid,public.user_min_right) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.modify_permissions_tmp(text,uuid,public.user_min_right) FROM "anon";
REVOKE ALL ON FUNCTION public.modify_permissions_tmp(text,uuid,public.user_min_right) FROM "authenticated";
REVOKE ALL ON FUNCTION public.modify_permissions_tmp(text,uuid,public.user_min_right) FROM "service_role";
GRANT ALL ON FUNCTION public.modify_permissions_tmp(text,uuid,public.user_min_right) TO "authenticated";
GRANT ALL ON FUNCTION public.modify_permissions_tmp(text,uuid,public.user_min_right) TO "service_role";

REVOKE ALL ON FUNCTION public.normalize_public_channel_overlap() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.normalize_public_channel_overlap() FROM "anon";
REVOKE ALL ON FUNCTION public.normalize_public_channel_overlap() FROM "authenticated";
REVOKE ALL ON FUNCTION public.normalize_public_channel_overlap() FROM "service_role";
GRANT ALL ON FUNCTION public.normalize_public_channel_overlap() TO "service_role";

REVOKE ALL ON FUNCTION public.normalize_sso_provider_domain() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.normalize_sso_provider_domain() FROM "anon";
REVOKE ALL ON FUNCTION public.normalize_sso_provider_domain() FROM "authenticated";
REVOKE ALL ON FUNCTION public.normalize_sso_provider_domain() FROM "service_role";
GRANT ALL ON FUNCTION public.normalize_sso_provider_domain() TO "service_role";
...
REVOKE ALL ON FUNCTION public.pg_log(text,jsonb) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.pg_log(text,jsonb) FROM "anon";
REVOKE ALL ON FUNCTION public.pg_log(text,jsonb) FROM "authenticated";
REVOKE ALL ON FUNCTION public.pg_log(text,jsonb) FROM "service_role";

REVOKE ALL ON FUNCTION public.prevent_last_super_admin_binding_delete() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.prevent_last_super_admin_binding_delete() FROM "anon";
REVOKE ALL ON FUNCTION public.prevent_last_super_admin_binding_delete() FROM "authenticated";
REVOKE ALL ON FUNCTION public.prevent_last_super_admin_binding_delete() FROM "service_role";
GRANT ALL ON FUNCTION public.prevent_last_super_admin_binding_delete() TO "service_role";
...
REVOKE ALL ON FUNCTION public.prevent_last_super_admin_binding_update() FROM "service_role";
GRANT ALL ON FUNCTION public.prevent_last_super_admin_binding_update() TO "service_role";
...
REVOKE ALL ON FUNCTION public.process_channel_device_counts_queue(integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.process_channel_device_counts_queue(integer) FROM "anon";
REVOKE ALL ON FUNCTION public.process_channel_device_counts_queue(integer) FROM "authenticated";
REVOKE ALL ON FUNCTION public.process_channel_device_counts_queue(integer) FROM "service_role";
GRANT ALL ON FUNCTION public.process_channel_device_counts_queue(integer) TO "service_role";
...
REVOKE ALL ON FUNCTION public.process_function_queue(text,integer) FROM "anon";
REVOKE ALL ON FUNCTION public.process_function_queue(text,integer) FROM "authenticated";
REVOKE ALL ON FUNCTION public.process_function_queue(text,integer) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.process_queue_with_healthcheck(text[],integer,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.process_queue_with_healthcheck(text[],integer,text) FROM "anon";
REVOKE ALL ON FUNCTION public.process_queue_with_healthcheck(text[],integer,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.process_queue_with_healthcheck(text[],integer,text) FROM "service_role";
GRANT ALL ON FUNCTION public.process_queue_with_healthcheck(text[],integer,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.process_subscribed_orgs() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.process_subscribed_orgs() FROM "anon";
REVOKE ALL ON FUNCTION public.process_subscribed_orgs() FROM "authenticated";
REVOKE ALL ON FUNCTION public.process_subscribed_orgs() FROM "service_role";
GRANT ALL ON FUNCTION public.process_subscribed_orgs() TO "service_role";
...
REVOKE ALL ON FUNCTION public.queue_cron_stat_app_for_app(character varying,uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.queue_cron_stat_org_for_org(uuid,text) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_check_permission_direct_no_password_policy(text,uuid,uuid,character varying,bigint,text) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_check_permission_direct_no_password_policy(text,uuid,uuid,character varying,bigint,text) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_check_permission_direct_no_password_policy(text,uuid,uuid,character varying,bigint,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_check_permission_direct(text,uuid,uuid,character varying,bigint,text) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_check_permission_direct(text,uuid,uuid,character varying,bigint,text) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_check_permission_direct(text,uuid,uuid,character varying,bigint,text) TO "service_role";

REVOKE ALL ON FUNCTION public.rbac_check_permission_no_password_policy(text,uuid,character varying,bigint) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.rbac_check_permission_no_password_policy(text,uuid,character varying,bigint) FROM "anon";
REVOKE ALL ON FUNCTION public.rbac_check_permission_no_password_policy(text,uuid,character varying,bigint) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_check_permission_no_password_policy(text,uuid,character varying,bigint) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_check_permission_no_password_policy(text,uuid,character varying,bigint) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_check_permission_no_password_policy(text,uuid,character varying,bigint) TO "service_role";

REVOKE ALL ON FUNCTION public.rbac_check_permission(text,uuid,character varying,bigint) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.rbac_check_permission(text,uuid,character varying,bigint) FROM "anon";
REVOKE ALL ON FUNCTION public.rbac_check_permission(text,uuid,character varying,bigint) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_check_permission(text,uuid,character varying,bigint) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_check_permission(text,uuid,character varying,bigint) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_check_permission(text,uuid,character varying,bigint) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_enable_for_org(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_enable_for_org(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_enable_for_org(uuid,uuid) TO "service_role";
...
GRANT ALL ON FUNCTION public.rbac_has_permission(text,uuid,text,uuid,character varying,bigint) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_is_enabled_for_org(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_is_enabled_for_org(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_is_enabled_for_org(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_is_enabled_for_org(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_legacy_role_hint(public.user_min_right,character varying,bigint) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_legacy_role_hint(public.user_min_right,character varying,bigint) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_legacy_role_hint(public.user_min_right,character varying,bigint) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_legacy_role_hint(public.user_min_right,character varying,bigint) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_migrate_org_users_to_bindings(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_migrate_org_users_to_bindings(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_migrate_org_users_to_bindings(uuid,uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.rbac_org_role_for_legacy_right(public.user_min_right) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.rbac_org_role_for_legacy_right(public.user_min_right) FROM "anon";
REVOKE ALL ON FUNCTION public.rbac_org_role_for_legacy_right(public.user_min_right) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_org_role_for_legacy_right(public.user_min_right) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_org_role_for_legacy_right(public.user_min_right) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_permission_for_legacy(public.user_min_right,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_permission_for_legacy(public.user_min_right,text) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_permission_for_legacy(public.user_min_right,text) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_permission_for_legacy(public.user_min_right,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_preview_migration(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_preview_migration(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_preview_migration(uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.rbac_preview_migration(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.rbac_rollback_org(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.rbac_rollback_org(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.rbac_rollback_org(uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.reassign_webhook_created_by_before_user_delete() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.reassign_webhook_created_by_before_user_delete() FROM "anon";
REVOKE ALL ON FUNCTION public.reassign_webhook_created_by_before_user_delete() FROM "authenticated";
REVOKE ALL ON FUNCTION public.reassign_webhook_created_by_before_user_delete() FROM "service_role";
GRANT ALL ON FUNCTION public.reassign_webhook_created_by_before_user_delete() TO "service_role";

REVOKE ALL ON FUNCTION public.record_build_time(uuid,uuid,character varying,character varying,bigint,character varying) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.record_build_time(uuid,uuid,character varying,character varying,bigint,character varying) FROM "anon";
REVOKE ALL ON FUNCTION public.record_build_time(uuid,uuid,character varying,character varying,bigint,character varying) FROM "authenticated";
REVOKE ALL ON FUNCTION public.record_build_time(uuid,uuid,character varying,character varying,bigint,character varying) FROM "service_role";
GRANT ALL ON FUNCTION public.record_build_time(uuid,uuid,character varying,character varying,bigint,character varying) TO "service_role";
...
REVOKE ALL ON FUNCTION public.record_email_otp_verified(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.record_email_otp_verified(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.record_email_otp_verified(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.record_email_otp_verified(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.record_email_otp_verified(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.refresh_app_rollups_after_demo_reset(uuid,text,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.refresh_app_rollups_after_demo_reset(uuid,text,uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.refresh_orgs_has_usage_credits() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.refresh_orgs_has_usage_credits() FROM "anon";
REVOKE ALL ON FUNCTION public.refresh_orgs_has_usage_credits() FROM "authenticated";
REVOKE ALL ON FUNCTION public.refresh_orgs_has_usage_credits() FROM "service_role";
GRANT ALL ON FUNCTION public.refresh_orgs_has_usage_credits() TO "service_role";

REVOKE ALL ON FUNCTION public.reject_access_due_to_2fa(uuid,uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.reject_access_due_to_2fa(uuid,uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.reject_access_due_to_2fa(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.reject_access_due_to_2fa(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.reject_access_due_to_2fa(uuid,uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.reject_access_due_to_password_policy(uuid,uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.reject_access_due_to_password_policy(uuid,uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.reject_access_due_to_password_policy(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.reject_access_due_to_password_policy(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.reject_access_due_to_password_policy(uuid,uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.request_app_chart_refresh(character varying) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.request_has_app_read_access(uuid,character varying) FROM "anon";
REVOKE ALL ON FUNCTION public.request_has_app_read_access(uuid,character varying) FROM "authenticated";
REVOKE ALL ON FUNCTION public.request_has_app_read_access(uuid,character varying) FROM "service_role";
GRANT ALL ON FUNCTION public.request_has_app_read_access(uuid,character varying) TO "service_role";

REVOKE ALL ON FUNCTION public.request_has_org_read_access(uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.request_has_org_read_access(uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.request_has_org_read_access(uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.request_has_org_read_access(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.request_has_org_read_access(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.request_org_chart_refresh(uuid) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.request_read_key_modes() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.request_read_key_modes() FROM "anon";
REVOKE ALL ON FUNCTION public.request_read_key_modes() FROM "authenticated";
REVOKE ALL ON FUNCTION public.request_read_key_modes() FROM "service_role";
GRANT ALL ON FUNCTION public.request_read_key_modes() TO "service_role";
...
REVOKE ALL ON FUNCTION public.rescind_invitation(text,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.rescind_invitation(text,uuid) TO "authenticated";
...
REVOKE ALL ON FUNCTION public.reset_onboarding_demo_app_data(uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.reset_onboarding_demo_app_data(uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.restore_deleted_account() FROM "service_role";
GRANT ALL ON FUNCTION public.restore_deleted_account() TO "authenticated";
GRANT ALL ON FUNCTION public.restore_deleted_account() TO "service_role";

REVOKE ALL ON FUNCTION public.resync_org_user_role_bindings(uuid,uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.resync_org_user_role_bindings(uuid,uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.resync_org_user_role_bindings(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.resync_org_user_role_bindings(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.resync_org_user_role_bindings(uuid,uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.sanitize_apps_text_fields() FROM "service_role";
GRANT ALL ON FUNCTION public.sanitize_apps_text_fields() TO "service_role";
...
REVOKE ALL ON FUNCTION public.sanitize_orgs_text_fields() FROM "service_role";
GRANT ALL ON FUNCTION public.sanitize_orgs_text_fields() TO "service_role";

REVOKE ALL ON FUNCTION public.sanitize_tmp_users_text_fields() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.sanitize_tmp_users_text_fields() FROM "anon";
REVOKE ALL ON FUNCTION public.sanitize_tmp_users_text_fields() FROM "authenticated";
REVOKE ALL ON FUNCTION public.sanitize_tmp_users_text_fields() FROM "service_role";
GRANT ALL ON FUNCTION public.sanitize_tmp_users_text_fields() TO "service_role";
...
REVOKE ALL ON FUNCTION public.sanitize_users_text_fields() FROM "service_role";
GRANT ALL ON FUNCTION public.sanitize_users_text_fields() TO "service_role";

REVOKE ALL ON FUNCTION public.seed_get_app_metrics_caches(uuid,date,date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.seed_get_app_metrics_caches(uuid,date,date) FROM "anon";
REVOKE ALL ON FUNCTION public.seed_get_app_metrics_caches(uuid,date,date) FROM "authenticated";
REVOKE ALL ON FUNCTION public.seed_get_app_metrics_caches(uuid,date,date) FROM "service_role";
...
REVOKE ALL ON FUNCTION public.set_build_time_exceeded_by_org(uuid,boolean) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.set_build_time_exceeded_by_org(uuid,boolean) FROM "anon";
REVOKE ALL ON FUNCTION public.set_build_time_exceeded_by_org(uuid,boolean) FROM "authenticated";
REVOKE ALL ON FUNCTION public.set_build_time_exceeded_by_org(uuid,boolean) FROM "service_role";
GRANT ALL ON FUNCTION public.set_build_time_exceeded_by_org(uuid,boolean) TO "service_role";

REVOKE ALL ON FUNCTION public.set_webhook_created_by() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.set_webhook_created_by() FROM "anon";
REVOKE ALL ON FUNCTION public.set_webhook_created_by() FROM "authenticated";
REVOKE ALL ON FUNCTION public.set_webhook_created_by() FROM "service_role";
GRANT ALL ON FUNCTION public.set_webhook_created_by() TO "service_role";

REVOKE ALL ON FUNCTION public.sync_org_has_usage_credits_from_grants() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.sync_org_has_usage_credits_from_grants() FROM "anon";
REVOKE ALL ON FUNCTION public.sync_org_has_usage_credits_from_grants() FROM "authenticated";
REVOKE ALL ON FUNCTION public.sync_org_has_usage_credits_from_grants() FROM "service_role";
GRANT ALL ON FUNCTION public.sync_org_has_usage_credits_from_grants() TO "service_role";

REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_delete() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_delete() FROM "anon";
REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_delete() FROM "authenticated";
REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_delete() FROM "service_role";
GRANT ALL ON FUNCTION public.sync_org_user_role_binding_on_delete() TO "service_role";

REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_update() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_update() FROM "anon";
REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_update() FROM "authenticated";
REVOKE ALL ON FUNCTION public.sync_org_user_role_binding_on_update() FROM "service_role";
GRANT ALL ON FUNCTION public.sync_org_user_role_binding_on_update() TO "service_role";

REVOKE ALL ON FUNCTION public.sync_org_user_to_role_binding() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.sync_org_user_to_role_binding() FROM "anon";
REVOKE ALL ON FUNCTION public.sync_org_user_to_role_binding() FROM "authenticated";
REVOKE ALL ON FUNCTION public.sync_org_user_to_role_binding() FROM "service_role";
GRANT ALL ON FUNCTION public.sync_org_user_to_role_binding() TO "service_role";

REVOKE ALL ON FUNCTION public.top_up_usage_credits(uuid,numeric,timestamp with time zone,text,jsonb,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.top_up_usage_credits(uuid,numeric,timestamp with time zone,text,jsonb,text) FROM "anon";
REVOKE ALL ON FUNCTION public.top_up_usage_credits(uuid,numeric,timestamp with time zone,text,jsonb,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.top_up_usage_credits(uuid,numeric,timestamp with time zone,text,jsonb,text) FROM "service_role";
GRANT ALL ON FUNCTION public.top_up_usage_credits(uuid,numeric,timestamp with time zone,text,jsonb,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.track_onboarding_demo_data(text,uuid,text,text[],uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.track_onboarding_demo_data(text,uuid,text,text[],uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.transfer_app(character varying,uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.transfer_app(character varying,uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.transfer_app(character varying,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.transfer_app(character varying,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.transfer_app(character varying,uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.transfer_app(character varying,uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.update_app_versions_retention() FROM "service_role";
GRANT ALL ON FUNCTION public.update_app_versions_retention() TO "service_role";

REVOKE ALL ON FUNCTION public.update_apps_build_timeout_updated_at() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.update_apps_build_timeout_updated_at() FROM "anon";
REVOKE ALL ON FUNCTION public.update_apps_build_timeout_updated_at() FROM "authenticated";
REVOKE ALL ON FUNCTION public.update_apps_build_timeout_updated_at() FROM "service_role";
GRANT ALL ON FUNCTION public.update_apps_build_timeout_updated_at() TO "service_role";
...
REVOKE ALL ON FUNCTION public.update_org_invite_role_rbac(uuid,uuid,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.update_org_invite_role_rbac(uuid,uuid,text) FROM "service_role";
GRANT ALL ON FUNCTION public.update_org_invite_role_rbac(uuid,uuid,text) TO "authenticated";
GRANT ALL ON FUNCTION public.update_org_invite_role_rbac(uuid,uuid,text) TO "service_role";

REVOKE ALL ON FUNCTION public.update_org_member_role(uuid,uuid,text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.update_org_member_role(uuid,uuid,text) FROM "anon";
REVOKE ALL ON FUNCTION public.update_org_member_role(uuid,uuid,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.update_org_member_role(uuid,uuid,text) FROM "service_role";
GRANT ALL ON FUNCTION public.update_org_member_role(uuid,uuid,text) TO "authenticated";
GRANT ALL ON FUNCTION public.update_org_member_role(uuid,uuid,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.update_tmp_invite_role_rbac(uuid,text,text) FROM "authenticated";
REVOKE ALL ON FUNCTION public.update_tmp_invite_role_rbac(uuid,text,text) FROM "service_role";
GRANT ALL ON FUNCTION public.update_tmp_invite_role_rbac(uuid,text,text) TO "authenticated";
GRANT ALL ON FUNCTION public.update_tmp_invite_role_rbac(uuid,text,text) TO "service_role";
...
REVOKE ALL ON FUNCTION public.upsert_version_meta(character varying,bigint,bigint) FROM "anon";
REVOKE ALL ON FUNCTION public.upsert_version_meta(character varying,bigint,bigint) FROM "authenticated";
REVOKE ALL ON FUNCTION public.upsert_version_meta(character varying,bigint,bigint) FROM "service_role";
GRANT ALL ON FUNCTION public.upsert_version_meta(character varying,bigint,bigint) TO "service_role";
...
REVOKE ALL ON FUNCTION public.user_has_app_update_user_roles(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.user_has_app_update_user_roles(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.user_has_app_update_user_roles(uuid,uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.user_has_app_update_user_roles(uuid,uuid) TO "service_role";
...
REVOKE ALL ON FUNCTION public.user_has_role_in_app(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.user_has_role_in_app(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.user_has_role_in_app(uuid,uuid) TO "authenticated";
GRANT ALL ON FUNCTION public.user_has_role_in_app(uuid,uuid) TO "service_role";

REVOKE ALL ON FUNCTION public.user_meets_password_policy(uuid,uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.user_meets_password_policy(uuid,uuid) FROM "anon";
REVOKE ALL ON FUNCTION public.user_meets_password_policy(uuid,uuid) FROM "authenticated";
REVOKE ALL ON FUNCTION public.user_meets_password_policy(uuid,uuid) FROM "service_role";
GRANT ALL ON FUNCTION public.user_meets_password_policy(uuid,uuid) TO "service_role";
...
REVOKE ALL ON TABLE public.apikey_global_permissions FROM "service_role";
GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE public.apikey_global_permissions TO "service_role";
...
REVOKE ALL ON TABLE public.daily_revenue_metrics FROM "service_role";
GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE public.daily_revenue_metrics TO "service_role";

REVOKE ALL ON TABLE public.global_stats FROM PUBLIC;
REVOKE ALL ON TABLE public.global_stats FROM "anon";
REVOKE ALL ON TABLE public.global_stats FROM "authenticated";
REVOKE ALL ON TABLE public.global_stats FROM "service_role";
GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE public.global_stats TO "service_role";
...
REVOKE ALL ON TABLE public.onboarding_demo_data FROM "service_role";
GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE public.onboarding_demo_data TO "service_role";
...
REVOKE ALL ON TABLE public.processed_stripe_events FROM "service_role";
...
REVOKE ALL ON TABLE public.webhook_deliveries FROM "service_role";
GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE public.webhook_deliveries TO "service_role";
...
REVOKE ALL ON TABLE public.webhooks FROM "service_role";
GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE public.webhooks TO "service_role";

REVOKE ALL ON SEQUENCE public.audit_logs_id_seq FROM PUBLIC;
...
--
-- Retained setup/data from historical migrations.
-- `supabase migration squash` produces a schema-only dump, so operational
-- queues, cron metadata, and static RBAC rows are restored explicitly here.
--
...
BEGIN
  FOREACH target_queue IN ARRAY ARRAY[
    ...
    IF NOT EXISTS (
      ...
      WHERE queues.queue_name = target_queue
    ) THEN
...
VALUES
  (1, 0, 6000, 0.16, 'build_time', 60, NULL),
  (2, 6000, 30000, 0.14, 'build_time', 60, NULL),
  (3, 30000, 60000, 0.12, 'build_time', 60, NULL),
  (4, 60000, 300000, 0.1, 'build_time', 60, NULL),
  (5, 300000, 600000, 0.09, 'build_time', 60, NULL),
...
SELECT pg_catalog.setval('"public"."capgo_credits_steps_id_seq"', 6, true);
...
VALUES
  ...
  ('app.transfer', 'app', 'Transfer app to another organization'),
  ...
  ('org.create_app', 'org', 'Create a new app within an organization'),
  ('org.delete', 'org', 'Delete an organization'),
...
VALUES
  ('apikey_org_reader', 'org', 'API key compatibility role: org metadata read only', 10, false, NULL),
  ...
  ('org_member', 'org', 'Basic org member: org-only access', 75, true, NULL),
...
FROM (
  VALUES
    ('apikey_org_reader', ARRAY['org.read']),
    ('app_admin', ARRAY[
      'app.build_native', 'app.create_channel', 'app.manage_devices', 'app.read',
      'app.read_audit', 'app.read_bundles', 'app.read_channels', 'app.read_devices',
      'app.read_logs', 'app.update_settings', 'app.update_user_roles', 'app.upload_bundle',
      'bundle.delete', 'channel.delete', 'channel.manage_forced_devices',
      'channel.promote_bundle', 'channel.read', 'channel.read_audit',
      'channel.read_forced_devices', 'channel.read_history', 'channel.rollback_bundle',
      'channel.update_settings'
    ]),
    ('app_developer', ARRAY[
      'app.build_native', 'app.manage_devices', 'app.read', 'app.read_audit',
      'app.read_bundles', 'app.read_channels', 'app.read_devices', 'app.read_logs',
      'app.upload_bundle', 'channel.manage_forced_devices', 'channel.promote_bundle',
      'channel.read', 'channel.read_audit', 'channel.read_forced_devices',
      'channel.read_history', 'channel.rollback_bundle', 'channel.update_settings'
    ]),
    ('app_reader', ARRAY[
      'app.read', 'app.read_audit', 'app.read_bundles', 'app.read_channels',
      'app.read_devices', 'app.read_logs'
    ]),
    ('app_uploader', ARRAY[
      'app.read', 'app.read_audit', 'app.read_bundles', 'app.read_channels',
      'app.read_devices', 'app.read_logs', 'app.upload_bundle',
      'channel.promote_bundle', 'channel.read', 'channel.read_history'
    ]),
    ('bundle_admin', ARRAY['bundle.delete']),
    ('channel_admin', ARRAY[
      'channel.delete', 'channel.manage_forced_devices', 'channel.promote_bundle',
      'channel.read', 'channel.read_audit', 'channel.read_forced_devices',
      'channel.read_history', 'channel.rollback_bundle', 'channel.update_settings'
    ]),
    ('channel_reader', ARRAY[
      'channel.read', 'channel.read_audit', 'channel.read_forced_devices',
    ...
    ('org_admin', ARRAY[
      'app.build_native', 'app.create_channel', 'app.manage_devices', 'app.read',
      'app.read_audit', 'app.read_bundles', 'app.read_channels', 'app.read_devices',
      'app.read_logs', 'app.update_settings', 'app.update_user_roles',
      'app.upload_bundle', 'channel.manage_forced_devices', 'channel.promote_bundle',
      'channel.read', 'channel.read_audit', 'channel.read_forced_devices',
      'channel.read_history', 'channel.rollback_bundle', 'channel.update_settings',
      'org.create_app', 'org.invite_user', 'org.read', 'org.read_audit',
      'org.read_billing', 'org.read_billing_audit', 'org.read_invoices',
      'org.read_members', 'org.update_settings', 'org.update_user_roles'
    ]),
    ('org_billing_admin', ARRAY[
      'org.create_app', 'org.read', 'org.read_billing', 'org.read_billing_audit',
      'org.read_invoices', 'org.update_billing'
    ]),
    ('org_member', ARRAY['org.create_app', 'org.read', 'org.read_members']),
    ('org_super_admin', ARRAY[
      'app.build_native', 'app.create_channel', 'app.delete', 'app.manage_devices',
      'app.read', 'app.read_audit', 'app.read_bundles', 'app.read_channels',
      'app.read_devices', 'app.read_logs', 'app.transfer', 'app.update_settings',
      'app.update_user_roles', 'app.upload_bundle', 'bundle.delete',
      'channel.delete', 'channel.manage_forced_devices', 'channel.promote_bundle',
      'channel.read', 'channel.read_audit', 'channel.read_forced_devices',
      'channel.read_history', 'channel.rollback_bundle', 'channel.update_settings',
      'org.create_app', 'org.delete', 'org.invite_user', 'org.read',
      'org.read_audit', 'org.read_billing', 'org.read_billing_audit',
      'org.read_invoices', 'org.read_members', 'org.update_billing',
      'org.update_settings', 'org.update_user_roles'
    ])
) AS role_permission_sets(role_name, permission_keys)
JOIN "public"."roles" roles
  ON roles."name" = role_permission_sets.role_name
JOIN LATERAL unnest(role_permission_sets.permission_keys) AS permission_key("key")
  ON true
JOIN "public"."permissions" permissions
  ON permissions."key" = permission_key."key"
ON CONFLICT DO NOTHING;

INSERT INTO "public"."role_hierarchy" ("parent_role_id", "child_role_id")
SELECT parent_roles.id, child_roles.id
FROM (
  VALUES
    ('app_admin', 'app_developer'),
    ('app_admin', 'bundle_admin'),
    ('app_admin', 'channel_admin'),
    ('app_developer', 'app_uploader'),
    ('app_uploader', 'app_reader'),
    ('bundle_admin', 'bundle_reader'),
    ('channel_admin', 'channel_reader'),
    ('org_admin', 'app_admin'),
    ('org_super_admin', 'org_admin')
) AS hierarchy(parent_role_name, child_role_name)
JOIN "public"."roles" parent_roles
  ON parent_roles."name" = hierarchy.parent_role_name
JOIN "public"."roles" child_roles
  ON child_roles."name" = hierarchy.child_role_name
ON CONFLICT DO NOTHING;
...
VALUES
  (1, 'high_frequency_queues', 'Process high-frequency event queues', 'function_queue', '["credit_usage_alerts", "on_app_create", "on_app_delete", "on_app_update", "on_channel_update", "on_org_update", "on_organization_create", "on_user_create", "on_user_delete", "on_user_update", "on_version_create", "on_version_delete", "on_version_update", "webhook_dispatcher", "webhook_delivery"]', 100, NULL, 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, NULL),
  (2, 'channel_device_counts', 'Process channel device counts queue', 'function', 'public.process_channel_device_counts_queue(1000)', NULL, NULL, 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, NULL),
  (3, 'delete_marked_accounts', 'Delete accounts marked for deletion', 'function', 'public.delete_accounts_marked_for_deletion()', NULL, NULL, NULL, 1, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (4, 'per_minute_queues', 'Process per-minute queues', 'function_queue', '["cron_sync_sub", "cron_stat_app"]', 10, NULL, NULL, 1, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (5, 'manifest_create_queue', 'Process manifest create queue', 'function_queue', '["on_manifest_create"]', NULL, NULL, NULL, 1, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (6, 'orphan_images_queue', 'Process orphan images cleanup queue', 'function_queue', '["cron_clean_orphan_images"]', NULL, NULL, NULL, 1, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (7, 'org_stats_queue', 'Process org stats queue', 'function_queue', '["cron_stat_org"]', 10, NULL, NULL, 5, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (8, 'cleanup_job_details', 'Cleanup frequent job details', 'function', 'public.cleanup_frequent_job_details()', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, true, NULL),
  (9, 'deploy_install_stats_email', 'Process deploy install stats email', 'function', 'public.process_deploy_install_stats_email()', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, true, NULL),
  (10, 'low_frequency_queues', 'Process low-frequency queues', 'function_queue', '["admin_stats", "cron_email", "on_organization_delete", "on_deploy_history_create", "cron_clear_versions"]', NULL, NULL, NULL, NULL, 2, NULL, 0, 0, NULL, NULL, true, NULL),
  (11, 'stats_jobs', 'Process cron stats jobs', 'function', 'public.process_cron_stats_jobs()', NULL, NULL, NULL, NULL, 6, NULL, 0, 0, NULL, NULL, true, NULL),
  (12, 'cleanup_queue_messages', 'Cleanup old queue messages', 'function', 'public.cleanup_queue_messages()', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, true, NULL),
  (13, 'delete_old_apps', 'Delete old deleted apps', 'function', 'public.delete_old_deleted_apps()', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, true, NULL),
  (14, 'remove_old_jobs', 'Remove old cron jobs', 'function', 'public.remove_old_jobs()', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, true, NULL),
  (15, 'version_retention', 'Update app versions retention', 'function', 'public.update_app_versions_retention()', NULL, NULL, NULL, NULL, NULL, 0, 40, 0, NULL, NULL, true, NULL),
  (16, 'admin_stats', 'Process admin stats', 'function', 'public.process_admin_stats()', NULL, NULL, NULL, NULL, NULL, 1, 1, 0, NULL, NULL, true, NULL),
  (17, 'free_trial_expired', 'Process free trial expired', 'function', 'public.process_free_trial_expired()', NULL, NULL, NULL, NULL, NULL, 3, 0, 0, NULL, NULL, true, NULL),
  (18, 'expire_credits', 'Expire usage credits', 'function', 'public.expire_usage_credits()', NULL, NULL, NULL, NULL, NULL, 3, 0, 0, NULL, NULL, true, NULL),
  (19, 'orphan_images_cleanup', 'Queue orphan images cleanup job', 'queue', 'cron_clean_orphan_images', NULL, NULL, NULL, NULL, NULL, 3, 0, 0, 0, NULL, true, NULL),
  (20, 'sync_sub_jobs', 'Process cron sync sub jobs', 'function', 'public.process_cron_sync_sub_jobs()', NULL, NULL, NULL, NULL, NULL, 4, 0, 0, NULL, NULL, true, NULL),
  (21, 'cleanup_job_run_details', 'Cleanup old job run details', 'function', 'public.cleanup_job_run_details_7days()', NULL, NULL, NULL, NULL, NULL, 12, 0, 0, NULL, NULL, true, NULL),
  (22, 'weekly_stats_email', 'Process weekly stats email', 'function', 'public.process_stats_email_weekly()', NULL, NULL, NULL, NULL, NULL, 12, 0, 0, 6, NULL, true, NULL),
  (23, 'monthly_stats_email', 'Process monthly stats email', 'function', 'public.process_stats_email_monthly()', NULL, NULL, NULL, NULL, NULL, 12, 0, 0, NULL, 1, true, NULL),
  (24, 'cleanup_old_channel_devices', 'Delete channel_devices older than one month', 'function', 'public.cleanup_old_channel_devices()', NULL, NULL, NULL, NULL, NULL, 2, 30, 0, NULL, NULL, true, NULL),
  (25, 'delete_old_versions', 'Permanently delete app versions 90 days after soft delete', 'function', 'public.delete_old_deleted_versions()', NULL, NULL, NULL, NULL, NULL, 3, 0, 0, NULL, NULL, true, NULL),
  (26, 'daily_fail_ratio_email', 'Send daily email alerts for apps with high install failure rates (>30%)', 'function', 'public.process_daily_fail_ratio_email()', NULL, NULL, NULL, NULL, NULL, 8, 0, 0, NULL, NULL, true, NULL),
  (27, 'cleanup_expired_demo_apps', 'Delete demo apps (app_id starts with com.capdemo.) older than 14 days', 'function', 'public.cleanup_expired_demo_apps()', NULL, NULL, NULL, NULL, NULL, 3, 0, 0, NULL, NULL, true, NULL),
  (28, 'refresh_org_usage_credits_flag', 'Refresh active credit flag for replica plugin gates', 'function', 'public.refresh_orgs_has_usage_credits()', NULL, NULL, NULL, NULL, NULL, 3, 0, 30, NULL, NULL, true, NULL),
  (29, 'cleanup_tmp_users', 'Cleanup expired tmp_users invitations (7 days)', 'function', 'public.cleanup_tmp_users()', NULL, NULL, NULL, 1, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (30, 'reconcile_build_status', 'Send build status reconciliation job to queue every 15 minutes', 'queue', 'cron_reconcile_build_status', NULL, NULL, NULL, 15, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (31, 'reconcile_build_status_queue', 'Process build status reconciliation queue', 'function_queue', '["cron_reconcile_build_status"]', NULL, NULL, NULL, 1, NULL, NULL, NULL, 0, NULL, NULL, true, NULL),
  (32, 'cleanup_old_audit_logs', 'Delete audit_logs older than 90 days', 'function', 'public.cleanup_old_audit_logs()', NULL, NULL, NULL, NULL, NULL, 3, 0, 0, NULL, NULL, true, NULL)
ON CONFLICT ("name") DO UPDATE
SET
  "id" = EXCLUDED."id",
  "description" = EXCLUDED."description",
...
SELECT pg_catalog.setval('"public"."cron_tasks_id_seq"', 32, true);
