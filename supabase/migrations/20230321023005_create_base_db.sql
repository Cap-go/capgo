...
CREATE TRIGGER on_app_stats_create AFTER INSERT ON public.app_stats FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_app_stats_create', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_app_stats_update AFTER UPDATE ON public.app_stats FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_app_stats_update', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_channel_create AFTER INSERT ON public.channels FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_channel_create', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_channel_update AFTER UPDATE ON public.channels FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_channel_update', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_log_create AFTER INSERT ON public.stats FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_log_create', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_shared_create AFTER INSERT ON public.channel_users FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_shared_create', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_user_create AFTER INSERT ON public.users FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_user_create', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_user_update AFTER UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_user_update', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_version_create AFTER INSERT ON public.app_versions FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_version_create', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_version_delete AFTER DELETE ON public.app_versions FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_version_delete', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
...
CREATE TRIGGER on_version_update AFTER UPDATE ON public.app_versions FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://xvwzpoazmxkqosrdewyv.functions.supabase.co/on_version_update', 'POST', '{"Content-type":"application/json","apisecret":"Y3p63TMDGNTHTze6MchBM7tPmB5"}', '{}', '1000');
