...
BEGIN
    ...
    -- test the user plan
    IF (is_paying_and_good_plan_org_action(orgid, ARRAY['mau'::"public"."action_type"]) = true AND is_paying_and_good_plan_org_action(orgid, ARRAY['bandwidth'::"public"."action_type"]) = true AND is_paying_and_good_plan_org_action(orgid, ARRAY['storage'::"public"."action_type"]) = false) THEN
        messages := array_append(messages, jsonb_build_object(
