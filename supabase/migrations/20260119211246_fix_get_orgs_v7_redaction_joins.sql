-- Fix get_orgs_v7 to return rows for users without 2FA/password compliance (with redacted data)
-- The issue was that INNER JOINs with NOT should_redact conditions excluded rows entirely
