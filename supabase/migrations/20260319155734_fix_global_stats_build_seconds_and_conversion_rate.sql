...
ALTER TABLE public.global_stats
RENAME COLUMN builds_day_ios TO build_avg_seconds_day_ios;

ALTER TABLE public.global_stats
RENAME COLUMN builds_day_android TO build_avg_seconds_day_android;
...
ALTER COLUMN build_avg_seconds_day_ios TYPE double precision USING 0,
ALTER COLUMN build_avg_seconds_day_android TYPE double precision USING 0;

ALTER TABLE public.global_stats
ALTER COLUMN build_total_seconds_day_ios SET DEFAULT 0,
ALTER COLUMN build_total_seconds_day_android SET DEFAULT 0,
ALTER COLUMN build_avg_seconds_day_ios SET DEFAULT 0,
ALTER COLUMN build_avg_seconds_day_android SET DEFAULT 0;
