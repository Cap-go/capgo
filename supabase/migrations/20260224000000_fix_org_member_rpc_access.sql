...
REVOKE ALL ON FUNCTION public.get_org_members(
    user_id uuid, guild_id uuid
) FROM public;
...
ALTER FUNCTION public.check_org_members_password_policy(
    org_id uuid
) OWNER TO postgres;
