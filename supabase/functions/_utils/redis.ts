import type { Redis, RedisPipeline } from 'https://deno.land/x/redis@v0.32.1/mod.ts'
import { Redis as RedisUpstash } from 'https://deno.land/x/upstash_redis@v1.28.3/mod.ts'
import { connect, parseURL } from 'https://deno.land/x/redis@v0.32.1/mod.ts'
import type { Pipeline as UpstashPipeline } from 'https://deno.land/x/upstash_redis@v1.28.3/pkg/pipeline.ts'
