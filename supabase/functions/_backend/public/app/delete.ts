...
export async function deleteApp(c: Context<MiddlewareKeyVariables>, appId: string, _apikey: Database['public']['Tables']['apikeys']['Row']): Promise<Response> {
  if (!appId) {
  ...
  if (!(await checkPermission(c, 'app.delete', { appId }))) {
