...
export function postApp(deprecated: boolean) {
  ...
  app.openapi(route, async (c: Context) => {
    ...
    try {
      ...
      console.log('Cannot update device overwrites', e)
      return c.json({ status: 'Cannot update device overwrites', error: JSON.stringify(e) }, 500)
    }
  })
