...
export async function* generateParts(requestId: string, body: ReadableStream<Uint8Array>, mem: WritableStreamBuffer): AsyncGenerator<Part> {
  try {
    ...
    cloudlog({ requestId, message: msg })
