...
SELECT
    throws_ok(
        'SELECT get_user_id(''ae6e7458-c46d-4c00-aa3b-153b0b8520ea'', ''com.demo.app'')',
        '42501',
        'permission denied for function get_user_id',
...
SELECT
    throws_ok(
        'SELECT get_org_perm_for_apikey(''ae6e7458-c46d-4c00-aa3b-153b0b8520ea'', ''com.demo.app'')',
        '42501',
...
SELECT
    is(
        ...
        'authenticated user should still call get_user_id'
    );
...
SELECT
    is(
        ...
        '6aa76066-55ef-4238-ade6-0b32334a4097',
        'authenticated user should still call get_user_id with app_id'
    );
...
SELECT
    is(
        ...
        'perm_owner',
        'authenticated user should still call get_org_perm_for_apikey'
    );
