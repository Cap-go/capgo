...
SELECT
    is(
        (
            ...
            WHERE
                bucket_id = 'images'
                AND name = 'org/55555555-5555-4555-8555-555555555555/com.shared.public.images/icon'
        ),
        0::bigint,
...
SELECT
    tests.authenticate_as('shared_public_image_unrelated');
...
SELECT
    tests.authenticate_as('shared_public_image_owner');
