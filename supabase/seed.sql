...
BEGIN
    ...
    TRUNCATE TABLE "public"."usage_credit_rates" CASCADE;
    ...
    VALUES
      ...
      ('storage', 0, 1073741824, 0.09, 1073741824), -- 0–1 GiB
      (
        'storage',
        1073741824,
        6442450944,
