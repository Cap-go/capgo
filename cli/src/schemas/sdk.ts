...
export const updateChannelOptionsSchema = z.object({
  ...
  rolloutPercentageBps: z.number().optional(),
  ...
  rolloutCacheTtlSeconds: z.number().optional(),
  autoPauseEnabled: z.boolean().optional(),
  autoPauseDisabled: z.boolean().optional(),
  autoPauseWindowMinutes: z.number().optional(),
  autoPauseFailureRateBps: z.number().nullable().optional(),
  autoPauseConfidence: z.number().optional(),
  autoPauseMinAttempts: z.number().nullable().optional(),
  autoPauseMinFailures: z.number().nullable().optional(),
  autoPauseAction: z.enum(['pause', 'rollback', 'notify']).optional(),
  autoPauseCooldownMinutes: z.number().optional(),
  apikey: z.string().optional(),
  supaHost: z.string().optional(),
  supaAnon: z.string().optional(),
})
