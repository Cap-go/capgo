...
import { readdir, stat, appendFile as append } from "node:fs/promises";
import path from "node:path";
import { PutObjectCommand, S3Client } from "@aws-sdk/client-s3";

const requiredEnv = [
  "CLOUDFLARE_ACCOUNT_ID",
  "R2_RESULTS_UPLOAD_ACCESS_KEY_ID",
  "R2_RESULTS_UPLOAD_SECRET_ACCESS_KEY",
  "R2_BUCKET",
  "REPORTS_BASE_URL",
  "PR_NUMBER",
  "HEAD_SHA",
...
const client = new S3Client({
  ...
  credentials: {
    accessKeyId: process.env.R2_RESULTS_UPLOAD_ACCESS_KEY_ID,
    secretAccessKey: process.env.R2_RESULTS_UPLOAD_SECRET_ACCESS_KEY,
  },
});
