...
const mutationsNode = [
  ...
  { from: 'https://deno.land/x/upstash_redis@v1.28.3/mod.ts', to: '@upstash/redis' },
  { from: 'const redis = await connect(parseURL(redisEnv))', to: 'const redis = new Redis(redisEnv)' },
  { from: 'https://deno.land/x/upstash_redis@v1.28.3/pkg/pipeline.ts', to: '@upstash/redis/types/pkg/pipeline' },
...
const mutationCloudflare = [
  ...
  { from: 'https://cdn.logsnag.com/deno/1.0.0-beta.6/index.ts', to: 'logsnag' },
  { from: 'import { Redis as RedisUpstash } from \'https://deno.land/x/upstash_redis@v1.28.3/mod.ts\'', to: '// Removed import' },
  { from: 'import type { Pipeline as UpstashPipeline } from \'https://deno.land/x/upstash_redis@v1.28.3/pkg/pipeline.ts\'', to: '// Removed import' },
  { from: 'https://deno.land/x/zod@v3.22.4/mod.ts', to: 'zod' },
