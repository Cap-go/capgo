...
const mutationsNode = [
  ...
  { from: 'import { serve } from \'https://deno.land/std@0.186.0/http/server.ts\'', to: 'import type { Handler } from \'@netlify/functions\'' },
...
const mutationsEgde = [
  ...
  { from: 'import { serve } from \'https://deno.land/std@0.186.0/http/server.ts\'', to: 'import type { Context } from \'https://edge.netlify.com\'' },
