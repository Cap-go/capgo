...
const allowedUtil = ['utils', 'conversion', 'types', 'supabase', 'supabase.types', 'invalids_ip', 'plans', 'logsnag', 'crisp', 'notifications', 'stripe', 'r2', 'downloadUrl', 'gplay_categ']
...
const mutationsNode = [
  { from: 'https://cdn.logsnag.com/deno/0.1.6/index.ts', to: 'logsnag' },
  ...
  { from: 'import { serve } from \'https://deno.land/std@0.182.0/http/server.ts\'', to: 'import type { Handler } from \'@netlify/functions\'' },
...
const mutationsEgde = [
  ...
  { from: 'import { serve } from \'https://deno.land/std@0.182.0/http/server.ts\'', to: 'import type { Context } from \'https://edge.netlify.com\'' },
