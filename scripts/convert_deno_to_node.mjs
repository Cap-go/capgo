...
const mutationsNode = [
  ...
  { from: 'https://deno.land/x/upstash_redis@v1.28.4/mod.ts', to: '@upstash/redis' },
  { from: 'const redis = await connect(parseURL(redisEnv))', to: 'const redis = new Redis(redisEnv)' },
  { from: 'https://deno.land/x/upstash_redis@v1.28.4/pkg/pipeline.ts', to: '@upstash/redis/types/pkg/pipeline' },
  { from: 'https://deno.land/x/zod@v3.22.4/mod.ts', to: 'zod' },
  { from: 'import type { Redis, RedisPipeline } from \'https://deno.land/x/redis@v0.32.1/mod.ts\'', to: 'import type { RedisPipeline } from \'ioredis\'' },
  ...
  { from: 'import { connect, parseURL } from \'https://deno.land/x/redis@v0.32.1/mod.ts\'', to: 'import { Redis } from \'ioredis\'' },
  { from: 'https://esm.sh/@supabase/supabase-js@^2.38.5', to: '@supabase/supabase-js' },
  { from: 'https://deno.land/x/axiod@0.26.2/mod.ts', to: 'axios' },
  { from: 'https://deno.land/x/s3_lite_client@0.7.0/mod.ts', to: 'minio' },
...
const mutationCloudflare = [
  ...
  { from: 'https://cdn.logsnag.com/deno/1.0.0-beta.6/index.ts', to: 'logsnag' },
  { from: 'import { Redis as RedisUpstash } from \'https://deno.land/x/upstash_redis@v1.28.4/mod.ts\'', to: '// Removed import' },
  { from: 'import type { Pipeline as UpstashPipeline } from \'https://deno.land/x/upstash_redis@v1.28.4/pkg/pipeline.ts\'', to: '// Removed import' },
  { from: 'https://deno.land/x/zod@v3.22.4/mod.ts', to: 'zod' },
  { from: 'import type { Redis, RedisPipeline } from \'https://deno.land/x/redis@v0.32.1/mod.ts\'', to: '// Removed import' },
  { from: 'bypassRedis = false', to: 'bypassRedis = true' },
  { from: 'import { connect, parseURL } from \'https://deno.land/x/redis@v0.32.1/mod.ts\'', to: '// Removed import' },
  { from: 'https://esm.sh/@supabase/supabase-js@^2.38.5', to: '@supabase/supabase-js' },
  { from: 'https://deno.land/x/axiod@0.26.2/mod.ts', to: 'axios' },
  { from: 'https://deno.land/x/s3_lite_client@0.7.0/mod.ts', to: '@aws-sdk/client-s3' },
  ...
  { from: 'btoa(STRIPE_TOKEN)', to: 'Buffer.from(STRIPE_TOKEN).toString(\'base64\')' },
  { from: '{ match: \'ver\*\', count: 5000 }', to: '{ pattern: \'ver\*\', count: 5000 })' },
  { from: 'https://esm.sh/drizzle-orm@0.29.3/#^', to: 'drizzle-orm', force: true },
