...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:dropdown__dropdownWrapper': {
    ...
    'group-data-overscroll:shadow-xs': true,
  ...
  'family:dropdown__listbox': {
    ...
    'dark:group-data-overscroll:border-neutral-600': true,
  },
  'family:dropdown__listitem': {
    ...
    'first:in-[.group\/optgroup]:before:rounded-none!': true,
    'last:in-[.group\/optgroup]:before:rounded-none!': true,
  },
  ...
  'file__fileRemove': {
    ...
    'peer-data-has-multiple:group-data-prefix-icon:left-2': true,
  ...
  'form__message': {
    ...
    'in-[.group\/summary]:text-sm': true,
  },
  'form__messageLink': {
    'in-[.group\/summary]:outline-hidden': true,
    'focus-visible:in-[.group\/summary]:ring-2': true,
    'in-[.group\/summary]:ring-blue-600': true,
  },
  'month__input': {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  'range__input': {
    ...
    'group-data-disabled:[&::-webkit-slider-thumb]:bg-neutral-500': true,
    'group-data-disabled:[&::-webkit-slider-thumb]:ring-neutral-300!': true,
    ...
    'dark:group-data-disabled:[&::-webkit-slider-thumb]:ring-neutral-600!': true,
    ...
    'group-data-disabled:[&::-moz-range-thumb]:bg-neutral-500': true,
    'group-data-disabled:[&::-moz-range-thumb]:ring-neutral-300!': true,
    ...
    'dark:group-data-disabled:[&::-moz-range-thumb]:ring-neutral-500!': true,
  ...
  'select__option': {
    ...
    'checked:group-data-multiple:bg-blue-100': true,
    'focus:group-data-multiple:bg-blue-100': true,
    ...
    'dark:bg-neutral-800': true,
    'dark:text-neutral-300': true,
    'dark:focus:group-data-multiple:bg-blue-800': true,
    'dark:checked:group-data-multiple:bg-blue-800': true,
  },
  'select__prefixIcon': {
    'flex': true,
    'items-center': true,
  ...
  'datepicker__panelHeader': {
    ...
    '[@media(max-width:431px)_and_(hover:none)]:group-data-[panel=time]/panel:group-[&:not([data-inline])]:grid-cols-[2.5em_1fr_2.5em]': true,
    '[@media(max-width:431px)_and_(hover:none)]:group-data-[panel=month]/panel:group-[&:not([data-inline])]:grid-cols-[2.5em_1fr_2.5em]': true,
  },
  ...
  'toggle__track': {
    ...
    '[&>div:last-child]:peer-checked:left-full': true,
    '[&>div:last-child]:peer-checked:-translate-x-full': true,
    '[&>div:first-child:not(:last-child)]:peer-checked:left-0': true,
    '[&>div:first-child:not(:last-child)]:peer-checked:translate-x-0': true,
    'shadow-xs': true,
    'peer-focus-visible:ring-2': true,
  ...
  'togglebuttons__input': {
    ...
    'disabled:group-data-disabled:opacity-100': true,
    'dark:bg-transparent': true,
    'dark:disabled:bg-transparent': true,
    'dark:disabled:text-blue-500': true,
    'dark:text-blue-500': true,
    'aria-pressed:bg-blue-600': true,
    'aria-pressed:text-white': true,
    'dark:aria-pressed:bg-blue-600': true,
    'dark:aria-pressed:text-white': true,
    'in-[.group\/option]:rounded-none!': true,
    'group-first/option:group-data-[vertical=false]/options:rounded-sm!': true,
    'group-first/option:group-data-[vertical=true]/options:rounded-sm!': true,
    'group-first/option:group-data-[vertical=false]/options:rounded-tr-none!': true,
    'group-first/option:group-data-[vertical=false]/options:rounded-br-none!': true,
    'group-first/option:group-data-[vertical=true]/options:rounded-bl-none!': true,
    'group-first/option:group-data-[vertical=true]/options:rounded-br-none!': true,
    'group-last/option:group-data-[vertical=false]/options:rounded-sm!': true,
    'group-last/option:group-data-[vertical=true]/options:rounded-sm!': true,
    'group-last/option:group-data-[vertical=false]/options:rounded-tl-none!': true,
    'group-last/option:group-data-[vertical=false]/options:rounded-bl-none!': true,
    'group-last/option:group-data-[vertical=true]/options:rounded-tl-none!': true,
    'group-last/option:group-data-[vertical=true]/options:rounded-tr-none!': true,
    'in-[.group\/option]:group-data-[vertical=false]/options:border-r-0!': true,
    'group-last/option:group-data-[vertical=false]/options:border-r!': true,
    'aria-pressed:in-[.group\/option]:group-data-[vertical=false]/options:border-x-blue-500': true,
    'aria-pressed:group-first/option:group-data-[vertical=false]/options:border-l-blue-600': true,
    'aria-pressed:group-last/option:group-data-[vertical=false]/options:border-r-blue-600': true,
    'dark:aria-pressed:in-[.group\/option]:group-data-[vertical=false]/options:border-x-blue-600': true,
    'dark:aria-pressed:group-first/option:group-data-[vertical=false]/options:border-l-blue-600': true,
    'dark:aria-pressed:group-last/option:group-data-[vertical=false]/options:border-r-blue-600': true,
    'in-[.group\/option]:group-data-[vertical=true]/options:border-b-0!': true,
    'group-last/option:group-data-[vertical=true]/options:border-b!': true,
    'aria-pressed:in-[.group\/option]:group-data-[vertical=true]/options:border-y-blue-500': true,
    'aria-pressed:group-first/option:group-data-[vertical=true]/options:border-t-blue-600': true,
    'aria-pressed:group-last/option:group-data-[vertical=true]/options:border-b-blue-600': true,
    'dark:aria-pressed:in-[.group\/option]:group-data-[vertical=true]/options:border-y-blue-600': true,
    'dark:aria-pressed:group-first/option:group-data-[vertical=true]/options:border-t-blue-600': true,
    'dark:aria-pressed:group-last/option:group-data-[vertical=true]/options:border-b-blue-600': true,
  },
  'transferlist__outer': {
    'group': true,
    'min-w-0': true,
