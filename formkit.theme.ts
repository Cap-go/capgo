...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'togglebuttons__input': {
    ...
    'group-data-[vertical=false]/options:group-first/option:aria-pressed:border-l-blue-600': true,
    'group-data-[vertical=false]/options:group-last/option:aria-pressed:border-r-blue-600': true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-blue-600': true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-pressed:border-l-blue-600': true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-pressed:border-r-blue-600': true,
    ...
    'group-data-[vertical=true]/options:group-first/option:aria-pressed:border-t-blue-600': true,
    'group-data-[vertical=true]/options:group-last/option:aria-pressed:border-b-blue-600': true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-blue-600': true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-pressed:border-t-blue-600': true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-pressed:border-b-blue-600': true,
  },
  'transferlist__outer': {
    'group': true,
    'min-w-0': true,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:before:w-5': true,
    'group-data-[tab-style=progress]/wrapper:before:h-5': true,
  ...
  'multi-step__badge': {
    ...
    'group-data-[tab-style=progress]/wrapper:w-5': true,
    'group-data-[tab-style=progress]/wrapper:h-5': true,
    'group-data-[tab-style=progress]/wrapper:p-1': true,
    'group-data-[tab-style=progress]/wrapper:text-[10px]': true,
    'group-data-[tab-style=progress]/wrapper:leading-0': true,
