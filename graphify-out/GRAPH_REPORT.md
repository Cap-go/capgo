...
## Corpus Check
- Large corpus: 1930 files · ~4,285,836 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13122 nodes · 24003 edges · 889 communities (750 shown, 139 thin omitted)
...
- `getClackCancelSymbol()` --calls--> `select()`  [INFERRED]
  tests/builder-cta.unit.test.ts → cli/src/init/prompts.ts
- `posthogLoader()` --calls--> `g`  [INFERRED]
  src/services/posthog.ts → cli/test/test-appflow-flow.mjs
...
## Communities (889 total, 139 thin omitted)
...
Cohesion: 0.03
Nodes (158): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+150 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (145): AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+137 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (149): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, formatBytes(), formatNumber(), funComparisons, getFunComparison(), getOrgIdForApp(), handleBillingPeriodStats() (+141 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (120): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), AdminStatsBody, adminStatsBodySchema (+112 more)
...
Cohesion: 0.03
Nodes (101): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+93 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (118): checkAppIdsExist(), ExistingOrganizationApp, PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), buildCodeDiffLines() (+110 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (103): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), Channel, checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel() (+95 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (86): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps (+78 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (68): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+60 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (52): pgPool, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), fixtureId, orgId, QueryFn, pool (+44 more)
...
Cohesion: 0.04
Nodes (72): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+64 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (70): findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), resolveCapacitorConfigTargetPath(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), resolveInitDirectoryPath(), resolveInitTargetPath() (+62 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (48): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+40 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (65): promoteEncryptionSummaryToEnabled(), streamCommandInInitPanel(), ConfirmOptions, PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+57 more)
...
Cohesion: 0.06
Nodes (75): AdditiveSchemaSyncOptions, AdditiveSchemaSyncPlan, AdditiveSchemaSyncResult, buildAddColumnStatement(), buildAlterSequenceStatement(), buildAttachConstraintStatement(), buildCreateIndexStatement(), buildCreateOrReplaceFunctionStatement() (+67 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (66): createChannel(), seedOptions, versionCache, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow, buildCompatibilityResult(), buildUploadPayload() (+58 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (60): spoof(), fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getFirstTierCreditUnitPricing(), sortCreditPricingSteps(), getErrorMessage() (+52 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (55): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), CheckDomainResponse, UpdateDeliveryScope, UpdateDeliveryStatsResponse, stripeEnabled, ArrayElement (+47 more)
...
Cohesion: 0.05
Nodes (55): analyticsOptOutCommands, applyCommandAnalyticsOptOut(), applyRawCommandAnalyticsOptOut(), buildInitReplayBody(), buildTerminalImageDataUrl(), chunkToString(), CliStream, createTerminal() (+47 more)
...
Cohesion: 0.04
Nodes (51): id, RBAC_ORG_ID, Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id (+43 more)
...
Cohesion: 0.06
Nodes (55): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit() (+47 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (29): adminStore, deliveryLatencyDays, devicesTrendSeries, displayStore, externalUpdatesSeries, isLoading, isLoadingGlobalStatsTrend, latestGlobalStats (+21 more)
...
Cohesion: 0.06
Nodes (47): assertCloudSqlDataApiResponseSucceeded(), CloudSqlDataApiResponse, ReadReplicaSchemaSyncPlan, readReplicaSubscriberCompatibilityIssues(), assertColumnStatement(), assertCompleteDataApiResponse(), assertConstraintStatement(), assertDataApiRequestFitsLimit() (+39 more)
...
Cohesion: 0.05
Nodes (40): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, deleteUserAs() (+32 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (56): NativeNotificationProviderConfig, aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody(), canRetry() (+48 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (48): app, DataDevice, devicesBodySchema, orderItemSchema, app, createUtcDate(), DataStats, defaultInsightActions (+40 more)
...
Cohesion: 0.05
Nodes (35): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, CreditStep, callLogAs() (+27 more)

### Community 40 - "Community 40"
Cohesion: 0.12
Nodes (56): completePendingOnboardingApp(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+48 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (41): setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement(), setLog() (+33 more)
...
Cohesion: 0.10
Nodes (40): asyncPool(), createStripeClient(), createSupabaseServiceClient(), getArgValue(), getRequiredEnv(), getSupabaseServiceRoleKey(), isActionableStripeCustomerId(), loadEnv() (+32 more)
...
Cohesion: 0.06
Nodes (42): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema, globalId, ORG_ID (+34 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (38): VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), deleteOrganization() (+30 more)
...
Cohesion: 0.06
Nodes (40): CLIActivityPayload, useRealtimeCLIFeed(), displayStore, mainStore, router, { t }, triggerFakeReplicationToast(), activeCount (+32 more)
...
Cohesion: 0.07
Nodes (37): resolveAppSetIconPath(), cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData, LogSpec (+29 more)

### Community 61 - "Community 61"
Cohesion: 0.07
Nodes (37): classes, globals, rootClasses(), availableLocales, ensureLanguageLoaded(), FALLBACK_LOCALE, fetchRemoteMessages(), getNavigatorLanguage() (+29 more)
...
Cohesion: 0.09
Nodes (34): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), isSsoProvider() (+26 more)
...
Cohesion: 0.10
Nodes (38): additionalDefaultStarRepositories, checkIfStarred(), parseNumber(), StarAllCommandOptions, starAllRepositoriesCommand(), starRepositoryCommand(), createAbortedError(), createStartRateLimiter() (+30 more)

### Community 66 - "Community 66"
Cohesion: 0.08
Nodes (28): readInitInternalLogLines(), confirmMessage(), contactSupport(), ContactSupportDeps, ContactSupportResult, fitBodyPrefix(), resetSupportUploadCacheForTests(), runContactSupport() (+20 more)

### Community 67 - "Community 67"
Cohesion: 0.09
Nodes (41): getCreditTopUpProductIdFromCustomer(), handleCheckoutSessionCompleted(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary (+33 more)
...
Cohesion: 0.08
Nodes (36): app, bodySchema, CreateDeviceBody, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString() (+28 more)
...
Cohesion: 0.10
Nodes (34): createRSA(), checkAlerts(), setSetting(), setSettingInternal(), configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite() (+26 more)
...
Cohesion: 0.07
Nodes (31): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+23 more)
...
Cohesion: 0.07
Nodes (33): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), createAuthenticatedSupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg() (+25 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (32): DependencySection, getDeclaredDependency(), getUpdaterInstallState(), PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson(), UpdaterInstallState, appendBulletedSection() (+24 more)
...
Cohesion: 0.10
Nodes (35): AppIconRow, AppleLookupResult, applyIcon(), BackfillFailure, BackfillResult, decodeHtml(), DEFAULT_ICON_VALUES, DownloadedIcon (+27 more)
...
Cohesion: 0.14
Nodes (28): formatDate(), formatDistanceToNow(), formatLocalDate(), formatLocalDateLong(), formatLocalDateShort(), formatLocalDateTime(), formatLocalDateTimeWithSeconds(), formatLocalMonthYear() (+20 more)
...
Cohesion: 0.10
Nodes (30): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), log, assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions (+22 more)
...
Cohesion: 0.10
Nodes (23): bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), creditPricingMetricOrder, CreditPricingStep (+15 more)
...
Cohesion: 0.16
Nodes (28): ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+20 more)
...
Cohesion: 0.12
Nodes (25): applyStoredPercents(), assertDateId(), BackfillRow, buildBackfillRow(), buildPluginBreakdownResult(), buildPluginVersionLadderQuery(), fetchGlobalStatsRows(), formatDateCF() (+17 more)
...
Cohesion: 0.15
Nodes (28): closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown(), getAdminGlobalStatsTrend() (+20 more)
...
Cohesion: 0.15
Nodes (24): isUpdateRequestBody(), DevicePlatform, fieldIssue(), getAllowedStatsActionsList(), isDevicePlatformValue(), isRecord(), UnknownRecord, validateBasePluginBooleans() (+16 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (21): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+13 more)
...
Cohesion: 0.08
Nodes (22): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey() (+14 more)
...
Cohesion: 0.09
Nodes (23): BuilderCtaAction, BuilderCtaChoice, BuilderCtaContext, BuilderCtaSurface, BuilderSelect, BuilderSelectOption, BuilderSelectOptions, decideBuilderCtaSurface() (+15 more)
...
Cohesion: 0.11
Nodes (20): app, assertPlatformAdmin(), buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), durationExpression, endActions, generateDateLabels() (+12 more)
...
Cohesion: 0.17
Nodes (19): apikeyHasOrgRight(), apikeyHasOrgRightWithPolicy(), checkApikeyMeetsOrgPolicy(), bodySchema, deleteWebhook(), getDeliveries(), bodySchema, get() (+11 more)
...
Cohesion: 0.14
Nodes (23): countDemoSeededApps(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow(), getPaidProductActivityStats(), getRegistersToday(), isMissingBuildMetricColumnError() (+15 more)

### Community 163 - "Community 163"
Cohesion: 0.16
Nodes (20): getDeliveryById(), getWebhookById(), getWebhookLogUrlMetadata(), getWebhookPublicUrlValidationError(), parseWebhookDeliveryVersion(), queueWebhookDelivery(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion (+12 more)
...
Cohesion: 0.14
Nodes (12): appGlobal, app, app, app, app, registerPluginStatsSbFallbacksForDeno(), appGlobal, consoleHeaders (+4 more)
...
Cohesion: 0.13
Nodes (14): AnalyzeBehavior, CiFailureActions, CiFailureActionsInput, decideCiFailureActions(), DecideInput, isLogTooBig(), PostAnalyzeInput, PostAnalyzeStreamInput (+6 more)
...
Cohesion: 0.15
Nodes (16): chunkArray(), delete_queue_message_batch(), deleteSuccessfulChunkMessages(), deleteUncheckpointedSuccessMessages(), DISCORD_IGNORED_ERROR_CODES, FailureDetail, getQueueAckChunkSize(), mapWithConcurrency() (+8 more)
...
Cohesion: 0.17
Nodes (12): isOptionalString(), isOptionalStringMaxLength(), isStatsRequestBody(), isValidStatsMetadata(), ALLOWED_STATS_ACTIONS_SET, actionToFilter, failureActionFilterKeys, failureActions (+4 more)
...
Cohesion: 0.16
Nodes (13): firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl(), ManifestEntry, rewriteLocalEdgeRuntimeUrl(), CompositeTypes, DatabaseWithoutInternals, DefaultSchema (+5 more)
...
Cohesion: 0.16
Nodes (10): applyReadReplicaAdditiveSchemaSync, applyReadReplicaSchemaSync(), assertAppliedStatementsVisible(), assertTimeRemaining(), positiveIntegerOrDefault(), ReadReplicaSchemaSyncClient, ReadReplicaSchemaSyncStatement, reconcileReadReplicaSchema() (+2 more)
...
Cohesion: 0.22
Nodes (11): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+3 more)
...
Cohesion: 0.18
Nodes (14): dispatchQueueMessage(), extractErrorDetails(), extractMessageBody(), generateUUID(), getManifestRecordFromQueueBody(), getQueueMessageTrace(), httpExceptionToQueueResponse(), isRecord() (+6 more)
...
Cohesion: 0.21
Nodes (13): archive_queue_messages(), getActionableQueueFailures(), getQueueBatchSize(), getQueueHttpConcurrency(), getQueueHttpTimeoutMs(), getQueueMaxReads(), getQueueVisibilityTimeout(), http_post_helper() (+5 more)
...
Cohesion: 0.33
Nodes (7): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, OptionsUpload
...
Cohesion: 0.20
Nodes (9): runInitContactSupport(), findSavedKeySilent(), tryReadKey(), ClipboardCandidate, copyToClipboard(), revealInFinder(), SupportUploadInput, SupportUploadResult (+1 more)
...
Cohesion: 0.24
Nodes (7): DEPLOYMENT_REGIONS, DeploymentRegion, getClosestRegionFromTimeZone(), getCurrentTimeZone(), getOrderedRegions(), ReplicationProgressOptions, showReplicationProgress()

### Community 313 - "Community 313"
Cohesion: 0.20
Nodes (6): hasUpdaterInCapacitorConfigJson(), hasUpdaterInText(), promptAndSyncCapacitor(), readJsonFileSafely(), resolvePackageJsonLocation(), validateIosUpdaterSync()
...
Cohesion: 0.31
Nodes (6): app, bytesToGb(), bytesToGBText(), bytesToMb(), bytesToMbText(), toFixed()
...
Cohesion: 0.22
Nodes (7): createAuthenticatedClient(), isRetryableRpcTransportError(), requestActorUserId(), SUPABASE_ANON_KEY, SUPABASE_SERVICE_KEY, SUPABASE_URL, APIKEY_TEST_APP_UPLOADER
...
Cohesion: 0.33
Nodes (7): makeStdin(), makeStdout(), renderShell(), renderShellInstance(), updateInfo, waitForFirstFrame(), watchdog
...
Cohesion: 0.40
Nodes (6): getCronHealthcheckStartUrl(), maybePingCronHealthcheck(), maybePingCronHealthcheckStart(), pingCronHealthcheck(), runQueueSync(), trimTrailingSlashes()

### Community 470 - "Community 470"
Cohesion: 0.40
Nodes (6): isAsciiLetterOrDigit(), isEmailDomainChar(), isEmailLocalChar(), isLikelyEmail(), redactEmailLikeSubstrings(), sanitizeDiscordResponseBody()
...
Cohesion: 0.50
Nodes (4): doLoginExists(), login(), loginInternal(), Options
...
## Knowledge Gaps
- **4466 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4461 more)
...
- **Why does `Database` connect `Community 60` to `Community 257`, `Community 2`, `Community 3`, `Community 10`, `Community 11`, `Community 13`, `Community 17`, `Community 21`, `Community 22`, `Community 23`, `Community 28`, `Community 31`, `Community 35`, `Community 165`, `Community 168`, `Community 41`, `Community 61`, `Community 79`, `Community 465`, `Community 82`, `Community 350`, `Community 104`, `Community 508`?**
  _High betweenness centrality (0.236) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 128`, `Community 387`, `Community 4`, `Community 5`, `Community 8`, `Community 139`, `Community 149`, `Community 150`, `Community 25`, `Community 283`, `Community 27`, `Community 30`, `Community 159`, `Community 160`, `Community 161`, `Community 34`, `Community 163`, `Community 43`, `Community 45`, `Community 50`, `Community 306`, `Community 51`, `Community 178`, `Community 440`, `Community 441`, `Community 442`, `Community 58`, `Community 444`, `Community 445`, `Community 59`, `Community 64`, `Community 67`, `Community 68`, `Community 452`, `Community 70`, `Community 69`, `Community 72`, `Community 73`, `Community 202`, `Community 80`, `Community 210`, `Community 340`, `Community 85`, `Community 86`, `Community 87`, `Community 91`, `Community 222`, `Community 94`, `Community 99`, `Community 230`, `Community 233`, `Community 106`, `Community 235`, `Community 496`, `Community 497`, `Community 112`, `Community 499`, `Community 116`, `Community 117`, `Community 246`, `Community 113`, `Community 505`, `Community 123`, `Community 125`, `Community 126`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.027202305890830482 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.022789309972703613 - nodes in this community are weakly interconnected._