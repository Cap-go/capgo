...
## Corpus Check
- Large corpus: 1834 files · ~3,721,123 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 9477 nodes · 20090 edges · 602 communities (497 shown, 105 thin omitted)
...
## Communities (602 total, 105 thin omitted)
...
Cohesion: 0.03
Nodes (209): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), cancelCommand(), markSnag(), buildAppIdConflictSuggestions() (+201 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (147): Channel, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+139 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (171): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+163 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (163): auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), bodySchema, ensureOrgAccess(), fetchOrg(), fetchOrgs() (+155 more)
...
Cohesion: 0.03
Nodes (130): setChannel(), SetChannelBody, checkWriteAppAccess(), runChannelSelfWithPgClient(), app, AppContext, canCallerResendInviteRole(), getInviteNotificationLockKey() (+122 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (110): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId() (+102 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (104): app, appPrivate, appTriggers, app, deleteBodySchema, DataUpload, app, DataUpload (+96 more)
...
Cohesion: 0.06
Nodes (112): withSupabaseSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, checkVersionNotUsedInChannel() (+104 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (111): deleteOverride(), DeviceLink, assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), logDeviceRequestContext(), recordDeviceIPRateLimit(), recordDeviceRateLimitSafely() (+103 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (105): filterDeviceKeys(), get(), GetDevice, publicDevice, app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils (+97 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (77): adminStore, appsTrendSeries, buildAverageSecondsTrendSeries, buildsLastMonthTrendSeries, buildsTrendSeries, buildTotalSecondsTrendSeries, bundleStorageTrendSeries, devicePlatformTrendSeries (+69 more)
...
Cohesion: 0.04
Nodes (79): get(), getAll(), app, CreateApp, post(), put(), UpdateApp, AppWithOrg (+71 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (83): app, DataDownload, ALLOWED_ATTRIBUTE_KEYS, app, createBodySchema, parseAttributeMapping(), requireManageSsoPermission(), updateBodySchema (+75 more)
...
Cohesion: 0.04
Nodes (44): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, testOrgId (+36 more)
...
Cohesion: 0.06
Nodes (45): plans, buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), checkoutSessionEventTypes, classifyRevenueMovement(), compactMetadata(), createdOrUpdated(), createZeroPlanBreakdown() (+37 more)
...
Cohesion: 0.11
Nodes (41): syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createCustomer(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary (+33 more)
...
Cohesion: 0.09
Nodes (28): addGroupMemberBodyHook, addGroupMemberBodySchema, appIdParamSchema, createGroupBodyHook, createGroupBodySchema, createRoleBindingBodyHook, createRoleBindingBodySchema, groupIdParamSchema (+20 more)
...
Cohesion: 0.07
Nodes (28): accumulateNumbers(), app, AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, bundleUsageSchema, bundleUsageTestUtils, checkOrganizationAccess() (+20 more)
...
Cohesion: 0.09
Nodes (22): bindingIdParamSchema, invalidAppIdHook, invalidBindingIdHook, AssignablePrincipal, CreateBindingResult, getLegacyChannelRowId(), isSupportedChannelId(), loadAssignableRoleForBinding() (+14 more)
...
Cohesion: 0.10
Nodes (21): isRetryableDurableObjectFetchError(), AppScopedAttachmentPath, AsyncLock, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, EXPOSED_HEADERS, FinalPart (+13 more)
...
Cohesion: 0.09
Nodes (21): author, bin, capgo, bugs, url, description, engines, node (+13 more)
...
Cohesion: 0.15
Nodes (19): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), isRetryableCronSyncError(), syncSubscriptionAndEventsWithRetry(), getManifestSizeWithRetry() (+11 more)
...
Cohesion: 0.67
Nodes (3): parseJsonBodyWithHeaderFallback(), validateJsonBody(), simpleErrorWithStatus()

## Knowledge Gaps
- **3304 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3299 more)
...
- **Why does `Database` connect `Community 11` to `Community 2`, `Community 3`, `Community 8`, `Community 138`, `Community 266`, `Community 14`, `Community 22`, `Community 151`, `Community 280`, `Community 25`, `Community 26`, `Community 23`, `Community 28`, `Community 30`, `Community 32`, `Community 289`, `Community 34`, `Community 166`, `Community 38`, `Community 312`, `Community 71`, `Community 72`, `Community 77`, `Community 213`, `Community 103`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `cloudlog()` connect `Community 9` to `Community 4`, `Community 5`, `Community 7`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 24`, `Community 159`, `Community 33`, `Community 163`, `Community 35`, `Community 37`, `Community 39`, `Community 41`, `Community 42`, `Community 44`, `Community 48`, `Community 49`, `Community 51`, `Community 56`, `Community 63`, `Community 65`, `Community 73`, `Community 76`, `Community 80`, `Community 85`, `Community 86`, `Community 218`, `Community 97`, `Community 111`, `Community 112`, `Community 116`, `Community 118`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `scripts` connect `Community 15` to `Community 101`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.026782581575767028 - nodes in this community are weakly interconnected._