...
Cohesion: 0.04
Nodes (48): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, semverApiKey, id (+40 more)
...
Cohesion: 0.08
Nodes (52): formatBytes(), formatNumber(), handleBillingPeriodStats(), syncSubscriptionAndEventsWithRetry(), sendNotifToOrgMembers(), applyCreditsForMetric(), BillingCycleInfo, BillingCycleRange (+44 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (48): getManifestSizeWithRetry(), shouldRetryManifestSizeLookup(), updateManifestSize(), delete_queue_message_batch(), DISCORD_IGNORED_ERROR_CODES, dispatchQueueMessage(), extractErrorDetails(), extractMessageBody() (+40 more)
...
Cohesion: 0.08
Nodes (32): addGroupMemberBodyHook, addGroupMemberBodySchema, appIdParamSchema, bindingIdParamSchema, createGroupBodyHook, createGroupBodySchema, createRoleBindingBodyHook, createRoleBindingBodySchema (+24 more)
...
Cohesion: 0.09
Nodes (31): invalidAppIdHook, invalidBindingIdHook, AssignablePrincipal, canManageRoleBindingScope(), CreateBindingResult, createRoleBindingForPrincipal(), getCallerMaxPriorityRank(), getLegacyChannelRowId() (+23 more)
...
Cohesion: 0.14
Nodes (23): UpdateRes, firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl(), ManifestEntry, rewriteLocalEdgeRuntimeUrl(), decodeManifestPathSegments(), encodeManifestPathSegments() (+15 more)
...
Cohesion: 0.10
Nodes (20): describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogSpec, Order, QueryStats, summarizeAction() (+12 more)
...
## Knowledge Gaps
- **3009 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3004 more)
