...
## Corpus Check
- Large corpus: 2159 files · ~4,296,530 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 11926 nodes · 25169 edges · 732 communities (605 shown, 127 thin omitted)
...
## Communities (732 total, 127 thin omitted)
...
Cohesion: 0.02
Nodes (199): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, appGlobal (+191 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (237): withGlobalPermissions(), replaceApiKeyGlobalPermissions(), replaceApiKeyBindings(), replaceApiKeyGlobalPermissionsForExistingBindings(), assertApiKeyManagerCanAssignBindings(), checkWriteAppAccess(), assertAppPermission(), assertOptionalDate() (+229 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (147): Channel, installMcpStdoutGuard(), appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, mcpLoginInputSchema, mcpLogoutInputSchema, saveScopeSchema (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (177): getChannelPreviewVersionId(), assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest (+169 more)
...
Cohesion: 0.03
Nodes (146): app, assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), logDeviceRequestContext(), recordDeviceIPRateLimit(), recordDeviceRateLimitSafely(), AppOwnerResult (+138 more)
...
Cohesion: 0.03
Nodes (111): get(), getAll(), app, CreateApp, post(), put(), UpdateApp, AppWithOrg (+103 more)
...
Cohesion: 0.02
Nodes (112): adminStatsBodySchema, adminDeleteIdentity(), fallbackDeleteEmailIdentity(), getOrgPrelinkCandidates(), maskEmail(), PrelinkCandidate, PrelinkUsersRequest, PUBLIC_EMAIL_DOMAINS (+104 more)
...
Cohesion: 0.03
Nodes (114): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant() (+106 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (111): checkAppIdsExist(), ExistingOrganizationApp, PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), buildCodeDiffLines() (+103 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (96): check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel() (+88 more)
...
Cohesion: 0.04
Nodes (82): AppContext, getInviteNotificationLockKey(), getInviteResendRequiredPermission(), inviteExistingUserSchema, inviteNotificationCooldowns, unlockInviteNotification(), validateRequest(), getOrgAdminMemberEmailsForTagsMock (+74 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (60): createAuthenticatedSupabaseClient(), pgPool, deleteUserAs(), withAuthClient(), fixtureId, orgId, QueryFn, createOrgWithMember() (+52 more)
...
Cohesion: 0.08
Nodes (72): completePendingOnboardingApp(), wait(), waitLog(), getInfoInternal(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep() (+64 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (56): setSetting(), setSettingInternal(), loadConfig(), writeConfig(), AppSettingOptions, CapacitorConfig, capacitorConfigSchema, ExtConfigPairs (+48 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (64): app, ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+56 more)
...
Cohesion: 0.05
Nodes (58): spoof(), fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser(), AppUsageByApp (+50 more)
...
Cohesion: 0.06
Nodes (55): createRSA(), checkAlerts(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getLatestDependencies(), writeConfigUpdater() (+47 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (42): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, CreditStep, callLogAs() (+34 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (58): createChannel(), seedOptions, versionCache, apiKeyHasAnyAppPermission(), apiKeyHasAnyChannelPermission(), ApiKeyRow, buildCompatibilityResult(), buildUploadPayload() (+50 more)
...
Cohesion: 0.05
Nodes (49): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), stripeEnabled, ArrayElement, Concrete, Expand, Merge (+41 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (40): CheckDomainResponse, classes, globals, rootClasses(), availableLocales, ensureLanguageLoaded(), FALLBACK_LOCALE, fetchRemoteMessages() (+32 more)
...
Cohesion: 0.06
Nodes (50): countUpdatesFromLogsCF(), countUpdatesFromLogsExternalCF(), getUpdateStatsCF(), trackBandwidthUsageCF(), trackVersionUsageCF(), buildStatsInsightsFromRows(), countAllUpdates(), countAllUpdatesExternal() (+42 more)
...
Cohesion: 0.05
Nodes (41): apiFetch(), appKeyBody(), BASE_ORG_ID, createApiKeySupabaseClient(), deleteSeededApiKeys(), expectApiKeyCannotReadBaseOrg(), expectApiKeyCanReadBaseOrg(), id (+33 more)
...
Cohesion: 0.06
Nodes (46): AdditiveSchemaSyncOptions, AdditiveSchemaSyncPlan, AdditiveSchemaSyncResult, assertCatalogObject(), assertSchemaCatalog(), assertSchemaColumn(), assertSchemaCompositeAttribute(), assertSchemaConstraint() (+38 more)
...
Cohesion: 0.08
Nodes (38): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, AppRow, assertAppAllowsPreview() (+30 more)
...
Cohesion: 0.06
Nodes (34): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, CompatibilityEventRow (+26 more)
...
Cohesion: 0.07
Nodes (34): buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), buildOnboardingBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString(), TrackEventBody (+26 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (39): resolveForRequest(), onManifestCreateTestUtils, onVersionUpdateTestUtils, messagesArraySchema, __queueConsumerTestUtils__, firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl() (+31 more)
...
Cohesion: 0.10
Nodes (35): ensureNativePlatformForBuild(), formatInheritedCommandFailure(), normalizeRunDevicePlatform(), PlatformChoice, runCapacitorPlatformAdd(), runInitDoctorDiagnostics(), runNativeResetCommand(), runPackageRunnerSync() (+27 more)
...
Cohesion: 0.12
Nodes (34): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, buildReadDevicesCFQuery(), buildStatsInsightsActionFilter() (+26 more)
...
Cohesion: 0.08
Nodes (25): addGroupMemberBodyHook, appIdParamSchema, bindingIdParamSchema, createGroupBodySchema, createRoleBindingBodyHook, createRoleBindingBodySchema, invalidAppIdHook, invalidBindingIdHook (+17 more)
...
Cohesion: 0.10
Nodes (26): assertCloudSqlDataApiResponseSucceeded(), CloudSqlDataApiResponse, applyReadReplicaSchemaSync(), assertAppliedStatementsVisible(), assertTimeRemaining(), positiveIntegerOrDefault(), reconcileReadReplicaSchema(), setStatementTimeoutForRemainingBudget() (+18 more)
...
Cohesion: 0.14
Nodes (31): buildAddColumnStatement(), buildAlterColumnNotNullStatement(), buildAlterSequenceStatement(), buildAttachConstraintStatement(), buildCreateIndexStatement(), buildCreateOrReplaceFunctionStatement(), buildCreateSequenceStatement(), buildDropIndexStatement() (+23 more)
...
Cohesion: 0.14
Nodes (28): cancelCommand(), markSnag(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions() (+20 more)
...
Cohesion: 0.15
Nodes (21): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), isRetryableCronSyncError(), getManifestSizeWithRetry() (+13 more)
...
Cohesion: 0.11
Nodes (18): app, canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId() (+10 more)

### Community 148 - "Community 148"
Cohesion: 0.11
Nodes (11): applyReadReplicaAdditiveSchemaSync, Queryable, REPLICA_EXCLUDED_INDEXES, REPLICA_FUNCTIONS, REPLICA_SEQUENCES, REPLICA_TABLES, REPLICA_TYPES, replicaConfigPattern() (+3 more)

### Community 149 - "Community 149"
Cohesion: 0.14
Nodes (17): countDevicesCF(), readBandwidthUsageCF(), assertAnalyticsEngineReadConfig(), countDevices(), countInstallSources(), hasAnalyticsEngineReadConfig(), readDevices(), readDeviceVersionCounts() (+9 more)
...
Cohesion: 0.13
Nodes (18): AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId(), getScopedCreditSteps() (+10 more)
...
Cohesion: 0.18
Nodes (13): fetchRegionVersion(), getDifferences(), getExpectedVersion(), getPluginRegionVersions(), parseWorkerVersion(), PluginRegionDifference, PluginRegionResult, toErrorMessage() (+5 more)
...
Cohesion: 0.15
Nodes (13): ensureOrgMembership(), ensureOrgMembershipInTransaction(), EnsureOrgMembershipResult, ensurePublicUserRowExists(), ensurePublicUserRowExistsInTransaction(), extractProviderId(), getAuthenticatedSsoProviders(), mergeSsoIdentityWithExistingAccount() (+5 more)
...
## Knowledge Gaps
- **4021 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4016 more)
...
- **Why does `Database` connect `Community 15` to `Community 3`, `Community 394`, `Community 139`, `Community 12`, `Community 141`, `Community 16`, `Community 18`, `Community 19`, `Community 22`, `Community 24`, `Community 156`, `Community 28`, `Community 31`, `Community 32`, `Community 417`, `Community 34`, `Community 35`, `Community 39`, `Community 40`, `Community 44`, `Community 53`, `Community 58`, `Community 79`, `Community 216`, `Community 348`, `Community 358`, `Community 233`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.02073738217396492 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.020436585049876926 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.021472645002056766 - nodes in this community are weakly interconnected._