...
## Corpus Check
- Large corpus: 2021 files · ~4,104,756 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 10662 nodes · 22380 edges · 688 communities (573 shown, 115 thin omitted)
...
## Communities (688 total, 115 thin omitted)
...
Cohesion: 0.02
Nodes (183): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+175 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (176): replaceApiKeyGlobalPermissionsForExistingBindings(), setChannel(), SetChannelBody, checkWriteAppAccess(), AdminStatsBody, app, CancellationDetails, cancellationFeedbackLabels (+168 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (148): buildServerInstructions(), installMcpStdoutGuard(), appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, mcpLoginInputSchema, mcpLogoutInputSchema (+140 more)
...
Cohesion: 0.05
Nodes (92): app, appPrivate, appTriggers, app, app, DataUpload, app, app (+84 more)
...
Cohesion: 0.04
Nodes (57): appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, app (+49 more)
...
Cohesion: 0.04
Nodes (70): createRSA(), setSetting(), setSettingInternal(), loadConfig(), writeConfig(), writeConfigUpdater(), CapacitorConfig, capacitorConfigSchema (+62 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (76): assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildNormalizedUploadMetadataHeader(), calculateBytesTransferred(), canReplayUploadRequest() (+68 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (79): adminStatsBodySchema, countActiveUsersForSnapshot(), AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+71 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (73): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, didCancel(), syncBillingBentoTags(), syncBillingBentoTagsFromStoredStripeInfo(), addTagBento(), bentoFetch(), getBentoHeaders() (+65 more)
...
Cohesion: 0.03
Nodes (75): areGlobalStatsNumbersDifferent(), BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, buildLogsnagInsightsRetryMessage(), buildLogsnagInsightsShardMessage(), buildRecentGlobalStatsRepairDateIds(), BuildShardStats (+67 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (66): streamCommandInInitPanel(), ConfirmOptions, log, PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+58 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (69): AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6, parseBodyRaw(), post(), PostResult (+61 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (68): optionsHandler(), app, getPublicSupabaseUrl(), isLocalHost(), isLocalSupabaseUrl(), deleteIt(), deleteManifest(), getManifestEntryCount() (+60 more)
...
Cohesion: 0.06
Nodes (16): Digester, noopDigester(), sha256Digester(), isR2ChecksumError(), isR2Error(), isR2MultipartDoesNotExistError(), retry(), RetryBucket (+8 more)
...
Cohesion: 0.13
Nodes (51): completePendingOnboardingApp(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), askForAppId(), askForExistingDirectoryPath() (+43 more)
...
Cohesion: 0.07
Nodes (44): isRetryableStatsError(), isRetryableStatsResult(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit(), buildStorageHourlyRows() (+36 more)
...
Cohesion: 0.11
Nodes (32): getInvocationSource(), checkAppExists(), checkAlerts(), VersionCheckResult, addApp(), addAppInternal(), AppCreateSource, ensureAppDoesNotExist() (+24 more)
...
Cohesion: 0.13
Nodes (31): ensureNativePlatformForBuild(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+23 more)
...
Cohesion: 0.12
Nodes (28): assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), assertChannelSelfIPRateLimit(), parseChannelSelfPluginRequest(), recordChannelSelfIPRateLimit(), recordChannelSelfRequestSafely(), runChannelSelfDeviceOperation() (+20 more)
...
Cohesion: 0.11
Nodes (30): calculateRevenue(), getBuildStats(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getEmptySubscriptionAccessSnapshotCounts(), getMetricWindowFromDailyWindow(), getRegistersToday(), getSubscriptionAccessSnapshotCounts() (+22 more)
...
Cohesion: 0.12
Nodes (27): dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows(), filterCandidateGlobalStatsShards(), getEmptyBuildShardStats() (+19 more)
...
Cohesion: 0.13
Nodes (14): mockContext, plans, mockContext, stripeEventTestUtils, extractDataEvent(), getLicensedSubscriptionItem(), getSubscriptionEndDate(), getSubscriptionInterval() (+6 more)
...
Cohesion: 0.16
Nodes (18): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), getRunDeviceCommandForPlatform(), canSelectRunDeviceTargetInteractively(), exitCanceledRunDeviceTest(), getNonInteractiveRunDeviceCommand(), handleNonInteractiveIosRunDevice() (+10 more)
...
Cohesion: 0.20
Nodes (16): getWebhookLogUrlMetadata(), getWebhookPublicUrlValidationError(), parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, checkWebhookPermissionV2(), bodySchema, post(), bodySchema (+8 more)
...
Cohesion: 0.27
Nodes (5): buildHelpMenuOptions(), HelpMenuOption, PATTERNS, redactSecrets(), t()
...
Cohesion: 0.28
Nodes (9): getEmptyBillingSnapshotCounts(), getGlobalStatsNotificationStepAction(), getNumber(), hasCompletedGlobalStatsNotifications(), markGlobalStatsShardComplete(), normalizeBillingSnapshotCounts(), normalizePlanTotals(), runGlobalStatsNotificationProviderStep() (+1 more)
...
- **Why does `Database` connect `Community 68` to `Community 3`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 20`, `Community 25`, `Community 26`, `Community 28`, `Community 30`, `Community 162`, `Community 43`, `Community 44`, `Community 45`, `Community 48`, `Community 177`, `Community 53`, `Community 313`, `Community 63`, `Community 193`, `Community 72`, `Community 76`, `Community 340`, `Community 89`, `Community 120`, `Community 122`?**
  _High betweenness centrality (0.217) - this node is a cross-community bridge._
- **Why does `cloudlog()` connect `Community 24` to `Community 128`, `Community 1`, `Community 2`, `Community 4`, `Community 132`, `Community 6`, `Community 136`, `Community 9`, `Community 138`, `Community 268`, `Community 140`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 31`, `Community 32`, `Community 35`, `Community 36`, `Community 42`, `Community 51`, `Community 55`, `Community 185`, `Community 61`, `Community 208`, `Community 209`, `Community 82`, `Community 210`, `Community 86`, `Community 87`, `Community 90`, `Community 219`, `Community 98`, `Community 102`, `Community 108`, `Community 116`, `Community 117`, `Community 123`, `Community 255`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.0226833603833372 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02218161514643927 - nodes in this community are weakly interconnected._