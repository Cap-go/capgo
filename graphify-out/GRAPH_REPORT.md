...
## Corpus Check
- Large corpus: 2121 files · ~4,223,016 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 11553 nodes · 24352 edges · 725 communities (600 shown, 125 thin omitted)
...
## Communities (725 total, 125 thin omitted)
...
Cohesion: 0.02
Nodes (232): replaceApiKeyGlobalPermissionsForExistingBindings(), post(), setChannel(), checkWriteAppAccess(), assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertString() (+224 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (189): app, assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), logDeviceRequestContext(), recordDeviceIPRateLimit(), recordDeviceRateLimitSafely(), assertPublicPluginApp() (+181 more)
...
Cohesion: 0.02
Nodes (144): appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials, buildCredentialsSchema (+136 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (143): get(), getAll(), app, CreateApp, AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle() (+135 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (178): scripts, admin:backfill-credit-usage-posthog, admin:backfill-missing-app-icons, admin:backfill-missing-store-urls, admin:backfill-paid-product-activity, admin:backfill-plugin-version-ladder, api:dev, api:preprod (+170 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (109): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, app (+101 more)
...
Cohesion: 0.03
Nodes (131): app, app, ensureOrgMembership(), ensureOrgMembershipInTransaction(), EnsureOrgMembershipResult, ensurePublicUserRowExists(), ensurePublicUserRowExistsInTransaction(), extractProviderId() (+123 more)
...
Cohesion: 0.03
Nodes (113): get(), auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), adminStatsBodySchema, app, canAccessRequestedOrg() (+105 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (103): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+95 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (108): app, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor (+100 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (75): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), Channel, checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel() (+67 more)
...
Cohesion: 0.04
Nodes (91): ExistingOrganizationApp, PendingOnboardingApp, askForAppId(), askForAppName(), askForWebDir(), BuildProjectStepOutcome, CancelablePromptValue, cancelBeforeAuthenticatedOnboarding() (+83 more)
...
Cohesion: 0.04
Nodes (61): CheckDomainResponse, spoof(), PUBLIC_ROUTES, SsoEnforcementResponse, fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType (+53 more)
...
Cohesion: 0.04
Nodes (65): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, createChannel(), versionCache, apiKeyHasAnyAppPermission() (+57 more)
...
Cohesion: 0.05
Nodes (59): adminDeleteIdentity(), fallbackDeleteEmailIdentity(), getOrgPrelinkCandidates(), maskEmail(), PrelinkCandidate, PrelinkUsersRequest, PUBLIC_EMAIL_DOMAINS, runPrelinkUsers() (+51 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (62): plans, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes (+54 more)
...
Cohesion: 0.04
Nodes (56): findMonorepoRoot, findNXMonorepoRoot, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, CapgoConfig, CapgoFilesConfig (+48 more)
...
Cohesion: 0.04
Nodes (50): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+42 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (55): assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildNormalizedUploadMetadataHeader(), calculateBytesTransferred(), canReplayUploadRequest() (+47 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (60): getAppsFromCF(), getUpdateStatsCF(), readDeviceVersionCountsCF(), serializeStatsMetadata(), trackBandwidthUsageCF(), trackLogsCF(), trackLogsCFExternal(), trackVersionUsageCF() (+52 more)

### Community 34 - "Community 34"
Cohesion: 0.08
Nodes (56): checkAppIdsExist(), completePendingOnboardingApp(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), applyInitAutoTestChange() (+48 more)
...
Cohesion: 0.05
Nodes (55): AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOrgMetrics, AdminPlatformOverview (+47 more)
...
Cohesion: 0.07
Nodes (45): enableSupabaseInstrumentation(), trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState (+37 more)
...
Cohesion: 0.08
Nodes (37): handleBundleUploadCommand(), getLinkedBundleOnChannel(), buildBundleUploadPreviewQrOptions(), AppRow, assertAppAllowsPreview(), buildPreviewQrUrl(), BundleRow, CapgoSupabaseClient (+29 more)
...
Cohesion: 0.10
Nodes (38): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, buildReadDevicesCFQuery(), buildStatsInsightsActionFilter() (+30 more)

### Community 66 - "Community 66"
Cohesion: 0.08
Nodes (32): Digester, noopDigester(), sha256Digester(), parseChecksum(), parseUploadMetadata(), UploadMetadata, AttachmentUploadHandler, Env (+24 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (38): addUpdaterStep(), ensureUpdaterReadyBeforeSync(), formatInheritedCommandFailure(), formatSpawnOutput(), getCompatibleUpdaterVersionForPackage(), getUpdaterInstallBlocker(), getUpdaterInstallCommand(), getUpdaterVersionToInstall() (+30 more)
...
Cohesion: 0.09
Nodes (34): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+26 more)

### Community 74 - "Community 74"
Cohesion: 0.10
Nodes (36): buildProjectStep(), ensureNativePlatformForBuild(), getInitRecoveryCommands(), normalizeRunDevicePlatform(), PlatformChoice, runCapacitorPlatformAdd(), runPackageRunnerSync(), log (+28 more)
...
Cohesion: 0.08
Nodes (27): bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), creditPricingMetricOrder, CreditPricingStep (+19 more)
...
Cohesion: 0.09
Nodes (27): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+19 more)
...
Cohesion: 0.09
Nodes (27): cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogData, LogSpec, markSnag() (+19 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (25): appIdParamSchema, invalidBindingIdHook, AssignablePrincipal, canManageRoleBindingScope(), CreateBindingResult, createRoleBindingForPrincipal(), getCallerMaxPriorityRank(), getLegacyChannelRowId() (+17 more)
...
Cohesion: 0.10
Nodes (25): CompatibilityResult, displayCompatibilityTable(), assertIntegerInRange(), assertOptionalConfidence(), assertOptionalIntegerInRange(), disableAutoUpdatesPossibleOptions, displayCompatibilityTable(), setChannel() (+17 more)
...
Cohesion: 0.17
Nodes (25): exitCanceledInitOnboarding(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getNativePlatformAvailability(), getRunDeviceCommand(), getRunTargetLabel(), getSelectablePlatformOptions(), getSkippedRunDeviceCommand() (+17 more)
...
Cohesion: 0.09
Nodes (16): bindingIdParamSchema, groupIdParamSchema, groupMemberParamSchema, invalidAppIdHook, invalidGroupIdHook, invalidGroupMemberParamHook, invalidScopeTypeHook, NON_EMPTY_STRING_SCHEMA (+8 more)
...
Cohesion: 0.11
Nodes (17): base, base, base, buildBuilderOnboardingBentoEvent(), BUILDER_RECOVERY_MILESTONES, BuilderOnboardingBentoInput, MILESTONE_TO_BENTO_EVENT, buildBundleCompatibilityBentoEvent() (+9 more)
...
Cohesion: 0.15
Nodes (16): countDevicesCF(), countInstallSourcesCF(), assertAnalyticsEngineReadConfig(), countDevices(), countInstallSources(), hasAnalyticsEngineReadConfig(), readDevices(), readStatsBandwidth() (+8 more)
...
Cohesion: 0.15
Nodes (13): getInfoInternal(), getInstalledDependencies(), runInitDoctorDiagnostics(), detectProjectFrameworkFromConfig(), detectProjectFrameworkFromDependencies(), detectProjectTypeInDir(), findMainFile(), findMainFileForProjectType() (+5 more)
...
Cohesion: 0.28
Nodes (5): app, mocks, GLOBAL_STATS_SHARDS, REQUIRED_GLOBAL_STATS_SHARDS, USAGE_GLOBAL_STATS_SHARDS
...
## Knowledge Gaps
- **3906 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3901 more)
...
- **Why does `Database` connect `Community 92` to `Community 4`, `Community 135`, `Community 138`, `Community 396`, `Community 12`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 22`, `Community 28`, `Community 29`, `Community 31`, `Community 35`, `Community 42`, `Community 44`, `Community 45`, `Community 48`, `Community 50`, `Community 64`, `Community 77`, `Community 79`, `Community 208`, `Community 83`, `Community 345`, `Community 96`, `Community 358`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.021023513139695714 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02208317997791682 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.025770849926043917 - nodes in this community are weakly interconnected._