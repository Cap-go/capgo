...
## Corpus Check
- Large corpus: 2110 files · ~4,209,285 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 11480 nodes · 24224 edges · 732 communities (608 shown, 124 thin omitted)
...
Cohesion: 0.02
Nodes (167): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, appGlobal (+159 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (221): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError(), addAppStep() (+213 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (185): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+177 more)
...
Cohesion: 0.03
Nodes (166): filterDeviceKeys(), get(), GetDevice, publicDevice, formatBytes(), formatNumber(), funComparisons, getFunComparison() (+158 more)
...
Cohesion: 0.03
Nodes (125): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult, deleteChannelSelfOverrideForDevice() (+117 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (122): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+114 more)
...
Cohesion: 0.06
Nodes (99): getInvocationSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, resolveAppSetIconPath() (+91 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (109): areGlobalStatsNumbersDifferent(), BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, buildLogsnagInsightsRetryMessage(), buildLogsnagInsightsShardMessage(), buildRecentGlobalStatsRepairDateIds(), BuildShardStats (+101 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (102): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), checkoutSessionEventTypes (+94 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (81): createRSA(), setSetting(), setSettingInternal(), loadConfig(), writeConfig(), writeConfigUpdater(), CapacitorConfig, capacitorConfigSchema (+73 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (72): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+64 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (83): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, SAMPLE_REFERENCE_DATE, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics (+75 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (78): DeliveryMessage, safeParseSchema(), AuthInfo, serializeError(), apikeyHasOrgRight(), allowLocalWebhookUrls(), AuditLogData, base64Encode() (+70 more)
...
Cohesion: 0.04
Nodes (72): app, fetchRegionVersion(), getDifferences(), getExpectedVersion(), getPluginRegionVersions(), parseWorkerVersion(), PluginRegionDifference, PluginRegionResult (+64 more)
...
Cohesion: 0.06
Nodes (54): streamCommandInInitPanel(), appendInitStreamingLine(), clearInitLogs(), clearPrompt(), ConfirmPrompt, emit(), ensureInitInkSession(), INIT_CANCEL (+46 more)
...
Cohesion: 0.07
Nodes (60): normalizeTargetLimit(), resolveTargetPlan(), analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret() (+52 more)
...
Cohesion: 0.05
Nodes (41): app, ResolvedTrackingId, TrackEventBody, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction() (+33 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (46): base, base, base, PluginNotificationBatchBody, buildBuilderOnboardingBentoEvent(), BUILDER_RECOVERY_MILESTONES, BuilderOnboardingBentoInput, MILESTONE_TO_BENTO_EVENT (+38 more)
...
Cohesion: 0.08
Nodes (40): CacheStore, CacheKey, createGuardApp(), APIKeyRateLimitScope, buildResetAt(), bytesToHex(), clearFailedAccountAuth(), clearFailedAuth() (+32 more)
...
Cohesion: 0.08
Nodes (45): createNotificationDeliveryEventProofFromSecret(), NativeNotificationQueueMessage, NativeNotificationRegistryRow, aesKeyFromSecret(), AnalyticsApiResponse, canRetry(), chunkDeviceRows(), convertAnalyticsRows() (+37 more)
...
Cohesion: 0.09
Nodes (34): checkAlerts(), checkVersionStatus(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies() (+26 more)
...
Cohesion: 0.11
Nodes (30): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), getRunDeviceCommandForPlatform(), assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions (+22 more)
...
Cohesion: 0.24
Nodes (22): baseResult(), decideAdvance(), decideAtStep(), decideStart(), drive(), explainLiveUpdateOnboarding(), gatherFacts(), GitRepoStatus (+14 more)
...
Cohesion: 0.15
Nodes (23): getCompletedDayWindowForDateId(), getEmptySubscriptionAccessSnapshotCounts(), getMetricWindowFromDailyWindow(), isMissingBuildMetricColumnError(), readGlobalStatsPastDueSnapshot(), runBuildsGlobalStatsShard(), runLogsnagInsightsShard(), runLtvGlobalStatsShard() (+15 more)
...
Cohesion: 0.14
Nodes (15): calculateConversionRate(), getGithubStars(), getPaidPlanTotal(), getPlanConversionRates(), runCoreGlobalStatsShard(), countUpdatesFromStoreAppsCF(), getAppsFromCF(), getAppsToProcessCF() (+7 more)
...
Cohesion: 0.18
Nodes (10): DependencySection, getDeclaredDependency(), PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson(), UpdaterInstallState, readUpdaterState(), writeFile() (+2 more)
...
Cohesion: 0.32
Nodes (7): Platform, EngineDeps, LiveUpdateFacts, LiveUpdateProgress, LiveUpdateSessionState, mergeDefined(), registry
...
Cohesion: 0.60
Nodes (4): countInstallSources(), readStatsBandwidth(), countInstallSourcesSB(), readBandwidthUsageSB()
...
## Knowledge Gaps
- **3877 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3872 more)
...
- **Why does `Database` connect `Community 12` to `Community 128`, `Community 5`, `Community 10`, `Community 15`, `Community 16`, `Community 403`, `Community 19`, `Community 23`, `Community 24`, `Community 25`, `Community 287`, `Community 32`, `Community 33`, `Community 38`, `Community 167`, `Community 40`, `Community 47`, `Community 180`, `Community 53`, `Community 57`, `Community 72`, `Community 73`, `Community 209`, `Community 337`, `Community 90`, `Community 353`, `Community 368`, `Community 121`, `Community 125`?**
...
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _3880 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.003992015968063872 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.024738955823293173 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.026025600113463106 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.02095307977660919 - nodes in this community are weakly interconnected._