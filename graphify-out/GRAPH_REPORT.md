# Graph Report - capgo.app  (2026-07-24)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 1929 files · ~4,284,684 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13113 nodes · 23984 edges · 884 communities (743 shown, 141 thin omitted)
...
1. `scripts` - 190 edges
2. `supabaseAdmin()` - 158 edges
3. `scripts` - 152 edges
4. `getSupabaseClient()` - 132 edges
5. `Database` - 120 edges
6. `formatError()` - 89 edges
7. `findSavedKey()` - 75 edges
8. `checkPermission()` - 72 edges
9. `createSupabaseClient()` - 63 edges
10. `GuidedFlowModel` - 61 edges
...
- `getGlobalAnalyticsProps()` --calls--> `Release`  [INFERRED]
  cli/src/analytics/global-props.ts → supabase/functions/_backend/files/util.ts
- `getClackCancelSymbol()` --calls--> `isCancel()`  [INFERRED]
  tests/builder-cta.unit.test.ts → cli/src/init/prompts.ts
- `getClackCancelSymbol()` --calls--> `select()`  [INFERRED]
  tests/builder-cta.unit.test.ts → cli/src/init/prompts.ts

## Import Cycles
- 1-file cycle: `shared/preview-subdomain.ts -> shared/preview-subdomain.ts`
- 1-file cycle: `supabase/functions/apikey/index.ts -> supabase/functions/apikey/index.ts`
- 1-file cycle: `supabase/functions/app/index.ts -> supabase/functions/app/index.ts`
- 1-file cycle: `supabase/functions/bundle/index.ts -> supabase/functions/bundle/index.ts`
- 1-file cycle: `supabase/functions/channel/index.ts -> supabase/functions/channel/index.ts`
- 1-file cycle: `supabase/functions/device/index.ts -> supabase/functions/device/index.ts`
- 1-file cycle: `supabase/functions/notifications/index.ts -> supabase/functions/notifications/index.ts`
...
## Communities (884 total, 141 thin omitted)
...
Cohesion: 0.03
Nodes (218): checkAppIdsExist(), completePendingOnboardingApp(), deleteAppInternal(), resolveCapacitorConfigTargetPath(), setConfigWriteTarget(), addAppStep(), addChannelStep(), addCodeChangeStep() (+210 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (144): appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema, BuildCredentials (+136 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (190): scripts, admin:backfill-credit-usage-posthog, admin:backfill-missing-app-icons, admin:backfill-missing-store-urls, admin:backfill-paid-product-activity, admin:backfill-plugin-version-ladder, api:dev, api:preprod (+182 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (116): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+108 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (152): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+144 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (125): formatBytes(), formatNumber(), funComparisons, getFunComparison(), getOrgIdForApp(), handleBillingPeriodStats(), handleDailyFailRatio(), handleDeployInstallStats() (+117 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (115): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+107 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (137): dependencies, better-qr, @bradenmacdonald/s3-lite-client, @capacitor/action-sheet, @capacitor/android, @capacitor/app, @capacitor/app-launcher, @capacitor/browser (+129 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (101): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps (+93 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (88): checkCompatibility(), checkCompatibilityInternal(), CompatibilityResult, summarizeUploadCompatibility(), UploadCompatibilityResult, UploadCompatibilitySummary, displayCompatibilityTable(), verifyCompatibility() (+80 more)
...
Cohesion: 0.05
Nodes (74): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), appGlobal, app (+66 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (78): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, findAppInOrganization(), getAppIconStoragePath(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), PendingOnboardingApp (+70 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (78): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), streamCommandInInitPanel(), ConfirmOptions, log, PromptResult, SelectOption (+70 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (51): createAuthenticatedSupabaseClient(), pgPool, deleteUserAs(), withAuthClient(), fixtureId, orgId, QueryFn, pool (+43 more)
...
Cohesion: 0.04
Nodes (44): adminStore, deliveryLatencyDays, devicesTrendSeries, displayStore, externalUpdatesSeries, isLoading, isLoadingGlobalStatsTrend, latestGlobalStats (+36 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (64): CheckDomainResponse, spoof(), fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getErrorMessage(), logAsUser() (+56 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (52): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+44 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (63): createRSA(), checkAlerts(), checkVersionStatus(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal() (+55 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (65): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, createChannel(), seedOptions, versionCache (+57 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (43): id, testOrgId, appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (66): assertSyncResult(), parseSchema(), parseSchemaAsync(), safeParseSchema(), safeParseSchemaAsync(), SafeParseSchemaResult, SchemaError, StandardSchema (+58 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (62): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), calculate(), addStorageIntervalToDailyBuckets(), applyStorageEvent(), AppOwnerOrgRow, assertStorageCycleWithinLimit() (+54 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (61): assertMemberRemovalAuthorizedAfterLock(), deleteBodySchema, deleteMember(), DrizzleClient, getMemberRemovalRanks(), MemberRemovalRanks, MemberRemovalRequest, PinnedPgClient (+53 more)
...
Cohesion: 0.05
Nodes (57): trackMcpServerStarted(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage() (+49 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (64): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+56 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (56): asyncPool(), createStripeClient(), createSupabaseServiceClient(), getArgValue(), getRequiredEnv(), getSupabaseServiceRoleKey(), isActionableStripeCustomerId(), loadEnv() (+48 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (64): devDependencies, adm-zip, @antfu/eslint-config, @aws-sdk/client-s3, bun-types, @capacitor/cli, @capacitor/core, @capgo/cli (+56 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (48): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), UpdateDeliveryScope, UpdateDeliveryStatsResponse, stripeEnabled, ArrayElement, Concrete (+40 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (55): analyticsRowsByApp, encryptToken(), fetchRequests, textEncoder, toBase64Url(), aesKeyFromSecret(), buildNotificationBadgeStateQuery(), buildNotificationStatsQuery() (+47 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (47): AppBuildOnboardingMetricRow, AppBuildOnboardingMetrics, BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, BuildShardStats, BuildStats, calculateSubscriptionAccessSnapshotCounts() (+39 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (42): configWriteTargetStore, getConfigWriteTarget(), loadConfig(), loadConfigForWrite(), loadConfigTarget(), withConfigWriteTarget(), writeConfig(), buildAppIdConflictSuggestions() (+34 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (45): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+37 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (43): app, canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId() (+35 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (54): AdditiveSchemaSyncOptions, AdditiveSchemaSyncPlan, AdditiveSchemaSyncResult, assertCatalogObject(), assertSchemaCatalog(), assertSchemaColumn(), assertSchemaCompositeAttribute(), assertSchemaConstraint() (+46 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (40): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, CompatibilityEventRow (+32 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (55): NativeNotificationProviderConfig, aesKeyFromSecret(), AnalyticsApiResponse, buildApnsJwt(), buildApnsPayload(), buildCollapseId(), buildFcmBody(), canRetry() (+47 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (50): app, appGlobal, assertAppPermission(), assertOptionalDate(), assertOptionalRecord(), assertProviderConfigReady(), assertString(), BadgeBody (+42 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (47): app, DataDevice, devicesBodySchema, orderItemSchema, app, createUtcDate(), DataStats, defaultInsightActions (+39 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (41): PKG_V6, PKG_V7, PKG_V7_DUP, ChannelRow, COMPATIBILITY_PLATFORMS, CompatibilityAutoResolve, CompatibilityBundle, CompatibilityEventInsert (+33 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (31): ctxWith(), aCtx(), withManifest(), aCtx(), ctxWith(), ctxFor(), plist(), b64() (+23 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (40): assertCloudSqlDataApiResponseSucceeded(), CloudSqlDataApiResponse, ReadReplicaSchemaSyncPlan, ReadReplicaSchemaSyncStatement, readReplicaSubscriberCompatibilityIssues(), assertColumnStatement(), assertCompleteDataApiResponse(), assertConstraintStatement() (+32 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (46): assertRawAttachmentRouteIdHasValidEncoding(), assertValidPercentEncodedAttachmentKey(), ATTACHMENT_PLAN_LIMIT, ATTACHMENT_ROUTE_PREFIXES, buildDurableObjectRequest(), buildNormalizedUploadMetadataHeader(), calculateBytesTransferred(), canReplayUploadRequest() (+38 more)
...
Cohesion: 0.05
Nodes (30): TEST_ORG_ID, CreditStep, callLogAs(), seedStaleCreatedByOrg(), createGroupOrgBinding(), createUserOrgBinding(), fixtureId, getOrgRoleId() (+22 more)

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (43): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema, globalId, ORG_ID (+35 more)

### Community 51 - "Community 51"
Cohesion: 0.06
Nodes (43): CLIActivityPayload, useRealtimeCLIFeed(), displayStore, mainStore, router, { t }, triggerFakeReplicationToast(), activeCount (+35 more)

### Community 52 - "Community 52"
Cohesion: 0.05
Nodes (47): adminStore, ago(), buildAverageSecondsTrendSeries, builderActivityTrendSeries, buildPeriodSubtitle(), buildsLastMonthTrendSeries, buildsSeries, buildsTrendSeries (+39 more)
...
Cohesion: 0.05
Nodes (44): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOnboardingFunnel, AdminOrganizationInsightRow (+36 more)
...
Cohesion: 0.07
Nodes (36): buildInitReplayBody(), buildTerminalImageDataUrl(), chunkToString(), CliStream, createTerminal(), createTerminalInteractionEvents(), createTerminalSnapshot(), createTerminalSnapshotNode() (+28 more)
...
Cohesion: 0.09
Nodes (36): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), isSsoProvider() (+28 more)
...
Cohesion: 0.07
Nodes (36): classes, globals, rootClasses(), availableLocales, ensureLanguageLoaded(), FALLBACK_LOCALE, fetchRemoteMessages(), getNavigatorLanguage() (+28 more)
...
Cohesion: 0.07
Nodes (37): app, bodySchema, CreateDeviceBody, app, CliReplayBody, readOptionalString(), readProperties(), readRequiredString() (+29 more)

### Community 64 - "Community 64"
Cohesion: 0.10
Nodes (38): DeliveryMessage, allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload(), bytesToArrayBuffer(), createDeliveryRecord() (+30 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (32): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+24 more)
...
Cohesion: 0.09
Nodes (36): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, parseApiKeyGlobalPermissions(), replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+28 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (31): Digester, noopDigester(), sha256Digester(), isRetryableDurableObjectFetchError(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata (+23 more)

### Community 69 - "Community 69"
Cohesion: 0.05
Nodes (36): AdminCancelledOrganizationRow, AdminCancelledOrganizationsResult, AdminCustomerCountryBreakdown, AdminDeploymentsTrend, AdminEmailTypeBreakdown, AdminGlobalStatsTrend, AdminOnboardingFunnel, AdminOrganizationInsightRow (+28 more)

### Community 70 - "Community 70"
Cohesion: 0.11
Nodes (33): createHashedKeySDK(), uploadBundleWithHashedKey(), assertCompatibilityTableColumns(), createCustomPackageJson(), writeBundleContent(), getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum() (+25 more)

### Community 71 - "Community 71"
Cohesion: 0.11
Nodes (32): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), AppRow, assertAppAllowsPreview(), buildPreviewQrUrl(), BundleRow, CapgoSupabaseClient, ChannelRow (+24 more)
...
Cohesion: 0.06
Nodes (36): api_domain, development, local, preprod, prod, base_domain, development, local (+28 more)

### Community 74 - "Community 74"
Cohesion: 0.08
Nodes (19): createInheritedOrgAdminApiKey(), createRbacApiKey(), createSeededAppApiKey(), expectApiKeyRow(), fillApiKeyName(), INHERITED_ORG_ID, openCreateKeyDialog(), RoleBindingWithRole (+11 more)

### Community 75 - "Community 75"
Cohesion: 0.09
Nodes (35): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+27 more)

### Community 76 - "Community 76"
Cohesion: 0.07
Nodes (25): applyReadReplicaAdditiveSchemaSync, applyReadReplicaSchemaSync(), assertAppliedStatementsVisible(), assertTimeRemaining(), positiveIntegerOrDefault(), ReadReplicaSchemaSyncClient, reconcileReadReplicaSchema(), setStatementTimeoutForRemainingBudget() (+17 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (36): BackfillFailure, buildHealthcheckPayload(), createHealthcheck(), CronTaskRow, CronTaskUpdate, fetchCronTasks(), formatPeriod(), getCronExpression() (+28 more)
...
Cohesion: 0.08
Nodes (15): assertFitsBudget(), flush(), frameRows(), makeStdin(), makeStdout(), REFERENCE_WIDTHS, renderFrameText(), renderResizeFrames() (+7 more)

### Community 81 - "Community 81"
Cohesion: 0.10
Nodes (36): syncOrgSubscriptionData(), buildSupabaseDashboardLink(), createCheckout(), createOneTimeCheckout(), createPortal(), CreditCheckoutDetails, CreditCheckoutItemSummary, DatafastAttribution (+28 more)

### Community 82 - "Community 82"
Cohesion: 0.10
Nodes (35): assertSchemaCatalog(), columnKey(), compareColumns(), compareConstraints(), compareExpectedColumns(), compareExpectedIndexes(), compareFunctions(), compareIndexes() (+27 more)
...
Cohesion: 0.08
Nodes (24): BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), BUILD_SERIES_KEYS, BuildChartWindow, BuildSeriesData, buildSeriesKey (+16 more)

### Community 85 - "Community 85"
Cohesion: 0.12
Nodes (30): isOptionalString(), isOptionalStringMaxLength(), isStatsRequestBody(), isValidStatsMetadata(), isUpdateRequestBody(), ALLOWED_STATS_ACTIONS_SET, DevicePlatform, fieldIssue() (+22 more)
...
Cohesion: 0.11
Nodes (25): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), attachApiKeyGlobalPermissions(), app (+17 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (32): src, capacitor, android, ios, optional, description, devDependencies, @capacitor/android (+24 more)

### Community 90 - "Community 90"
Cohesion: 0.11
Nodes (29): assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions, renderNotificationHelper(), runCommand(), runInstall(), runSync() (+21 more)

### Community 91 - "Community 91"
Cohesion: 0.12
Nodes (32): buildAddColumnStatement(), buildAlterSequenceStatement(), buildAttachConstraintStatement(), buildCreateIndexStatement(), buildCreateOrReplaceFunctionStatement(), buildCreateSequenceStatement(), buildDropIndexStatement(), buildReindexIndexStatement() (+24 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (25): getNativeExternalPurchaseRedirect(), isNativeExternalPurchaseRestrictedPath(), nativeExternalPurchaseRestrictedPaths, normalizePath(), getErrorMessage(), isKnownCrawlerNoiseErrorMessage(), isStaleAssetErrorMessage(), KNOWN_CRAWLER_ERROR_PATTERNS (+17 more)

### Community 93 - "Community 93"
Cohesion: 0.11
Nodes (29): additionalDefaultStarRepositories, checkIfStarred(), createAbortedError(), createStartRateLimiter(), dedupeRepositories(), ensureGhReady(), executeGhCommand(), fallbackStarRepositories (+21 more)
...
Cohesion: 0.08
Nodes (28): AiBinding, buildBatches(), jsonCandidates(), LANGUAGE_NAMES, MessageEntry, normalizeTranslationError(), parseJsonCandidate(), parseTranslationObject() (+20 more)

### Community 98 - "Community 98"
Cohesion: 0.11
Nodes (30): assertCanPromoteChannelInTransaction(), ChannelRow, DrizzleClient, fetchTargetChannel(), fetchVersionName(), getEffectiveApikey(), PgQueryClient, setChannel() (+22 more)
...
Cohesion: 0.08
Nodes (24): AssignablePrincipal, canManageRoleBindingScope(), CreateBindingResult, DrizzleClient, DrizzleExecutor, getCallerMaxPriorityRank(), getLegacyChannelRowId(), isSupportedChannelId() (+16 more)
...
Cohesion: 0.09
Nodes (26): app, buildNativeObservePluginResponse(), buildNativeObserveResponse(), BuildNativeObserveResponseInput, createSeries(), durationExpression, generateDateLabels(), issueActions (+18 more)
...
Cohesion: 0.14
Nodes (24): BuilderStatusResponse, calculateBuildRuntimeSeconds(), calculateRunnerWaitSeconds(), calculateTimeoutCompletedAt(), capBuildRuntimeSeconds(), formatBuildTimeoutError(), hasBuildTimedOut(), isTerminalBuildStatus() (+16 more)

### Community 111 - "Community 111"
Cohesion: 0.10
Nodes (18): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString(), TrackEventBody (+10 more)
...
Cohesion: 0.10
Nodes (11): async, Any, ASCSession, Int, Never, NSImage, URL, Void (+3 more)
...
Cohesion: 0.11
Nodes (25): APPLE_ASNS, APPLE_KEYWORDS, CacheableInvalidIpInfo, cachedInvalidIpInfo(), classifyProvider(), fetchProviderIpInfo(), getCachedFromMemory(), GOOGLE_ASNS (+17 more)
...
Cohesion: 0.10
Nodes (24): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+16 more)
...
Cohesion: 0.13
Nodes (24): appVersion, manifest, AutoUpdateBlockReason, getInvalidIpInfo(), getProviderInfrastructureInfo(), getResponseFeatureSupport(), getStoredChannelSelfOverride(), getUpdateResponseKind() (+16 more)

### Community 126 - "Community 126"
Cohesion: 0.14
Nodes (24): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, Platform (+16 more)
...
Cohesion: 0.11
Nodes (18): AnnotationOptions, inlineAnnotationPlugin, canSafelyUpdateChart(), clearTooltipSelection(), createCustomTooltip(), formatDateForTooltip(), formatTooltipValue(), getCanvasContext() (+10 more)

### Community 130 - "Community 130"
Cohesion: 0.12
Nodes (26): buildReadDevicesCFCursorCondition(), buildReadDevicesCFOuterConditions(), buildReadDevicesCFUpdatedAtGtCondition(), buildStatsInsightsActionFilter(), countDevicesCF(), countInstallSourcesCF(), countUpdatesFromLogsCF(), countUpdatesFromLogsExternalCF() (+18 more)

### Community 131 - "Community 131"
Cohesion: 0.15
Nodes (21): numberLikeSchema, apikeyHasOrgRight(), WEBHOOK_EVENT_TYPES, bodySchema, deleteWebhook(), getDeliveries(), bodySchema, get() (+13 more)
...
Cohesion: 0.09
Nodes (6): ApiKeyAccessOptions, bindApiKeyAccess(), bindApiKeyRole(), createHashedApiKey(), createPlainApiKey(), RequestRole

### Community 134 - "Community 134"
Cohesion: 0.14
Nodes (6): CAPBridgedPlugin, CapgoNotificationsPlugin, CAPPluginCall, CAPPluginMethod, Int, Void

### Community 135 - "Community 135"
Cohesion: 0.11
Nodes (14): Tab, TableAction, TableColumn, TableSort, accountTabs, adminTabs, appTabs, bundleTabs (+6 more)

### Community 136 - "Community 136"
Cohesion: 0.18
Nodes (3): UploadHandler, readIntFromHeader(), toBase64()

### Community 137 - "Community 137"
Cohesion: 0.16
Nodes (24): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), assertChannelSelfIPRateLimit(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult (+16 more)

### Community 138 - "Community 138"
Cohesion: 0.17
Nodes (23): buildBundlePreviewDeepLink(), buildChannelPreviewDeepLink(), buildChannelPreviewLatestOptions(), buildDeferredPreviewInstallReferrerUrl(), BundlePreviewLink, ChannelPreviewLink, DEFERRED_PREVIEW_REFERRER_KEYS, getHttpUrlParam() (+15 more)
...
Cohesion: 0.17
Nodes (25): closeClient(), createAdminTrialPlanTrendDay(), deleteChannelDevicePg(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown(), getAdminGlobalStatsTrend() (+17 more)
...
Cohesion: 0.12
Nodes (16): mockContext, plans, mockContext, stripeEventTestUtils, honoFactory, MiddlewareKeyVariablesStripe, middlewareStripeWebhook(), extractDataEvent() (+8 more)
...
Cohesion: 0.11
Nodes (21): analyticsOptOutCommands, applyCommandAnalyticsOptOut(), applyRawCommandAnalyticsOptOut(), queryTerminalPixelSize(), resolveCapgoReplayUrl(), resolveConfiguredCapgoReplayUrl(), resolveSupabaseReplayUrl(), shouldStartInitReplay() (+13 more)

### Community 145 - "Community 145"
Cohesion: 0.12
Nodes (21): AiBinding, app, buildBatches(), extractAiText(), extractContentText(), getTargetLanguageName(), keepTranslation(), LANGUAGE_NAMES (+13 more)
...
Cohesion: 0.13
Nodes (19): child, ensureSupabaseStarted(), functionsReadyTimeoutMs, generatedEnvPath, hasHealthySupabaseApi(), overriddenEnv, repoRoot, resetSupabaseDb() (+11 more)

### Community 148 - "Community 148"
Cohesion: 0.17
Nodes (20): buildOnPremResponse(), extractAppId(), fetch(), getCacheTtlSeconds(), getCircuitBreakerCacheKey(), getEndpointName(), getOnPremCache(), getOnPremCacheKey() (+12 more)

### Community 149 - "Community 149"
Cohesion: 0.14
Nodes (20): appendBulletedSection(), appendMetadataLine(), appendPlainSection(), diagnosticsLines(), nowStamp(), omittedMarker(), OnboardingSupportBundleInput, OnboardingSupportSection (+12 more)
...
Cohesion: 0.12
Nodes (21): AI_STEPS, dayKey(), FailedErrorRow, fingerprint(), FIRST_STEPS, getAdminBuilderAnalytics(), hogql(), HogResult (+13 more)

### Community 156 - "Community 156"
Cohesion: 0.17
Nodes (19): clearInviteOrgQuery(), closeDropdown(), createNewOrg(), getLogoRefreshKey(), handleOrganizationInvitation(), isInvitation(), isRowInteractive(), isSelected() (+11 more)

### Community 157 - "Community 157"
Cohesion: 0.11
Nodes (20): adminStore, cancelDebouncedSearchReload(), currentPage, displayStore, formatNumber(), formatPercent(), getOrganizationAttentionLabel(), isLoadingOrganizations (+12 more)

### Community 158 - "Community 158"
Cohesion: 0.13
Nodes (17): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, lintFailures, liveFailures (+9 more)

### Community 159 - "Community 159"
Cohesion: 0.11
Nodes (19): app, buildScopedDeliveriesCte(), buildStatsQuery(), buildUpdateDeliveryResponse(), durationExpression, endActions, generateDateLabels(), NumericValue (+11 more)
...
Cohesion: 0.09
Nodes (22): AppInfos, AppStats, BaseHeaders, Customer, DeviceRes, DeviceWithoutCreatedAt, NativeVersionUsage, Order (+14 more)
...
Cohesion: 0.12
Nodes (10): ChannelPromotionPermissionChecker, ChannelPromotionTarget, findChannelsWithoutPromotionPermission(), formatChannelPromotionTargets(), checkPermissions(), CheckPermissionsOptions, hasPermission(), Permission (+2 more)
...
Cohesion: 0.24
Nodes (18): formatDate(), formatDistanceToNow(), formatLocalDate(), formatLocalDateLong(), formatLocalDateShort(), formatLocalDateTime(), formatLocalDateTimeWithSeconds(), formatLocalMonthYear() (+10 more)
...
Cohesion: 0.17
Nodes (20): AutoPauseAction, AutoPauseEvaluationInput, AutoPauseEvaluationResult, buildPayload(), clampInteger(), evaluateAutoPausePolicy(), getDeltaProbabilityBps(), getRolloutDecision() (+12 more)
...
Cohesion: 0.15
Nodes (22): countDemoSeededApps(), getBundleStorageGb(), getCompletedDayWindowForDateId(), getLtvStats(), getMetricWindowFromDailyWindow(), getRegistersToday(), isMissingBuildMetricColumnError(), runBuildsGlobalStatsShard() (+14 more)
...
Cohesion: 0.10
Nodes (5): clearAllSessions(), test(), test(), test(), test()

### Community 178 - "Community 178"
Cohesion: 0.15
Nodes (20): AxisConfig, colorChannelToLinear(), createChartColorWithOpacity(), createChartScales(), createStackedChartScales(), createXAxisConfig(), createYAxisConfig(), DARK_CHART_BACKGROUND (+12 more)

### Community 179 - "Community 179"
Cohesion: 0.12
Nodes (13): longLog, render(), makeStdin(), makeStdout(), renderShellAt(), watchdog, makeStdin(), makeStdout() (+5 more)

### Community 180 - "Community 180"
Cohesion: 0.21
Nodes (20): buildCleanupPromises(), buildGroupMembersByGroup(), buildOrgAdminUsers(), collectCandidateOrgIds(), deleteUser(), deleteUserImages(), fetchDirectRbacBindings(), fetchGroupMembers() (+12 more)

### Community 181 - "Community 181"
Cohesion: 0.15
Nodes (11): appGlobal, app, app, app, app, registerPluginStatsSbFallbacksForDeno(), appGlobal, consoleHeaders (+3 more)

### Community 182 - "Community 182"
Cohesion: 0.14
Nodes (12): creditPricingDisclaimer, ensureBillingAccess(), formatMetricAmount(), handleBuyCredits(), handleCreditCheckoutReturn(), loadTransactions(), metricLabel(), paginatedDailyTransactions (+4 more)
...
Cohesion: 0.14
Nodes (12): androidBridgeDeps(), appPhaseDeps(), buildReadyProgress(), fakeDeps(), iosDeps(), makeKeystorePersistDeps(), makeOAuthSessionFake(), minimalFacts (+4 more)

### Community 185 - "Community 185"
Cohesion: 0.10
Nodes (15): assertCanPromoteChannelInTransaction, checkPermission, checkPermissionPg, closeClient, dbClient, drizzle, getDrizzleClient, getPgClient (+7 more)

### Community 186 - "Community 186"
Cohesion: 0.21
Nodes (20): claimTranslationBatch(), deleteExpiredTranslationStoreEntries(), deleteTranslationStoreEntry(), ensureTranslationStore(), getTranslationStore(), insertPendingTranslationStoreEntry(), messageCatalogOf(), parseTranslationStoreEntry() (+12 more)

### Community 187 - "Community 187"
Cohesion: 0.12
Nodes (14): enrolledFactorId, enrollTotp(), mfaQRCode, mfaVerificationCode, mfaVerifying, otpEmail, otpSending, otpVerificationCode (+6 more)

### Community 188 - "Community 188"
Cohesion: 0.18
Nodes (18): errorHints, extractExtra(), getConfiguredUpdaterVersion(), getProbeDefaultChannel(), getUpdateUrl(), NativeVersionInfo, parseAndroidNativeVersion(), ParsedUpdateResponse (+10 more)
...
Cohesion: 0.11
Nodes (18): imports, adm-zip, @bradenmacdonald/s3-lite-client, @cloudflare/workers-types, cron-schedule, dayjs, discord-api-types/, drizzle-orm (+10 more)

### Community 193 - "Community 193"
Cohesion: 0.12
Nodes (8): PUBLIC_ROUTES, SsoEnforcementResponse, AppContext, UserModule, getGuard(), mockGetSession, mockGetSpoofedAdminJwt, mockSignOut
...
Cohesion: 0.14
Nodes (13): app, ensureOrgMembership(), ensureOrgMembershipInTransaction(), EnsureOrgMembershipResult, ensurePublicUserRowExistsInTransaction(), extractProviderId(), getAuthenticatedSsoProviders(), mergeSsoIdentityWithExistingAccount() (+5 more)
...
Cohesion: 0.11
Nodes (18): apikeys, app_versions, apps, channel_devices, channels, disableUpdatePgEnum, group_members, groups (+10 more)
...
Cohesion: 0.18
Nodes (19): cacheReadyStoreEntry(), cacheReadyTranslationPayload(), cloudlogErr(), corsHeaders(), errorResponse(), fetch(), fetchHandler(), handleTranslationMessages() (+11 more)

### Community 204 - "Community 204"
Cohesion: 0.17
Nodes (19): areGlobalStatsNumbersDifferent(), dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), ensureGlobalStatsSnapshotRow(), ensureGlobalStatsSnapshotRows(), getEmptyBuildShardStats() (+11 more)
...
Cohesion: 0.16
Nodes (15): app, buildWorkersCacheKey(), CachedFiles, CachedFilesLoopback, fetch(), FilesExecutionContext, filesWorkerCacheTestUtils, getRequestHostname() (+7 more)
...
Cohesion: 0.17
Nodes (14): Release, capturePosthogException(), CapturePosthogExceptionPayload, CliPosthogExceptionKind, getCommanderCode(), getCommandPath(), getPosthogExceptionUrl(), getPosthogToken() (+6 more)
...
Cohesion: 0.20
Nodes (16): decodePreviewAppId(), parseChannelId(), ParsedBundlePreviewSubdomain, ParsedChannelPreviewSubdomain, parseEncodedPreviewSubdomain(), parseLegacyPreviewSubdomain(), parsePreviewSubdomain(), parseVersionId() (+8 more)
...
Cohesion: 0.13
Nodes (13): accumulateData, dataMax, evolution, generateAnnotations, generateAppColors(), getSafeHue(), hasAppData, isReservedHue() (+5 more)

### Community 225 - "Community 225"
Cohesion: 0.19
Nodes (10): readInitInternalLogLines(), buildHelpMenuOptions(), HelpMenuOption, getInternalLogPath(), SAFE_RESPONSE_HEADERS, safeHeaders(), sanitize(), stamp() (+2 more)

### Community 226 - "Community 226"
Cohesion: 0.24
Nodes (16): ensureFunctionsEnvFile(), ensureSymlink(), ensureWorktreeSupabaseDir(), getLocalSupabaseCli(), getStatusJson(), getSupabaseCmd(), hasSupabaseCli(), main() (+8 more)
...
Cohesion: 0.12
Nodes (16): dependencies, happy-dom, ink, ink-spinner, @inkjs/ui, jsonwebtoken, node-forge, qrcode (+8 more)
...
Cohesion: 0.27
Nodes (16): closeClient(), createAdminTrialPlanTrendDay(), getAdminCancelledOrganizations(), getAdminCustomerCountryBreakdown(), getAdminDeploymentsTrend(), getAdminEmailTypeBreakdown(), getAdminGlobalStatsTrend(), getAdminOnboardingFunnel() (+8 more)
...
Cohesion: 0.19
Nodes (13): capturePosthogException(), capturePosthogReplaySnapshot(), getPostHogExceptionUrl(), getPostHogSnapshotUrl(), getRequestPath(), jsonByteLength(), parseExceptionFrames(), PostHogCapturePayload (+5 more)
...
Cohesion: 0.12
Nodes (14): ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, GLOBAL_STATS_TREND_DATES, NOW, ONBOARDING_LATE_SUBSCRIPTION_ORG_ID, ONBOARDING_NO_BUNDLE_ORG_ID (+6 more)
...
Cohesion: 0.20
Nodes (12): buildProcessingKey(), flushQueuedPluginNotifications(), getPluginNotificationThrottleTtlSeconds(), getPluginNotificationTriggerUrl(), PluginNotificationFlushResult, PluginNotificationTransferResult, PluginNotificationTriggerBody, postPluginNotificationBatch() (+4 more)
...
Cohesion: 0.19
Nodes (12): configuredWorkers, localStripeApiBaseUrl, localStripeEmulatorPort, { ports: supabasePorts }, webServer, getPlaywrightStripeApiBaseUrl(), getStripeEmulatorPort(), getConfiguredPortOffset() (+4 more)

### Community 247 - "Community 247"
Cohesion: 0.21
Nodes (12): capgoRootMatchers, Component, componentMatchers, getChangedFiles(), getCommitMessage(), getCommitShas(), getSeverity(), GitRunner (+4 more)
...
Cohesion: 0.16
Nodes (12): syncBentoSubscriberTagsMock, ALL_EMAIL_PREF_DISABLED_TAGS, ALL_EMAIL_TYPE_TAGS, ALL_LEGACY_TAGS, ALL_TAGS, buildDesiredTags(), buildTagDelta(), EMAIL_PREF_DISABLED_TAGS (+4 more)

### Community 252 - "Community 252"
Cohesion: 0.21
Nodes (15): claimedTranslationBatchIndex(), currentReadyTranslationResponse(), isPendingTranslationStale(), isReadyTranslationFresh(), isTranslationBatchLeaseExpired(), nextProcessableBatchIndex(), nowSeconds(), queueCurrentTranslationResponse() (+7 more)

### Community 253 - "Community 253"
Cohesion: 0.29
Nodes (10): writeLocalAiFile(), appendCapturedLine(), cleanupCapturedJobFiles(), CleanupOptions, getAiPromptPath(), getBaseDir(), getLogCapturePath(), shouldCaptureLogs() (+2 more)
...
Cohesion: 0.32
Nodes (13): decideAdvance(), decideAtStep(), decideStart(), mergeProgress(), nextAction(), runAutoEffect(), stepNumberFromProgress(), clearSession() (+5 more)

### Community 258 - "Community 258"
Cohesion: 0.18
Nodes (9): app, AppContext, getInviteNotificationLockKey(), getInviteResendRequiredPermission(), inviteExistingUserSchema, inviteNotificationCooldowns, lockInviteNotification(), unlockInviteNotification() (+1 more)
...
Cohesion: 0.23
Nodes (4): CacheHelper, CacheKeyParams, CacheLike, resolveGlobalCache()
...
Cohesion: 0.18
Nodes (14): claimGlobalStatsNotificationDelivery(), getBillingSnapshotCounts(), getEmptyBillingSnapshotCounts(), getGlobalStatsNotificationStepAction(), getNumber(), hasCompletedGlobalStatsNotifications(), markGlobalStatsShardComplete(), normalizeBillingSnapshotCounts() (+6 more)
...
Cohesion: 0.19
Nodes (10): AnalyzeBehavior, CiFailureActions, CiFailureActionsInput, decideCiFailureActions(), DecideInput, PostAnalyzeInput, PostAnalyzeStreamInput, RunCapgoAiAnalysisInput (+2 more)
...
Nodes (4): {
  ...
  getPgClientMock,
  closeClientMock,
}, OrganizationUpdateBuilder, OrgRow, pendingOrganizationUpdates

### Community 286 - "Community 286"
Cohesion: 0.18
Nodes (8): { closeClientMock, sendNotifOrgMock, sendNotifToOrgMembersOnceMock }, requestPluginNotifications(), getPluginNotificationItemResult(), PluginNotificationBatchBody, PluginNotificationItemResult, PluginNotificationSendResult, processPluginNotifications(), sendQueuedPluginNotification()

### Community 287 - "Community 287"
Cohesion: 0.24
Nodes (10): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+2 more)
...
Cohesion: 0.21
Nodes (12): buildLogsnagInsightsRetryMessage(), buildLogsnagInsightsShardMessage(), getLogsnagInsightsShardDelaySeconds(), getLogsnagInsightsShardFunctionName(), getLogsnagInsightsShardQueueKey(), queueLogsnagInsightsMessage(), queueLogsnagInsightsShard(), queueLogsnagInsightsShards() (+4 more)

### Community 299 - "Community 299"
Cohesion: 0.18
Nodes (12): calculateConversionRate(), countRegisteredUsersForSnapshot(), getAppBuildOnboardingMetrics(), getCoreSnapshotCounts(), getGithubStars(), getPaidPlanTotal(), getPlanConversionRates(), normalizeCoreSnapshotCounts() (+4 more)

### Community 300 - "Community 300"
Cohesion: 0.27
Nodes (10): callManagementAPI(), createSSOProvider(), deleteSSOProvider(), getProjectRef(), getSSOProvider(), ManagementAPIError, SSOProviderResponse, SSOProviderUpdate (+2 more)
...
Cohesion: 0.22
Nodes (7): drizzleErrorNames, filesUploadFunctionNames, parsePositiveInteger(), queueRetryHeaderNames, readRequestHeader(), sensitiveRequestBodyKeys, shouldSuppressQueueRetryAlert()
...
Cohesion: 0.22
Nodes (11): buildTranslationCacheRequest(), cloudlog(), currentSourceChecksum(), enqueueTranslationBatch(), fail(), getTranslationModel(), getTranslationQueue(), logStaleQueuedMessage() (+3 more)

### Community 319 - "Community 319"
Cohesion: 0.20
Nodes (11): calculateRevenue(), getEmptySubscriptionAccessSnapshotCounts(), getSubscriptionAccessSnapshotCounts(), getTrailing12mStart(), getTrialExtensionStats(), getUpgradeRate12m(), hasPersistedPastDueStats(), normalizeSubscriptionAccessSnapshotCounts() (+3 more)

### Community 320 - "Community 320"
Cohesion: 0.22
Nodes (11): filterCandidateGlobalStatsShards(), getGlobalStatsRepairShardQueueCandidates(), getGlobalStatsShardQueueCandidates(), getMissingGlobalStatsRequiredShards(), getMissingGlobalStatsShards(), normalizeCompletedGlobalStatsShards(), normalizeGlobalStatsRepairNumber(), normalizeGlobalStatsRepairRow() (+3 more)
...
Cohesion: 0.27
Nodes (10): normalizeTargetLimit(), resolveTargetPlan(), buildNotificationRegistryLookupQuery(), getAllNotificationBuckets(), normalizeNotificationTag(), readNotificationRegistrationsCF(), resolveNotificationBuckets(), normalizeMessageLimit() (+2 more)
...
Cohesion: 0.29
Nodes (7): bytesToGb(), ChecksumInfo, ChecksumType, formatBytes(), getDaysBetweenDates(), toFixed(), setAccountFormatLocale()

### Community 337 - "Community 337"
Cohesion: 0.27
Nodes (7): actionToFilter, failureActionFilterKeys, failureActions, filterToAction, statsActionFilters, HEALTH_STATS_ACTIONS, NATIVE_VERSION_STATS_ACTIONS
...
Cohesion: 0.31
Nodes (9): parseWebhookDeliveryVersion(), WebhookDeliveryVersion, bodySchema, buildWebhookUpdateData(), parseRequestedDeliveryVersion(), put(), PutWebhookBody, validateEvents() (+1 more)
...
Cohesion: 0.22
Nodes (9): buildDeviceIdsByInstallSourcesQuery(), buildInstallSourceList(), buildReadDevicesCFQuery(), getAdminOrgMetrics(), getReadDevicesCFOrder(), normalizeAnalyticsLimit(), readDeviceIdsByInstallSourcesCF(), readDevicesCF() (+1 more)

### Community 359 - "Community 359"
Cohesion: 0.44
Nodes (8): buildNormalizedDeviceForWrite(), DeviceComparable, DeviceExistingRowLike, hasComparableDeviceChanged(), normalizeDeviceCountryCode(), normalizeOptionalString(), toComparableDevice(), toComparableExisting()
...
Cohesion: 0.32
Nodes (8): addFirstSeenByApp(), buildAdminOnboardingProductionDeviceQuery(), buildAdminOnboardingUpdateDownloadQuery(), emptyAdminOnboardingTelemetry(), getAdminOnboardingTelemetry(), getAdminOnboardingTelemetryWindowFilter(), isAdminOnboardingTelemetryWithinRetention(), toValidDate()
...
Cohesion: 0.25
Nodes (8): getCachedReplicaLag(), getFreshReplicationLagMemoryEntry(), getReplicationLagCacheKey(), queryReplicaLag(), safeSetResponseHeader(), setReplicationLagHeader(), setReplicationLagMemoryEntry(), toReplicationLagSeconds()
...
Cohesion: 0.46
Nodes (7): buildOnPremCacheTag(), buildPlanCacheTag(), parseZoneIds(), purgeByTags(), purgeOnPremCache(), purgePlanCache(), purgePlanCacheForOrg()

### Community 398 - "Community 398"
Cohesion: 0.39
Nodes (7): getDeliveryById(), getWebhookById(), getWebhookLogUrlMetadata(), queueWebhookDelivery(), getDeliveriesSchema, retryDelivery(), retryDeliverySchema
...
Cohesion: 0.29
Nodes (4): isLogTooBig(), postAnalyzeStreamRequest(), runCapgoAiAnalysis(), baseInput
...
Cohesion: 0.48
Nodes (5): isSafariBrowser(), openChangePlan(), openSafariStripeCheckout(), prefetchStripeCheckoutUrl(), trackPlanCheckoutStarted()
...
Cohesion: 0.29
Nodes (7): buildBreakdownMetrics(), convertDataToJsTypes(), getAdminPlatformOverview(), getPublicLiveUpdateMetricsCF(), readLastMonthDevicesByPlatformCF(), roundPublicPercent(), runQueryToCFA()
...
Cohesion: 0.33
Nodes (5): explainLiveUpdateOnboarding(), stateForStepNumber(), explainForState(), EXPLANATIONS, FALLBACK
...
Cohesion: 0.53
Nodes (6): fixSupabaseHost(), getDatabaseURL(), getLocalReadOnlyDatabaseURL(), getReadOnlyDatabaseURL(), isLocalWorkerEnv(), setDatabaseSource()
...
Cohesion: 0.40
Nodes (3): logsnagInsightsTestUtils, logsnagInsights(), LogsnagInsightsOptions
...
Cohesion: 0.40
Nodes (4): VisualDiffRoute, visualDiffRoutes, visualDiffViewport, LoadedVisualDiffConfig

### Community 492 - "Community 492"
Cohesion: 0.70
Nodes (4): isChannelSelfRequestBody(), isDevicePlatform(), isOptionalString(), isOptionalStringMaxLength()
...
Cohesion: 0.50
Nodes (5): appLogDimensionBlobs(), normalizeAppLogDimension(), serializeStatsMetadata(), trackLogsCF(), trackLogsCFExternal()
...
Cohesion: 0.50
Nodes (4): fixtureDir, nodeModulesDir, writeJson(), writePackage()

### Community 534 - "Community 534"
Cohesion: 0.80
Nodes (5): extractAiChoiceText(), extractAiFieldText(), extractAiText(), extractContentText(), recordOf()
...
Cohesion: 0.50
Nodes (3): bannerLeftText, bannerText, lacksSecurityAccess
...
Cohesion: 0.50
Nodes (3): GLOBAL_STATS_SHARDS, REQUIRED_GLOBAL_STATS_SHARDS, USAGE_GLOBAL_STATS_SHARDS
...
Cohesion: 0.50
Nodes (4): buildPlanValidationExpression(), getAppByIdPg(), getAppOwnerPostgres(), getAppVersionsByAppIdPg()
...
Cohesion: 0.50
Nodes (3): auth, { checkPermissionMock, checkPermissionPgMock }, context
...
Cohesion: 0.67
Nodes (3): getAdminPluginBreakdown(), parseBreakdownJson(), parsePluginVersionLadderJson()
...
Cohesion: 1.00
Nodes (3): calculateAveragePastDueDays(), calculatePastDueOrgStats(), getPastDueStartTimesByCustomer()

## Knowledge Gaps
- **4463 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4458 more)
...
- **Why does `Database` connect `Community 60` to `Community 2`, `Community 261`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 31`, `Community 35`, `Community 164`, `Community 38`, `Community 168`, `Community 46`, `Community 61`, `Community 196`, `Community 71`, `Community 74`, `Community 96`?**
  _High betweenness centrality (0.233) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 12` to `Community 131`, `Community 4`, `Community 6`, `Community 137`, `Community 11`, `Community 150`, `Community 151`, `Community 24`, `Community 25`, `Community 26`, `Community 23`, `Community 28`, `Community 29`, `Community 285`, `Community 161`, `Community 162`, `Community 33`, `Community 42`, `Community 45`, `Community 180`, `Community 53`, `Community 439`, `Community 440`, `Community 441`, `Community 57`, `Community 443`, `Community 444`, `Community 58`, `Community 62`, `Community 63`, `Community 65`, `Community 66`, `Community 67`, `Community 451`, `Community 75`, `Community 77`, `Community 78`, `Community 335`, `Community 81`, `Community 83`, `Community 85`, `Community 86`, `Community 213`, `Community 88`, `Community 349`, `Community 98`, `Community 232`, `Community 105`, `Community 108`, `Community 236`, `Community 238`, `Community 495`, `Community 496`, `Community 112`, `Community 498`, `Community 113`, `Community 116`, `Community 125`, `Community 251`, `Community 504`, `Community 249`, `Community 123`, `Community 124`, `Community 381`?**
  _High betweenness centrality (0.146) - this node is a cross-community bridge._
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _4466 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.003992015968063872 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.027205553067622033 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02356276020905306 - nodes in this community are weakly interconnected._
