...
## Corpus Check
- Large corpus: 1851 files · ~3,745,173 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 9596 nodes · 20310 edges · 626 communities (519 shown, 107 thin omitted)
...
## Communities (626 total, 107 thin omitted)
...
Cohesion: 0.03
Nodes (200): checkAppIdsExist(), completePendingOnboardingApp(), ExistingOrganizationApp, findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), PendingOnboardingApp, buildAppIdConflictSuggestions() (+192 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (141): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+133 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (111): appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, app (+103 more)
...
Cohesion: 0.04
Nodes (108): app, appPrivate, appTriggers, app, DataUpload, app, app, DataUpload (+100 more)
...
Cohesion: 0.03
Nodes (124): mockContext, plans, mockContext, buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+116 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (96): app, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor (+88 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (96): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), Channel, checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel(), delChannel() (+88 more)
...
Cohesion: 0.04
Nodes (95): bundleVersions, checksumPayload, compatibilityMatrix, updaterVersions, maybePromptBuilderCta(), shouldBlockIncompatibleUpload(), CompatibilityResult, summarizeUploadCompatibility() (+87 more)
...
Cohesion: 0.04
Nodes (59): loadConfig(), writeConfig(), CapacitorConfig, capacitorConfigSchema, ExtConfigPairs, extConfigPairsSchema, CapacitorCliConfig, isMonorepo (+51 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (63): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+55 more)
...
Cohesion: 0.04
Nodes (50): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, testOrgId (+42 more)
...
Cohesion: 0.09
Nodes (55): AppOwnerResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult, deleteOverride(), isChannelSelfLocalChannelStorageVersion(), listCompatibleChannels() (+47 more)
...
Cohesion: 0.05
Nodes (29): createAuthenticatedSupabaseClient(), pgPool, deleteUserAs(), withAuthClient(), QueryFn, supabase, supabaseServiceKey, supabaseUrl (+21 more)
...
Cohesion: 0.08
Nodes (42): createRSA(), checkAlerts(), checkVersionStatus(), VersionCheckResult, setSetting(), setSettingInternal(), writeConfigUpdater(), addOrganization() (+34 more)
...
Cohesion: 0.06
Nodes (46): Actives, BuildStats, calculateAveragePastDueDays(), calculateChurnRevenue(), calculateConversionRate(), calculateNrr(), calculatePastDueOrgStats(), CurrentDayWindow (+38 more)
...
Cohesion: 0.09
Nodes (35): buildNotifCacheRequest(), claimNotifOrgOnce(), deleteNotificationClaim(), EventData, getNotifCacheStatus(), getNotification(), getSecondsUntilNextCronWindow(), hasNotifOrgClaim() (+27 more)
...
Cohesion: 0.13
Nodes (26): deleteChannelSelfOverrideForDevice(), pluginVersionCases, buildChannelSelfCacheRequest(), buildChannelSelfStoreKey(), ChannelSelfContext, ChannelSelfDeviceClient, ChannelSelfOverride, ChannelSelfOverridePayload (+18 more)
...
Cohesion: 0.11
Nodes (24): allowLocalWebhookUrls(), base64Encode(), bytesToArrayBuffer(), decodeSerializedWebhookSecret(), deliverWebhook(), disableWebhook(), generateStandardWebhookSignature(), getWebhookPayloadEvent() (+16 more)
...
Cohesion: 0.12
Nodes (22): getChannelSelfOverrideForDevice(), canManageRoleBindingScope(), loadManagedBinding(), eq(), activeChannelVersionJoin(), buildPlanValidationExpression(), deleteChannelDevicePg(), getAlias() (+14 more)

### Community 88 - "Community 88"
Cohesion: 0.10
Nodes (18): ContinentsCFWorker, DbRegionSB, getClientDbRegionSB(), getContinentCF(), getContinentSB(), RegionsAWS, SimpleErrorResponse, drizzleErrorNames (+10 more)
...
Cohesion: 0.11
Nodes (19): isRetryableDurableObjectFetchError(), ALLOWED_HEADERS, AppScopedAttachmentPath, AsyncLock, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, FinalPart (+11 more)
...
Cohesion: 0.18
Nodes (15): getWebhookLogUrlMetadata(), parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion, bodySchema, post(), bodySchema, buildWebhookUpdateData() (+7 more)
...
Cohesion: 0.18
Nodes (6): longLog, makeStdin(), makeStdout(), renderShell(), updateInfo, watchdog
...
Cohesion: 0.29
Nodes (9): DeliveryMessage, getDeliveryById(), getWebhookById(), getWebhookPublicUrlValidationError(), queueWebhookDelivery(), WebhookDeliveryPayload, getDeliveriesSchema, retryDelivery() (+1 more)
...
## Knowledge Gaps
- **3356 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3351 more)
...
- **Why does `Database` connect `Community 50` to `Community 2`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 145`, `Community 18`, `Community 19`, `Community 23`, `Community 24`, `Community 25`, `Community 29`, `Community 30`, `Community 161`, `Community 291`, `Community 36`, `Community 37`, `Community 39`, `Community 46`, `Community 308`, `Community 182`, `Community 318`, `Community 69`, `Community 75`, `Community 339`, `Community 104`, `Community 234`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `Release` connect `Community 130` to `Community 92`, `Community 15`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `cloudlog()` connect `Community 7` to `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 17`, `Community 273`, `Community 20`, `Community 22`, `Community 26`, `Community 31`, `Community 35`, `Community 40`, `Community 41`, `Community 44`, `Community 174`, `Community 177`, `Community 55`, `Community 59`, `Community 65`, `Community 195`, `Community 198`, `Community 71`, `Community 74`, `Community 209`, `Community 81`, `Community 211`, `Community 84`, `Community 85`, `Community 88`, `Community 90`, `Community 92`, `Community 93`, `Community 99`, `Community 100`, `Community 110`, `Community 241`, `Community 116`, `Community 119`?**
...
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _3359 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.003992015968063872 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.02530295272230756 - nodes in this community are weakly interconnected._