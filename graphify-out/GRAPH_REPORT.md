# Graph Report - capgo.app  (2026-07-23)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 1930 files · ~4,284,680 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 13120 nodes · 23990 edges · 881 communities (741 shown, 140 thin omitted)
...
- `setAccountFormatLocale()` --calls--> `useMainStore`  [EXTRACTED]
  tests/conversion.unit.test.ts → src/stores/main.ts
...
## Communities (881 total, 140 thin omitted)
...
Cohesion: 0.02
Nodes (140): Channel, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+132 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (148): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, formatBytes(), formatNumber(), funComparisons, getFunComparison(), getOrgIdForApp(), handleBillingPeriodStats() (+140 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (125): app, AppContext, GrantRequest, grantSchema, SearchOrgsQuery, verifyAdmin(), app, app (+117 more)
...
Cohesion: 0.03
Nodes (110): assertCanManageApiKeysForOrgs(), get(), getAll(), CreateApp, post(), put(), UpdateApp, AppWithOrg (+102 more)
...
Cohesion: 0.03
Nodes (121): checkAppIdsExist(), ExistingOrganizationApp, PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), askForAppName(), askForWebDir(), buildCodeDiffLines() (+113 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (84): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, appGlobal (+76 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (104): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (88): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel(), delChannel() (+80 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (79): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+71 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (80): mockContext, plans, mockContext, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata() (+72 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (77): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding (+69 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (74): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+66 more)
...
Cohesion: 0.06
Nodes (51): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), AppInsert, id, id, id (+43 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (65): app, canManageGroupRank(), canManageGroupRoles(), DrizzleClient, getGroupRankPrincipal(), GroupRankPrincipal, GroupRecord, loadGroupLockOrgId() (+57 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (47): createAuthenticatedSupabaseClient(), pgPool, getPublicKeyFingerprint(), testEncryption(), tryDecryptChecksum(), fixtureId, orgId, QueryFn (+39 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (46): adminStore, deliveryLatencyDays, devicesTrendSeries, displayStore, externalUpdatesSeries, isLoading, isLoadingGlobalStatsTrend, latestGlobalStats (+38 more)
...
Cohesion: 0.05
Nodes (65): streamCommandInInitPanel(), ConfirmOptions, log, PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone (+57 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (66): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, createChannel(), seedOptions, versionCache (+58 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (60): getInvocationSource(), checkAppExists(), addApp(), addAppInternal(), AppCreateSource, ensureAppDoesNotExist(), ensureOptions(), isMissingAppBuildOnboardingSchemaError() (+52 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (63): AdminStatsBody, adminStatsBodySchema, app, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, churnReasonLabels, formatCancellationReason() (+55 more)
...
Cohesion: 0.06
Nodes (60): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, Platform (+52 more)
...
Cohesion: 0.10
Nodes (66): completePendingOnboardingApp(), addAppStep(), addChannelStep(), addCodeChangeStep(), addCodeStep(), addEncryptionStep(), addUpdaterStep(), askForAppId() (+58 more)
...
Cohesion: 0.05
Nodes (45): createUserOrgBinding(), destinationOrgId, clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, deleteUserAs() (+37 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (50): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), UpdateDeliveryScope, UpdateDeliveryStatsResponse, stripeEnabled, ArrayElement, Concrete (+42 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (59): onManifestCreateTestUtils, onVersionUpdateTestUtils, archive_queue_messages(), chunkArray(), delete_queue_message_batch(), deleteSuccessfulChunkMessages(), deleteUncheckpointedSuccessMessages(), DISCORD_IGNORED_ERROR_CODES (+51 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (48): Awaitable, ChannelInfo, ChannelsListResponse, expectNoChannelDeviceRow(), getUniqueBaseData(), id, headers, id (+40 more)
...
Cohesion: 0.05
Nodes (44): BuildCardProps, useBuildCardStats(), BuildChartConfigProps, useBuildChartConfig(), BUILD_SERIES_KEYS, BuildChartWindow, BuildSeriesData, buildSeriesKey (+36 more)
...
Cohesion: 0.09
Nodes (45): DeliveryMessage, allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload(), bytesToArrayBuffer(), createDeliveryRecord() (+37 more)
...
Cohesion: 0.07
Nodes (37): accumulateNumbers(), AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, buildNativeVersionCounts(), bundleUsageSchema, bundleUsageTestUtils, checkOrganizationAccess() (+29 more)
...
Cohesion: 0.07
Nodes (32): Digester, noopDigester(), sha256Digester(), isRetryableDurableObjectFetchError(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata (+24 more)
...
Cohesion: 0.10
Nodes (34): handleBundleUploadCommand(), buildBundleUploadPreviewQrOptions(), normalizeChannels(), sendUpdateNotificationsForChannels(), SendUpdateNotificationsOptions, UpdateCheckResponse, AppRow, assertAppAllowsPreview() (+26 more)
...
Cohesion: 0.08
Nodes (37): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), assertChannelSelfIPRateLimit(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult (+29 more)
...
Cohesion: 0.11
Nodes (36): maybePromptStarCapgoRepo(), formatGithubRepositoryList(), maybeStarCapgoRepo(), additionalDefaultStarRepositories, checkIfStarred(), createAbortedError(), createStartRateLimiter(), dedupeRepositories() (+28 more)
...
Cohesion: 0.09
Nodes (36): createCapacitorRunTargetListError(), getCapacitorRunTargetList(), getCapacitorRunTargetListTimeoutMs(), getSpawnOutputText(), normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerForTargetList(), runPackageRunnerSync() (+28 more)
...
Cohesion: 0.08
Nodes (24): app, buildBuilderBentoEvent(), buildBundleIncompatibleBentoEvent(), handleNotifyConsole(), ResolvedTrackingId, resolveTrackingUserId(), toIdString(), TrackEventBody (+16 more)
...
Cohesion: 0.10
Nodes (29): addOrganization(), deleteOrganization(), deleteOrganizationInternal(), listOrganizations(), displayMembers(), DisplayOptions, listMembers(), listMembersInternal() (+21 more)
...
Cohesion: 0.11
Nodes (24): VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), checkIndexPosition() (+16 more)
...
Cohesion: 0.13
Nodes (30): buildAddColumnStatement(), buildAlterSequenceStatement(), buildAttachConstraintStatement(), buildCreateIndexStatement(), buildCreateOrReplaceFunctionStatement(), buildCreateSequenceStatement(), buildDropIndexStatement(), buildReindexIndexStatement() (+22 more)
...
Cohesion: 0.12
Nodes (26): executeStatsQueryWithRetry(), isRetryableStatsError(), isRetryableStatsResult(), hasPendingAppStatsRefresh(), queueOrgPlanRefreshWithRetry(), runSupabaseResultWithRetry(), syncOrgStatsRefresh(), getErrorCode() (+18 more)

### Community 112 - "Community 112"
Cohesion: 0.09
Nodes (18): appGlobal, app, app, app, AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION (+10 more)
...
Cohesion: 0.15
Nodes (25): isUpdateRequestBody(), DevicePlatform, fieldIssue(), getAllowedStatsActionsList(), isDevicePlatform(), isDevicePlatformValue(), isRecord(), UnknownRecord (+17 more)
...
Cohesion: 0.11
Nodes (20): ALLOWED_ATTRIBUTE_KEYS, app, createBodySchema, requireManageSsoPermission(), updateBodySchema, uuidSchema, getActivePlanNameOrg(), hasFeature() (+12 more)
...
Cohesion: 0.08
Nodes (21): id, testOrgId, id, semverApiKey, createOrgBoundApiKey(), id, testOrgApiKey, testOrgId (+13 more)
...
Cohesion: 0.09
Nodes (20): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), PasswordPolicy, rollbackCreatedUser() (+12 more)
...
Cohesion: 0.14
Nodes (22): assertSubkeyHasPlaintextSecret(), checkKeyByIdPg(), checkKeyPg(), FindApikeyByValueResult, foundAPIKey(), foundJWT(), getSubkeyId(), hasLimitedRbacSubkeyScope() (+14 more)
...
Cohesion: 0.14
Nodes (18): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+10 more)

### Community 172 - "Community 172"
Cohesion: 0.14
Nodes (17): app, buildWorkersCacheKey(), CachedFiles, CachedFilesLoopback, fetch(), FilesExecutionContext, filesWorkerCacheTestUtils, getRequestHostname() (+9 more)
...
Cohesion: 0.15
Nodes (15): creditPricingMetricOrder, CreditPricingStep, creditPricingUnitLabelKeys, formatCreditPriceValue(), formatCreditPricingPrice(), formatCreditPricingTierLabel(), formatCreditTierAmount(), formatIncludedThenPrice() (+7 more)
...
Cohesion: 0.16
Nodes (17): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+9 more)
...
Cohesion: 0.19
Nodes (17): decodePreviewAppId(), parseChannelId(), ParsedBundlePreviewSubdomain, ParsedChannelPreviewSubdomain, ParsedPreviewSubdomain, parseEncodedPreviewSubdomain(), parseLegacyPreviewSubdomain(), parsePreviewSubdomain() (+9 more)
...
Cohesion: 0.21
Nodes (17): apikeyHasOrgRight(), apikeyHasOrgRightWithPolicy(), checkApikeyMeetsOrgPolicy(), bodySchema, deleteWebhook(), getDeliveries(), get(), apiKeyHasAppScopedBinding() (+9 more)
...
Cohesion: 0.19
Nodes (16): getCapacitorRunTargetListWithStatus(), getPhysicalIosRunTargets(), getRunDeviceCommand(), getRunTargetLabel(), getSimulatorIosRunTargets(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets() (+8 more)
...
Cohesion: 0.23
Nodes (13): cancelCommand(), describeFetchFailure(), formatTimeOnly(), getStats(), Level, LogSpec, markSnag(), Order (+5 more)
...
Cohesion: 0.17
Nodes (11): detectProjectFrameworkFromConfig(), detectProjectFrameworkFromDependencies(), detectProjectTypeInDir(), findMainFile(), findMainFileForProjectType(), findProjectType(), getAllPackagesDependencies(), getProjectTypeWithLanguage() (+3 more)
...
Cohesion: 0.17
Nodes (13): TERMINAL_BUILD_STATUSES, BuildFailureCategory, BuildRowForTracking, BuildTransition, classifyBuildTransition(), ClassifyInput, emitBuildTransitionEvent(), EmitBuildTransitionInput (+5 more)
...
Cohesion: 0.40
Nodes (10): BuilderStatusResponse, calculateBuildRuntimeSeconds(), calculateRunnerWaitSeconds(), calculateTimeoutCompletedAt(), capBuildRuntimeSeconds(), formatBuildTimeoutError(), hasBuildTimedOut(), isTerminalBuildStatus() (+2 more)
...
Cohesion: 0.28
Nodes (12): cleanStoredImageMetadata(), concatUint8Arrays(), isSameBytes(), JPEG_SIGNATURE, mimeFromFileBytes(), mimeFromFilePath(), PNG_SIGNATURE, readUint32() (+4 more)

### Community 283 - "Community 283"
Cohesion: 0.23
Nodes (11): parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion, bodySchema, bodySchema, buildWebhookUpdateData(), parseRequestedDeliveryVersion(), put() (+3 more)
...
Cohesion: 0.33
Nodes (9): DB_URL_ENV_KEYS, formatRate(), loadEnv(), main(), mapPool(), moveToTrash(), objectExists(), requireDbUrl() (+1 more)
...
Cohesion: 0.20
Nodes (6): NO_ERROR, RequestJSON, schemas, channelSelfRequestSchema, statsRequestSchema, updateRequestSchema
...
Cohesion: 0.28
Nodes (5): findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), buildAppIdConflictSuggestions(), isAppAlreadyExistsError()
...
Cohesion: 0.25
Nodes (7): CompatibilityResult, Compatibility, compatibleSameVersion, iosCodeChanged, newPlugin, removedRemoteOnly, versionMismatch
...
Cohesion: 0.33
Nodes (6): resolveInitDirectoryPath(), resolveInitTargetPath(), resolveResumedInitTargets(), resolveLiveUpdateProjectTarget(), outsideRoot, root
...
- **Why does `Database` connect `Community 63` to `Community 256`, `Community 2`, `Community 10`, `Community 11`, `Community 12`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 159`, `Community 33`, `Community 34`, `Community 164`, `Community 36`, `Community 47`, `Community 178`, `Community 64`, `Community 69`, `Community 80`, `Community 99`, `Community 240`?**
  _High betweenness centrality (0.229) - this node is a cross-community bridge._
- **Why does `Database` connect `Community 9` to `Community 258`, `Community 3`, `Community 4`, `Community 131`, `Community 6`, `Community 13`, `Community 14`, `Community 144`, `Community 145`, `Community 150`, `Community 281`, `Community 25`, `Community 283`, `Community 28`, `Community 156`, `Community 157`, `Community 31`, `Community 35`, `Community 38`, `Community 171`, `Community 300`, `Community 44`, `Community 46`, `Community 175`, `Community 436`, `Community 437`, `Community 438`, `Community 184`, `Community 440`, `Community 441`, `Community 61`, `Community 62`, `Community 448`, `Community 68`, `Community 198`, `Community 71`, `Community 72`, `Community 74`, `Community 333`, `Community 82`, `Community 211`, `Community 86`, `Community 89`, `Community 91`, `Community 222`, `Community 101`, `Community 229`, `Community 232`, `Community 490`, `Community 491`, `Community 234`, `Community 493`, `Community 109`, `Community 111`, `Community 112`, `Community 113`, `Community 114`, `Community 117`, `Community 123`, `Community 124`, `Community 125`, `Community 382`, `Community 127`?**
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02352466729399113 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.028870829769033362 - nodes in this community are weakly interconnected._