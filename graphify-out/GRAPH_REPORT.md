...
## Corpus Check
- Large corpus: 2172 files · ~4,309,128 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 12015 nodes · 25404 edges · 747 communities (612 shown, 135 thin omitted)
...
Cohesion: 0.02
Nodes (197): assertCanManageApiKeysForOrgs(), AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle() (+189 more)
...
Cohesion: 0.03
Nodes (132): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), AcceptInvitation, app (+124 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (142): Channel, AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials (+134 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (151): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+143 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (148): AppBuildOnboardingMetricRow, AppBuildOnboardingMetrics, areGlobalStatsNumbersDifferent(), BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, buildLogsnagInsightsRetryMessage(), buildLogsnagInsightsShardMessage() (+140 more)
...
Cohesion: 0.05
Nodes (112): getInvocationSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), checkVersionNotUsedInChannel(), CheckVersionOptions (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (116): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+108 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (112): formatBytes(), formatNumber(), funComparisons, getFunComparison(), getOrgIdForApp(), handleBillingPeriodStats(), handleDailyFailRatio(), handleDeployInstallStats() (+104 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (94): app, ensureOrgMembership(), ensureOrgMembershipInTransaction(), EnsureOrgMembershipResult, ensurePublicUserRowExists(), ensurePublicUserRowExistsInTransaction(), extractProviderId(), getAuthenticatedSsoProviders() (+86 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (102): checkAppIdsExist(), ExistingOrganizationApp, PendingOnboardingApp, checkVersionStatus(), applyInitAutoTestChange(), buildCodeDiffLines(), BuildProjectStepOutcome, CancelablePromptValue (+94 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (84): withSupabaseSource(), createRSA(), checkAlerts(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getLatestDependencies() (+76 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (66): appCreationApiKey, id, createAppForTest(), isDuplicateAppCreationError(), headers, testRunId, AppInsert, id (+58 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (79): setInvocationSource(), enableSupabaseInstrumentation(), trackMcpServerStarted(), withMcpToolTracking(), clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath() (+71 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (51): TEST_ORG_ID, createAuthenticatedSupabaseClient(), pgPool, fixtureId, orgId, QueryFn, pool, supabase (+43 more)
...
Cohesion: 0.05
Nodes (72): deleteOverride(), DeviceLink, app, assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), logDeviceRequestContext(), recordDeviceIPRateLimit() (+64 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (53): appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, app (+45 more)
...
Cohesion: 0.04
Nodes (55): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+47 more)
...
Cohesion: 0.04
Nodes (70): addFirstSeenByApp(), ADMIN_ONBOARDING_COMPLETED_DOWNLOAD_ACTIONS, AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend (+62 more)
...
Cohesion: 0.04
Nodes (38): adminStore, devicesTrendSeries, displayStore, externalUpdatesSeries, isLoading, isLoadingGlobalStatsTrend, latestGlobalStats, mainStore (+30 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (70): completePendingOnboardingApp(), cancelCommand(), markSnag(), wait(), waitLog(), getInfoInternal(), addAppStep(), addChannelStep() (+62 more)
...
Cohesion: 0.04
Nodes (56): CompatibilityResult, Compatibility, isMonorepo, isNXMonorepo, addProjectTypeCandidateDir(), ArrayElement, CapgoConfig, CapgoFilesConfig (+48 more)
...
Cohesion: 0.08
Nodes (66): withGlobalPermissions(), checkWriteAppAccess(), assertAppPermission(), assertOptionalDate(), assertString(), createCampaignRecord(), getAppOwnerOrg(), getNotificationProviderConfigs() (+58 more)
...
Cohesion: 0.05
Nodes (42): CreditStep, callLogAs(), seedStaleCreatedByOrg(), createUserOrgBinding(), expectCreatedOrganizationPlan(), globalId, globalIdRbac, ORG_ID (+34 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (59): getAppsFromCF(), getUpdateStatsCF(), serializeStatsMetadata(), trackBandwidthUsageCF(), trackLogsCF(), trackLogsCFExternal(), trackVersionUsageCF(), isDemoApp() (+51 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (58): assertPublicPluginApp(), AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), assertChannelSelfIPRateLimit(), blockProviderInfrastructure(), ChannelSelfDeviceOperation (+50 more)
...
Cohesion: 0.05
Nodes (50): apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES, replaceApiKeyGlobalPermissions(), SUPPORTED_APIKEY_GLOBAL_PERMISSIONS (+42 more)
...
Cohesion: 0.05
Nodes (48): DeviceRow, UpdateEndpointRequest, useDeviceUpdateFormat(), stripeEnabled, ArrayElement, Concrete, Expand, Merge (+40 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (53): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, AdminStatsBody, adminStatsBodySchema (+45 more)
...
Cohesion: 0.05
Nodes (39): app, AppContext, getInviteNotificationLockKey(), getInviteResendRequiredPermission(), inviteExistingUserSchema, inviteNotificationCooldowns, lockInviteNotification(), unlockInviteNotification() (+31 more)
...
Cohesion: 0.06
Nodes (41): ChannelSet, app, ChannelSet, definedOrAlias(), findVersion(), findVersionId(), normalizeChannelSet(), post() (+33 more)
...
Cohesion: 0.08
Nodes (39): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+31 more)
...
Cohesion: 0.09
Nodes (41): adminStore, cancelDebouncedSearchReload(), currentPage, displayStore, formatDateOrNever(), formatNumber(), formatPercent(), getOrganizationAttentionLabel() (+33 more)

### Community 66 - "Community 66"
Cohesion: 0.07
Nodes (35): Digester, noopDigester(), sha256Digester(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env, normalizeContentType() (+27 more)
...
Cohesion: 0.09
Nodes (37): app, ApiKeyPublicRow, ApiKeyPublicSelectRow, ApiKeyRow, app, parseApiKeyGlobalPermissions(), app, ApiKeyRow (+29 more)
...
Cohesion: 0.10
Nodes (34): appVersion, manifest, firstForwardedHeaderValue(), getBundleUrl(), getManifestUrl(), rewriteLocalEdgeRuntimeUrl(), decodeManifestPathSegments(), encodeManifestPathSegments() (+26 more)
...
Cohesion: 0.08
Nodes (31): fetchRest(), getAnonHeaders(), getApiKeyHeaders(), AuditLog, auditLogSchema, auditLogsResponseSchema, globalId, ORG_ID (+23 more)

### Community 89 - "Community 89"
Cohesion: 0.09
Nodes (33): DeliveryMessage, allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload(), bytesToArrayBuffer(), createDeliveryRecord() (+25 more)
...
Cohesion: 0.11
Nodes (31): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), getRunDeviceCommandForPlatform(), assertHelperFileWritable(), getConfigAppId(), notificationPackages, NotificationSetupOptions (+23 more)
...
Cohesion: 0.07
Nodes (19): ChannelSelfMethod, DeviceApiMethod, hitRateLimit(), id, sleep(), Awaitable, ChannelInfo, ChannelsListResponse (+11 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (27): bodySchema, buildExpectedCurrentFields(), buildOrganizationUpdateQuery(), buildRollbackFields(), buildUpdateFields(), enforceSelf2faRequirement(), getErrorDetail(), getOrganizationUpdateColumn() (+19 more)
...
Cohesion: 0.15
Nodes (27): parseOptionalQueryBoolean(), parseQueryDate(), makeIssue(), createPluginSchema(), DevicePlatform, fieldIssue(), isDevicePlatform(), isDevicePlatformValue() (+19 more)

### Community 113 - "Community 113"
Cohesion: 0.08
Nodes (20): id, testOrgId, buildAttachmentPath(), cleanupSeededOrg(), createSeededApiKey(), seedApp(), seedReadyBundle(), createDirectApiKeyWithBindings() (+12 more)
...
Cohesion: 0.11
Nodes (22): ensureUpdaterReadyBeforeSync(), getCompatibleUpdaterVersionForPackage(), getUpdaterInstallBlocker(), getUpdaterInstallCommand(), getUpdaterVersionToInstall(), handleBuildAndSyncFailure(), logUpdaterInstallStateDetails(), normalizeConcreteVersion() (+14 more)
...
Cohesion: 0.13
Nodes (21): bodySchema, createPendingStripeInfo(), ensureApiKeyCanCreateOrganization(), estimatedMauSchema, getInitialPlanForMau(), getOwnerEmail(), insertOrgForApiKey(), PgTransactionClient (+13 more)
...
Cohesion: 0.12
Nodes (20): buildDeviceIdsByInstallSourcesQuery(), buildInstallSourceList(), countInstallSourcesCF(), readBandwidthUsageCF(), readDeviceIdsByInstallSourcesCF(), readDevicesCF(), assertAnalyticsEngineReadConfig(), countDevices() (+12 more)
...
Cohesion: 0.17
Nodes (21): askForAppName(), askForWebDir(), cancelBeforeAuthenticatedOnboarding(), cancelPackageJsonSelection(), ensureWorkspaceReadyForInit(), exitBeforeAuthenticatedOnboarding(), getCreateAppTemplateCommand(), getFrameworkDisplayName() (+13 more)
...
Cohesion: 0.14
Nodes (17): AppStatusResult, BatchStatsResult, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6, parseBodyRaw(), post(), PostResult, shouldRecordStatsAction() (+9 more)
...
Cohesion: 0.21
Nodes (16): CacheStore, buildResetAt(), bytesToHex(), clearFailedAccountAuth(), clearFailedAuth(), getAccountRateLimitKey(), getClientIP(), getFailedAuthLimit() (+8 more)
...
Cohesion: 0.15
Nodes (13): getInstalledDependencies(), getAssistedDependencies(), rememberPackageJsonPath(), detectProjectFrameworkFromConfig(), detectProjectFrameworkFromDependencies(), detectProjectTypeInDir(), findMainFile(), findMainFileForProjectType() (+5 more)
...
Cohesion: 0.20
Nodes (9): SimpleErrorResponse, drizzleErrorNames, filesUploadFunctionNames, onError(), parsePositiveInteger(), queueRetryHeaderNames, readRequestHeader(), sensitiveRequestBodyKeys (+1 more)
...
Cohesion: 0.29
Nodes (6): buildReplicationQuery(), executeReplicationQuery(), ReplicationContext, ReplicationQueryMode, ReplicationSlotLag, SlotStatus
...
## Knowledge Gaps
- **4030 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+4025 more)
...
- **Why does `Database` connect `Community 9` to `Community 4`, `Community 10`, `Community 138`, `Community 14`, `Community 142`, `Community 15`, `Community 17`, `Community 276`, `Community 406`, `Community 25`, `Community 27`, `Community 28`, `Community 32`, `Community 168`, `Community 170`, `Community 43`, `Community 48`, `Community 61`, `Community 67`, `Community 73`, `Community 82`, `Community 213`, `Community 354`, `Community 367`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `getEffectiveDeviceChannelNamePostgres()` connect `Community 38` to `Community 73`, `Community 153`, `Community 23`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.024091587854654057 - nodes in this community are weakly interconnected._
