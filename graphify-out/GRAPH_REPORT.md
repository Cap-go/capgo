# Graph Report - capgo  (2026-06-13)

## Generation Mode
- Deterministic code-only AST extraction. No semantic LLM extraction or API keys are used.

## Corpus Check
- Large corpus: 1810 files · ~3,702,744 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.
...
Cohesion: 0.02
Nodes (140): appGlobal, appGlobal, GetLatest, get(), GetLatest, app, appGlobal, SetChannelBody (+132 more)
...
Cohesion: 0.03
Nodes (146): filterDeviceKeys(), get(), GetDevice, publicDevice, post(), formatBytes(), formatNumber(), funComparisons (+138 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (129): withGlobalPermissions(), setChannel(), checkWriteAppAccess(), runChannelSelfWithPgClient(), app, AppContext, canCallerResendInviteRole(), getInviteNotificationLockKey() (+121 more)
...
Cohesion: 0.05
Nodes (88): app, appPrivate, appTriggers, app, AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (112): scripts, build, check-posix-paths, dev, dev-build, generate-docs, lint, lint:fix (+104 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (87): recoverUploadOffsetFromDurableObject(), app, canAccessRequestedOrg(), ResolvedTrackingId, TrackEventBody, app, ensureOrgMembership(), ensureOrgMembershipInTransaction() (+79 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (86): calcKeyId(), decryptChecksum(), decryptChecksumV3(), decryptSource(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey() (+78 more)
...
Cohesion: 0.05
Nodes (85): deleteOverride(), app, assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), logDeviceRequestContext(), recordDeviceIPRateLimit(), recordDeviceRateLimitSafely() (+77 more)
...
Cohesion: 0.08
Nodes (31): VersionCheckResult, addOrganization(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), displayMembers() (+23 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (37): TEST_ORG_ID, pgPool, deleteUserAs(), withAuthClient(), QueryFn, supabase, supabaseServiceKey, supabaseUrl (+29 more)
...
Cohesion: 0.05
Nodes (46): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, id, semverApiKey, id (+38 more)
...
Cohesion: 0.06
Nodes (52): buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, classifyRevenueMovement(), compactMetadata(), createdOrUpdated(), createZeroPlanBreakdown() (+44 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (54): completePendingOnboardingApp(), markSnag(), wait(), waitLog(), getInfoInternal(), getInstalledDependencies(), addAppStep(), addChannelStep() (+46 more)
...
Cohesion: 0.06
Nodes (44): getLocalConfig(), stripeEnabled, ArrayElement, Concrete, Expand, Merge, MergeArrays, MergeNonUnionArrays (+36 more)
...
Cohesion: 0.08
Nodes (44): addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured(), syncBentoSubscriberTags(), trackBentoEvent(), unsubscribeBento(), CacheKeyParams (+36 more)
...
Cohesion: 0.08
Nodes (41): ALLOWED_STORE_HOSTS, AppleLookupResult, assertAllowedStoreUrl(), decodeHtml(), extractAndroidAppId(), extractAppleStoreId(), extractMetaTag(), extractTitle() (+33 more)
...
Cohesion: 0.10
Nodes (32): AdminStatsBody, adminStatsBodySchema, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, isoUtcDatetimeSchema, limitSchema, metricCategories (+24 more)

### Community 59 - "Community 59"
Cohesion: 0.08
Nodes (32): ensureUpdaterReadyBeforeSync(), getCompatibleUpdaterVersionForPackage(), getUpdaterInstallBlocker(), getUpdaterInstallCommand(), getUpdaterVersionToInstall(), handleBrokenIosSync(), handleBuildAndSyncFailure(), logBrokenIosSync() (+24 more)
...
Cohesion: 0.09
Nodes (27): appIdParamSchema, bindingIdParamSchema, invalidAppIdHook, invalidBindingIdHook, AssignablePrincipal, CreateBindingResult, createRoleBindingForPrincipal(), getCallerMaxPriorityRank() (+19 more)

### Community 66 - "Community 66"
Cohesion: 0.13
Nodes (33): cancelCommand(), ensureNativePlatformForBuild(), exitCanceledInitOnboarding(), formatGithubRepositoryList(), getCapacitorRunTargetListWithStatus(), getInitRecoveryCommands(), getNativePlatformAvailability(), getRunDeviceCommand() (+25 more)
...
Cohesion: 0.11
Nodes (18): useRealtimeCLIFeed(), updateUser(), base64ToArrayBuffer(), blobToData(), getPhotoErrorMessage(), isPhotoSelectionCancelledError(), pickPhoto(), supabase (+10 more)
...
Cohesion: 0.09
Nodes (21): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+13 more)
...
Cohesion: 0.17
Nodes (20): recordChannelSelfIPRateLimit(), recordChannelSelfRequestSafely(), buildIpRateRequest(), buildOperationRateRequest(), buildSameSetRequest(), ChannelSelfIPRateLimitStatus, ChannelSelfOperation, ChannelSelfRateLimitStatus (+12 more)
...
Cohesion: 0.18
Nodes (18): maybeWriteBrokenIosSyncSupportBundle(), writeInitSupportBundle(), appendBulletedSection(), appendMetadataLine(), appendPlainSection(), diagnosticsLines(), nowStamp(), omittedMarker() (+10 more)
...
Cohesion: 0.21
Nodes (13): canManageRoleBindingScope(), loadManagedBinding(), loadRoleBindingApp(), eq(), activeChannelVersionJoin(), getAlias(), getAppVersionsByAppIdPg(), getSchemaUpdatesAlias() (+5 more)
...
Cohesion: 0.24
Nodes (14): buildWebhookDeliveryPayload(), createDeliveryRecord(), createTestPayload(), deliverWebhook(), getWebhookLogUrlMetadata(), getWebhookPayloadEvent(), getWebhookPayloadEventId(), getWebhookPublicUrlValidationError() (+6 more)
...
Cohesion: 0.29
Nodes (9): parseWebhookDeliveryVersion(), WEBHOOK_EVENT_TYPES, WebhookDeliveryVersion, bodySchema, buildWebhookUpdateData(), parseRequestedDeliveryVersion(), put(), PutWebhookBody (+1 more)
...
Cohesion: 0.31
Nodes (8): DeliveryMessage, getDeliveryById(), getWebhookById(), queueWebhookDelivery(), WebhookDeliveryPayload, getDeliveriesSchema, retryDelivery(), retryDeliverySchema
...
- **Why does `Database` connect `Community 15` to `Community 3`, `Community 11`, `Community 12`, `Community 13`, `Community 18`, `Community 21`, `Community 22`, `Community 279`, `Community 23`, `Community 25`, `Community 26`, `Community 155`, `Community 288`, `Community 35`, `Community 38`, `Community 43`, `Community 172`, `Community 171`, `Community 308`, `Community 55`, `Community 323`, `Community 70`, `Community 71`, `Community 74`, `Community 78`, `Community 88`, `Community 231`, `Community 109`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `getCreditTopUpProductId()` connect `Community 64` to `Community 1`, `Community 10`, `Community 142`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `log` connect `Community 142` to `Community 64`, `Community 20`, `Community 14`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.02295153227559226 - nodes in this community are weakly interconnected._