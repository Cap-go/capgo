...
## Corpus Check
- Large corpus: 1878 files · ~3,756,516 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 9729 nodes · 20425 edges · 624 communities (515 shown, 109 thin omitted)
...
## Communities (624 total, 109 thin omitted)
...
Cohesion: 0.02
Nodes (220): app, app, apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES (+212 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (159): Channel, setSetting(), setSettingInternal(), UpdateProbeResult, buildServerInstructions(), installMcpStdoutGuard(), AppDebugOptions, appDebugOptionsSchema (+151 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (203): checkAppIdsExist(), completePendingOnboardingApp(), ExistingOrganizationApp, findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), PendingOnboardingApp, buildAppIdConflictSuggestions() (+195 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (119): app, appPrivate, appTriggers, app, appGlobal, app, appGlobal, app (+111 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (159): withGlobalPermissions(), assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage (+151 more)
...
Cohesion: 0.03
Nodes (135): AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId(), getScopedCreditSteps() (+127 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (141): filterDeviceKeys(), get(), GetDevice, publicDevice, formatBytes(), formatNumber(), funComparisons, getFunComparison() (+133 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (114): getInvocationSource(), withSupabaseSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), checkVersionNotUsedInChannel(), CheckVersionOptions (+106 more)
...
Cohesion: 0.03
Nodes (93): canAccessRequestedOrg(), ResolvedTrackingId, TrackEventBody, ensureOrgMembership(), ensureOrgMembershipInTransaction(), EnsureOrgMembershipResult, ensurePublicUserRowExists(), ensurePublicUserRowExistsInTransaction() (+85 more)
...
Cohesion: 0.05
Nodes (80): deleteBodySchema, DeleteOrganizationParams, checkDomainRateLimit(), executeStatsQueryWithRetry(), app, CreditUsageAlertPayload, EVENT_BY_THRESHOLD, app (+72 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (81): normalizeRunDevicePlatform(), PlatformChoice, runPackageRunnerSync(), streamCommandInInitPanel(), ConfirmOptions, log, PromptResult, SelectOption (+73 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (74): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), loadConfig(), writeConfig() (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (77): DeliveryMessage, app, safeParseSchema(), AuthInfo, apikeyHasOrgRight(), allowLocalWebhookUrls(), AuditLogData, base64Encode() (+69 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (76): AcceptInvitation, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensureOrgMembership(), ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), legacyInviteToRbac, PasswordPolicy (+68 more)
...
Cohesion: 0.04
Nodes (58): ATTENTION_SORT_HEALTHY_ORG_CREATED_AT, ATTENTION_SORT_HEALTHY_ORG_ID, CANCELLED_MONTHLY_ORG_ID, CANCELLED_YEARLY_ORG_ID, GLOBAL_STATS_TREND_DATES, ONBOARDING_LATE_SUBSCRIPTION_ORG_ID, ONBOARDING_NO_BUNDLE_ORG_ID, ONBOARDING_ORG_ID (+50 more)
...
Cohesion: 0.04
Nodes (41): createAuthenticatedSupabaseClient(), pgPool, deleteUserAs(), withAuthClient(), QueryFn, supabase, supabaseServiceKey, supabaseUrl (+33 more)
...
Cohesion: 0.04
Nodes (46): ChannelSelfMethod, DeviceApiMethod, id, Awaitable, ChannelInfo, ChannelsListResponse, getUniqueBaseData(), id (+38 more)
...
Cohesion: 0.07
Nodes (51): AppOwnerResult, ChannelSelfDeviceOperation, ChannelSelfOverrideResult, deleteChannelSelfOverrideForDevice(), deleteOverride(), getChannelSelfOverrideForDevice(), isChannelSelfLocalChannelStorageVersion(), PLAN_MAU_ACTIONS (+43 more)
...
Cohesion: 0.06
Nodes (45): parseChannelSelfPluginRequest(), DataDevice, devicesBodySchema, orderItemSchema, app, DataStats, EXPORT_FORMATS, ExportBody (+37 more)
...
Cohesion: 0.06
Nodes (47): Actives, BuildStats, calculateAveragePastDueDays(), calculateChurnRevenue(), calculateConversionRate(), calculateNrr(), calculatePastDueOrgStats(), CurrentDayWindow (+39 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (44): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+36 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (46): AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOrgMetrics, AdminPlatformOverview (+38 more)
...
Cohesion: 0.09
Nodes (38): createRSA(), checkAlerts(), checkVersionStatus(), VersionCheckResult, writeConfigUpdater(), syncPendingAppIdToCapacitorConfig(), deleteOrganization(), deleteOrganizationInternal() (+30 more)
...
Cohesion: 0.09
Nodes (35): getAccountDisabledRedirect(), getPostRestorePath(), guard(), isDisabledAccount(), maybeProvisionSsoMembership(), updateUser(), isNativeAppStoreContext(), isSsoProvider() (+27 more)
...
Cohesion: 0.09
Nodes (36): buildBundleInfoRequest(), buildPreviewAuthRequest(), buildPreviewDownloadPayload(), buildPreviewPayloadResponseHeaders(), buildPreviewResponseHeaders(), BundleInfoCache, getBundleInfo(), getChannelPreviewVersionId() (+28 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (40): assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), listCompatibleChannels(), prepareChannelSelfDeviceRequest(), put(), BatchStatsResult, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6 (+32 more)
...
Cohesion: 0.10
Nodes (24): accumulateNumbers(), AppMetricRow, AppOwnerOrgRow, AppUsageByVersion, bundleUsageSchema, bundleUsageTestUtils, formatNativePlatform(), getDaysBetweenDates() (+16 more)
...
Cohesion: 0.13
Nodes (19): ALLOWED_ATTRIBUTE_KEYS, createBodySchema, parseAttributeMapping(), updateBodySchema, uuidSchema, getActivePlanNameOrg(), hasFeature(), isActivePlanStatus() (+11 more)
...
Cohesion: 0.14
Nodes (22): assertDeviceIPRateLimit(), assertChannelSelfIPRateLimit(), recordChannelSelfIPRateLimit(), recordChannelSelfRequestSafely(), buildIpRateRequest(), buildOperationRateRequest(), buildSameSetRequest(), ChannelSelfIPRateLimitStatus (+14 more)
...
## Knowledge Gaps
- **3382 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3377 more)
...
- **Why does `Database` connect `Community 9` to `Community 2`, `Community 11`, `Community 17`, `Community 20`, `Community 149`, `Community 22`, `Community 23`, `Community 153`, `Community 25`, `Community 27`, `Community 28`, `Community 288`, `Community 33`, `Community 35`, `Community 41`, `Community 42`, `Community 171`, `Community 299`, `Community 65`, `Community 322`, `Community 75`, `Community 216`, `Community 101`, `Community 103`, `Community 234`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `cloudlog()` connect `Community 15` to `Community 1`, `Community 129`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 13`, `Community 18`, `Community 19`, `Community 154`, `Community 29`, `Community 31`, `Community 32`, `Community 162`, `Community 36`, `Community 38`, `Community 167`, `Community 49`, `Community 50`, `Community 55`, `Community 68`, `Community 71`, `Community 78`, `Community 86`, `Community 87`, `Community 90`, `Community 91`, `Community 221`, `Community 96`, `Community 98`, `Community 104`, `Community 118`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Release` connect `Community 113` to `Community 91`, `Community 14`?**
...
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _3385 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.003992015968063872 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.019634776987718164 - nodes in this community are weakly interconnected._