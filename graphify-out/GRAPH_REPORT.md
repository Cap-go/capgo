...
## Corpus Check
- Large corpus: 2125 files · ~4,232,246 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 11615 nodes · 24480 edges · 715 communities (593 shown, 122 thin omitted)
...
Cohesion: 0.02
Nodes (236): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), cancelCommand(), markSnag(), waitLog() (+228 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (153): SuperOptions, buildServerInstructions(), installMcpStdoutGuard(), AppDebugOptions, appDebugOptionsSchema, AppOptions, appOptionsSchema, AppSettingOptions (+145 more)
...
Cohesion: 0.03
Nodes (118): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, AppContext (+110 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (150): refreshStorageHourly(), areGlobalStatsNumbersDifferent(), BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, buildLogsnagInsightsRetryMessage(), buildRecentGlobalStatsRepairDateIds(), BuildShardStats (+142 more)
...
Cohesion: 0.05
Nodes (116): withSupabaseSource(), check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, resolveAppSetIconPath(), Channel (+108 more)
...
Cohesion: 0.04
Nodes (108): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+100 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (99): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, adminStatsBodySchema, AdminAppsTrend (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (103): rollbackCreatedUser(), formatBytes(), formatNumber(), funComparisons, getFunComparison(), getOrgIdForApp(), handleBillingPeriodStats(), handleDailyFailRatio() (+95 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (89): get(), auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), canAccessRequestedOrg(), globalId, WEBHOOK_TEST_ORG_ID (+81 more)
...
Cohesion: 0.04
Nodes (71): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), getInvocationSource(), GlobalAnalyticsProps (+63 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (82): mocks, classifyEmailAddress(), classifyEmailDomain(), DISPOSABLE_EMAIL_DOMAINS, disposableEmailDomainSet, EmailType, extractEmailDomain(), PERSONAL_EMAIL_DOMAINS (+74 more)
...
Cohesion: 0.04
Nodes (75): app, app, apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES (+67 more)
...
Cohesion: 0.05
Nodes (59): appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, app, appGlobal (+51 more)
...
Cohesion: 0.05
Nodes (87): withGlobalPermissions(), replaceApiKeyGlobalPermissionsForExistingBindings(), checkWriteAppAccess(), getAppOwnerOrg(), getNotificationProviderConfigs(), getNotificationSettings(), publicNotificationSettings(), upsertNotificationSettings() (+79 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (79): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncBillingBentoTags(), syncBillingBentoTagsFromStoredStripeInfo(), addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured() (+71 more)
...
Cohesion: 0.04
Nodes (61): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+53 more)
...
Cohesion: 0.05
Nodes (60): filterDeviceKeys(), get(), GetDevice, publicDevice, getUpdateStatsCF(), isDemoApp(), isDemoAppRow(), assertAnalyticsEngineReadConfig() (+52 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (60): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult, deleteChannelSelfOverrideForDevice() (+52 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (56): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+48 more)
...
Cohesion: 0.07
Nodes (57): AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6, parseBodyRaw(), post(), PostResult (+49 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (41): { closeClientMock, sendNotifOrgMock, sendNotifToOrgMembersOnceMock }, requestPluginNotifications(), getPluginNotificationItemResult(), PluginNotificationBatchBody, PluginNotificationItemResult, PluginNotificationSendResult, processPluginNotifications(), sendQueuedPluginNotification() (+33 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (57): BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), cancelingOrFinished(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+49 more)
...
Cohesion: 0.05
Nodes (45): cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, seedPlainApiKey(), id, semverApiKey (+37 more)
...
Cohesion: 0.06
Nodes (51): baseDecision, buildReason(), evaluateChannel(), getRolloutVersionName(), getWindowStart(), normalizeAction(), RolloutAutoPauseChannel, __rolloutAutoPauseTestUtils__ (+43 more)
...
Cohesion: 0.07
Nodes (44): checkAlerts(), checkVersionStatus(), VersionCheckResult, computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies() (+36 more)
...
Cohesion: 0.06
Nodes (38): fetchUploadHandlerWithRetry(), recoverUploadOffsetFromDurableObject(), uploadHandler(), ensureOrgMembership(), ensureOrgMembershipInTransaction(), EnsureOrgMembershipResult, ensurePublicUserRowExists(), ensurePublicUserRowExistsInTransaction() (+30 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (43): CacheStore, assertSubkeyHasPlaintextSecret(), checkKeyByIdPg(), checkKeyPg(), FindApikeyByValueResult, foundAPIKey(), foundJWT(), getAppIdFromRequest() (+35 more)
...
Cohesion: 0.12
Nodes (34): checkIfExist(), deleteObject(), deleteObjectsWithPrefix(), firstForwardedHeaderValue(), getObject(), getSignedUrl(), getSize(), getSizeDiagnostics() (+26 more)
...
Cohesion: 0.07
Nodes (28): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensureOrgMembership(), ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), legacyInviteToRbac (+20 more)
...
}, DeletedVersionAction, getManifestEntryCount(), getMetadataBranch(), handleManifest(), resolveOwnerOrg(), updateIt(), v2PathSize() (+21 more)
...
Cohesion: 0.11
Nodes (28): clearSavedKey(), ensureGitignored(), getLoginState(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage() (+20 more)
...
Cohesion: 0.15
Nodes (27): assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), logDeviceRequestContext(), recordDeviceIPRateLimit(), recordDeviceRateLimitSafely(), assertChannelSelfIPRateLimit(), parseChannelSelfPluginRequest() (+19 more)
...
Cohesion: 0.12
Nodes (21): SimpleErrorResponse, drizzleErrorNames, filesUploadFunctionNames, parsePositiveInteger(), queueRetryHeaderNames, readRequestHeader(), sensitiveRequestBodyKeys, shouldSuppressQueueRetryAlert() (+13 more)
...
Cohesion: 0.16
Nodes (13): compareNativePackages(), CompatibilitySummary, DeploymentHistoryEntry, DeploymentPair, getIncompatibilityReasons(), IncompatibilityReason, NativePackage, PackageComparison (+5 more)
...
Cohesion: 0.22
Nodes (6): app, AppContext, getInviteResendRequiredPermission(), inviteExistingUserSchema, inviteNotificationCooldowns, validateRequest()
...
- **Why does `Database` connect `Community 7` to `Community 2`, `Community 391`, `Community 135`, `Community 9`, `Community 138`, `Community 140`, `Community 14`, `Community 15`, `Community 17`, `Community 21`, `Community 282`, `Community 28`, `Community 36`, `Community 37`, `Community 42`, `Community 48`, `Community 178`, `Community 55`, `Community 59`, `Community 62`, `Community 70`, `Community 78`, `Community 210`, `Community 341`, `Community 98`, `Community 354`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.024015077821011675 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.021446788778112683 - nodes in this community are weakly interconnected._
