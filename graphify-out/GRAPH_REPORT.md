...
## Corpus Check
- Large corpus: 2105 files · ~4,201,742 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 11438 nodes · 24142 edges · 713 communities (594 shown, 119 thin omitted)
...
## Communities (713 total, 119 thin omitted)
...
Cohesion: 0.02
Nodes (228): checkAppIdsExist(), completePendingOnboardingApp(), ExistingOrganizationApp, findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), PendingOnboardingApp, buildAppIdConflictSuggestions() (+220 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (156): installMcpStdoutGuard(), AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, appSettingOptionsSchema, mcpLoginInputSchema, mcpLogoutInputSchema, saveScopeSchema (+148 more)
...
Cohesion: 0.03
Nodes (162): filterDeviceKeys(), get(), GetDevice, publicDevice, formatBytes(), formatNumber(), funComparisons, getFunComparison() (+154 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (112): appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, app, appGlobal (+104 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (131): getInvocationSource(), check2FAComplianceForApp(), checkAppExists(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), resolveAppSetIconPath(), Channel, checkVersionNotUsedInChannel() (+123 more)
...
Cohesion: 0.04
Nodes (101): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), app, app (+93 more)
...
Cohesion: 0.04
Nodes (117): deleteBodySchema, deleteMember(), bodySchema, get(), memberSchema, inviteBodySchema, LegacyInviteRole, _legacyInviteRoles (+109 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (116): areGlobalStatsNumbersDifferent(), BillingSnapshotCounts, BillingSnapshotCustomerCounts, BillingSnapshotRow, buildLogsnagInsightsRetryMessage(), buildRecentGlobalStatsRepairDateIds(), BuildShardStats, BuildStats (+108 more)
...
Cohesion: 0.04
Nodes (93): app, app, apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor, ORG_CREATE_ROLE_NAMES (+85 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (102): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, SAMPLE_REFERENCE_DATE, AdminStatsBody, adminStatsBodySchema, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels (+94 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (82): createRSA(), setSetting(), setSettingInternal(), loadConfig(), writeConfig(), writeConfigUpdater(), syncPendingAppIdToCapacitorConfig(), AppSettingOptions (+74 more)
...
Cohesion: 0.04
Nodes (81): classifyEmailAddress(), classifyEmailDomain(), DISPOSABLE_EMAIL_DOMAINS, disposableEmailDomainSet, EmailType, extractEmailDomain(), PERSONAL_EMAIL_DOMAINS, personalEmailDomainSet (+73 more)
...
Cohesion: 0.05
Nodes (67): AppWithOrg, checkEncryptedBundleEnforcement(), checkVersionExists(), createBundle(), CreateBundleBody, getAppOrganization(), insertBundle(), validateUrlFormat() (+59 more)
...
Cohesion: 0.05
Nodes (61): appVersion, channelSelfGetSchema, ChannelSelfPayload, channelSelfQuery, getContext, manifestEntries, postContext, statsPayload (+53 more)
...
Cohesion: 0.04
Nodes (53): actionToFilter, failureActionFilterKeys, failureActions, filterToAction, statsActionFilters, Awaitable, ChannelInfo, ChannelsListResponse (+45 more)
...
Cohesion: 0.04
Nodes (48): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, seedPlainApiKey(), id (+40 more)
...
Cohesion: 0.05
Nodes (48): app, AppUsageByVersion, ChannelStatsRequest, channelStatsTestUtils, DeploymentHistoryEntry, generateDateLabels(), getStatsPeriod(), StatsPeriodDays (+40 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (55): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+47 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (55): DeliveryMessage, serializeError(), allowLocalWebhookUrls(), AuditLogData, base64Encode(), buildWebhookDeliveryPayload(), buildWebhookPayload(), bytesToArrayBuffer() (+47 more)
...
Cohesion: 0.05
Nodes (42): app, ResolvedTrackingId, resolveTrackingUserId(), TrackEventBody, base, base, buildBuilderOnboardingBentoEvent(), BUILDER_RECOVERY_MILESTONES (+34 more)
...
Cohesion: 0.05
Nodes (53): plans, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+45 more)
...
Cohesion: 0.06
Nodes (38): createAuthenticatedSupabaseClient(), clearCronStatAppMessages(), countCronStatAppMessages(), countStatsRefreshAuditLogs(), getAppRefreshState(), orgId, deleteUserAs(), withAuthClient() (+30 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (41): TableColumn, setLog(), stepToName(), addNewApiKey(), clearWatchers(), copyToast(), onInviteSuccess(), scrollToElement() (+33 more)

### Community 38 - "Community 38"
Cohesion: 0.08
Nodes (50): sendQueuedPluginNotification(), trackBentoEvent(), buildNotifCacheRequest(), claimNotifOrgOnce(), EventData, getNotifCacheStatus(), getNotification(), getSecondsUntilNextCronWindow() (+42 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (50): onManifestCreateTestUtils, delete_queue_message_batch(), DISCORD_IGNORED_ERROR_CODES, dispatchQueueMessage(), extractErrorDetails(), extractMessageBody(), FailureDetail, generateUUID() (+42 more)
...
Cohesion: 0.07
Nodes (45): clearSavedKey(), ensureGitignored(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage(), readKeyFile() (+37 more)
...
Cohesion: 0.09
Nodes (43): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, Platform (+35 more)
...
Cohesion: 0.10
Nodes (45): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult, deleteChannelSelfOverrideForDevice() (+37 more)
...
Cohesion: 0.09
Nodes (42): post(), appVersion, manifest, AppStatus, AppStatusCachePayload, AppStatusResult, buildAppStatusRequest(), deleteAppStatus() (+34 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (43): apiKeyHasAnyAppPermission(), ApiKeyPermissionMode, ApiKeyRow, buildCompatibilityResult(), buildUploadPayload(), buildZipBuffer(), CAPACITOR_CONFIG_PATH, ChannelVersionRow (+35 more)
...
Cohesion: 0.08
Nodes (33): AppStatusResult, BatchStatsResult, blockProviderInfrastructure(), DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6, parseBodyRaw(), PostResult, shouldRecordStatsAction() (+25 more)
...
Cohesion: 0.09
Nodes (30): streamCommandInInitPanel(), appendInitStreamingLine(), clearPrompt(), emit(), ensureInitInkSession(), INIT_CANCEL, InitCodeDiff, InitCodeDiffLine (+22 more)
...
Cohesion: 0.11
Nodes (27): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncBillingBentoTags(), addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured(), syncBentoSubscriberTags() (+19 more)
...
Cohesion: 0.12
Nodes (22): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), checkIndexPosition(), searchInDirectory() (+14 more)
...
Cohesion: 0.10
Nodes (20): ALLOWED_METHODS, AppScopedAttachmentPath, AsyncLock, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart, EXPOSED_HEADERS, FinalPart (+12 more)
...
Cohesion: 0.15
Nodes (23): dispatchLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShards(), dispatchMissingLogsnagInsightsShardsFor(), dispatchMissingLogsnagInsightsUsageShards(), filterCandidateGlobalStatsShards(), getEmptyBuildShardStats(), getGlobalStatsRepairShardQueueCandidates(), getGlobalStatsShardQueueCandidates() (+15 more)
...
Cohesion: 0.14
Nodes (13): ConfirmPrompt, InitLogTone, InitStreamingOutput, encryptionPhaseColor(), EncryptionSummaryPanel(), InitInkAppProps, colorForTone(), CurrentStepSection() (+5 more)
...
Cohesion: 0.13
Nodes (18): apiFetch(), appKeyBody(), BASE_ORG_ID, deleteSeededApiKeys(), id, keyName(), orgKeyBody(), POLICY_ORG_ID (+10 more)
...
Cohesion: 0.16
Nodes (14): mockContext, mockContext, honoFactory, MiddlewareKeyVariablesStripe, middlewareStripeWebhook(), extractDataEvent(), getLicensedSubscriptionItem(), getSubscriptionEndDate() (+6 more)
...
## Knowledge Gaps
- **3869 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3864 more)
...
- **Why does `Database` connect `Community 6` to `Community 2`, `Community 390`, `Community 12`, `Community 141`, `Community 15`, `Community 144`, `Community 18`, `Community 21`, `Community 23`, `Community 24`, `Community 153`, `Community 26`, `Community 409`, `Community 31`, `Community 36`, `Community 37`, `Community 49`, `Community 51`, `Community 59`, `Community 191`, `Community 64`, `Community 67`, `Community 78`, `Community 214`, `Community 342`, `Community 354`, `Community 99`?**
...
- **What connects `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude` to the rest of the system?**
  _3872 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.003992015968063872 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.024620651064810244 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.021155655938264635 - nodes in this community are weakly interconnected._
