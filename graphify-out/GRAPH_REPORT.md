...
## Corpus Check
- Large corpus: 1727 files · ~3,464,642 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 8646 nodes · 18841 edges · 558 communities (468 shown, 90 thin omitted)
...
Cohesion: 0.02
Nodes (139): AppDebugOptions, appDebugOptionsSchema, appOptionsSchema, AppSettingOptions, appSettingOptionsSchema, optionsBaseSchema, AllCredentials, allCredentialsSchema (+131 more)
...
Cohesion: 0.03
Nodes (98): appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, app (+90 more)
...
Cohesion: 0.05
Nodes (81): app, appPrivate, appTriggers, app, DataUpload, app, app, DataUpload (+73 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (94): bodySchema, get(), memberSchema, auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), canAccessRequestedOrg() (+86 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (88): ExistingOrganizationApp, PendingOnboardingApp, addCodeChangeStep(), addCodeStep(), applyInitAutoTestChange(), askForAppId(), askForAppName(), askForWebDir() (+80 more)
...
Cohesion: 0.05
Nodes (67): AdminAppsTrend, AdminBandwidthTrend, AdminBundlesTrend, AdminDistributionMetrics, AdminFailureMetrics, AdminMauTrend, AdminOrgMetrics, AdminPlatformOverview (+59 more)
...
Cohesion: 0.05
Nodes (53): app, AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId() (+45 more)
...
Cohesion: 0.05
Nodes (39): TEST_ORG_ID, cleanupTestData(), createdKeyIds, setupTestOrg(), TEST_ID, TEST_ORG_ID, createChannel(), versionCache (+31 more)

### Community 34 - "Community 34"
Cohesion: 0.10
Nodes (50): checkAppIdsExist(), completePendingOnboardingApp(), checkVersionStatus(), cancelCommand(), markSnag(), wait(), waitLog(), addAppStep() (+42 more)
...
Cohesion: 0.08
Nodes (39): rollbackCreatedUser(), getCurrentChannel(), getCurrentPublicWinner(), buildIlikeContainsPattern(), checkApikeyMeetsOrgPolicy(), checkAppOwner(), createStripeCustomer(), customerToSegmentOrg() (+31 more)
...
Cohesion: 0.10
Nodes (28): VersionCheckResult, addOrganization(), deleteOrganization(), deleteOrganizationInternal(), displayOrganizations(), listOrganizations(), listOrganizationsInternal(), displayMembers() (+20 more)
...
Cohesion: 0.07
Nodes (24): app, ResolvedTrackingId, resolveTrackingUserId(), TrackEventBody, base, base, buildBuilderOnboardingBentoEvent(), BUILDER_RECOVERY_MILESTONES (+16 more)
...
Cohesion: 0.13
Nodes (16): CacheHelper, CacheKeyParams, CacheLike, resolveGlobalCache(), buildChannelSelfCacheRequest(), buildChannelSelfStoreKey(), ChannelSelfContext, ChannelSelfOverride (+8 more)
...
Cohesion: 0.08
Nodes (17): id, RBAC_ORG_ID, createOrgBoundApiKey(), createStatsAppReadKey(), createDirectApiKeyWithBindings(), fetchBundle(), globalId, WEBHOOK_TEST_ORG_ID (+9 more)
...
Cohesion: 0.26
Nodes (16): getCapacitorRunTargetListWithStatus(), getRunDeviceCommand(), getRunTargetLabel(), getSkippedRunDeviceCommand(), handleCapacitorRunTargets(), handleMissingCapacitorRunTargets(), handleMissingPhysicalIosRunTargets(), handleMissingSimulatorIosRunTargets() (+8 more)
...
Cohesion: 0.43
Nodes (6): PARTIALLY_REDACTED_FIELDS, partialRedact(), REMOVED_FIELDS, sanitizeSensitiveFromString(), sanitizeSensitiveHeaders(), sendDiscordAlert500()
...
Cohesion: 0.60
Nodes (4): Bindings, honoFactory, MiddlewareKeyVariablesStripe, StripeData
...
## Knowledge Gaps
- **3019 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3014 more)
...
- **Why does `log` connect `Community 71` to `Community 25`, `Community 10`, `Community 15`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.023382594417077174 - nodes in this community are weakly interconnected._