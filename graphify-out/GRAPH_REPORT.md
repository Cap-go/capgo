...
## Corpus Check
- Large corpus: 2108 files · ~4,208,091 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 11473 nodes · 24218 edges · 723 communities (602 shown, 121 thin omitted)
...
## Communities (723 total, 121 thin omitted)
...
Cohesion: 0.02
Nodes (231): checkAppIdsExist(), completePendingOnboardingApp(), findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), cancelCommand(), markSnag(), waitLog() (+223 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (222): replaceApiKeyGlobalPermissionsForExistingBindings(), setChannel(), SetChannelBody, checkWriteAppAccess(), assertAppPermission(), assertOptionalDate(), assertString(), createCampaignRecord() (+214 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (168): AcceptInvitation, app, baseInvitationSchema, DEFAULT_PASSWORD_POLICY, ensureOrgMembership(), ensurePublicUserRowExists(), isMissingCreatedViaInviteColumnError(), legacyInviteToRbac (+160 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (159): Channel, setSetting(), SuperOptions, buildServerInstructions(), installMcpStdoutGuard(), AppDebugOptions, appDebugOptionsSchema, AppOptions (+151 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (169): assertRecognizedRows(), createDemoApp, daysAgoDate(), DEMO_FILE_HASHES, DemoChannel, DemoManifestEntry, DemoNativePackage, DemoVersion (+161 more)
...
Cohesion: 0.03
Nodes (128): app, appPrivate, appScheduled, appTriggers, runScheduledPluginNotificationFlush(), scheduled(), deleteBodySchema, DataUpload (+120 more)
...
Cohesion: 0.05
Nodes (109): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), ExistingOrganizationApp, getAppIconStoragePath(), PendingOnboardingApp, resolveAppSetIconPath(), checkVersionNotUsedInChannel(), CheckVersionOptions (+101 more)
...
Cohesion: 0.04
Nodes (106): AppOwnerResult, AppStatusResult, assertChannelSelfAppOwnerPlanValid(), assertChannelSelfCachedStatus(), assertChannelSelfIPRateLimit(), blockProviderInfrastructure(), ChannelSelfDeviceOperation, ChannelSelfOverrideResult (+98 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (107): getChannelPreviewVersionId(), formatBytes(), formatNumber(), funComparisons, getFunComparison(), getOrgIdForApp(), handleBillingPeriodStats(), handleDailyFailRatio() (+99 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (96): AnalyticsEngineSqlCapture, AnalyticsEngineSqlFixture, collectAnalyticsEngineSqlFixtures(), createMockContext(), installAnalyticsEngineSqlCapture(), SAMPLE_REFERENCE_DATE, adminStatsBodySchema, AdminAppsTrend (+88 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (84): app, canAccessRequestedOrg(), ResolvedTrackingId, TrackEventBody, DeliveryMessage, AuthInfo, broadcastCLIEvent(), CLIActivityPayload (+76 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (82): classifyEmailAddress(), classifyEmailDomain(), DISPOSABLE_EMAIL_DOMAINS, disposableEmailDomainSet, EmailType, extractEmailDomain(), PERSONAL_EMAIL_DOMAINS, personalEmailDomainSet (+74 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (74): computeDoctorAnalyticsTags(), DoctorInfoOptions, getInfo(), getInfoInternal(), getInstalledDependencies(), getLatestDependencies(), findMonorepoRoot, findNXMonorepoRoot (+66 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (56): appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal, appGlobal (+48 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (66): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), getGlobalAnalyticsProps(), GlobalAnalyticsProps, InvocationSource (+58 more)
...
Cohesion: 0.05
Nodes (63): CheckDomainResponse, spoof(), fetchLinkedChannelsForVersion(), LinkedChannel, mergeLinkedChannels(), CreditMetricType, getFirstTierCreditUnitPricing(), sortCreditPricingSteps() (+55 more)
...
Cohesion: 0.06
Nodes (63): existingRow, fullDevice, sparseDevice, sparseExisting, simulateReplicaStorage(), countUpdatesFromLogsCF(), countUpdatesFromLogsExternalCF(), serializeStatsMetadata() (+55 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (59): clearSavedKey(), ensureGitignored(), globalKeyPath(), KeySource, LoginState, loginSuccessMessage(), logoutMessage(), readKeyFile() (+51 more)
...
Cohesion: 0.05
Nodes (56): plans, BentoSegmentUpdate, BentoSubscriberTagUpdate, buildBillingBentoTagUpdates(), buildStripeInfoUpdateStatement(), buildSubscriptionEventMetadata(), checkoutSessionEventTypes, CHURNED_SUBSCRIPTION_STATUSES (+48 more)
...
Cohesion: 0.07
Nodes (39): CacheStore, CacheHelper, CacheKeyParams, CacheLike, resolveGlobalCache(), buildIpRateRequest(), buildOperationRateRequest(), buildSameSetRequest() (+31 more)
...
Cohesion: 0.08
Nodes (35): app, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor (+27 more)
...
Cohesion: 0.11
Nodes (32): getInvocationSource(), checkAppExists(), checkAlerts(), checkVersionStatus(), VersionCheckResult, addApp(), addAppInternal(), AppCreateSource (+24 more)
...
Cohesion: 0.10
Nodes (33): app, assertDeviceIPRateLimit(), assertDeviceOperationRateLimit(), handleDeviceOperation(), logDeviceRequestContext(), recordDeviceIPRateLimit(), recordDeviceRateLimitSafely(), assertPublicPluginApp() (+25 more)
...
Cohesion: 0.10
Nodes (30): getOrgAdminMemberEmailsForTagsMock, syncBentoSubscriberTagsMock, syncBillingBentoTags(), syncBillingBentoTagsFromStoredStripeInfo(), addTagBento(), bentoFetch(), getBentoHeaders(), isBentoConfigured() (+22 more)
...
Cohesion: 0.10
Nodes (24): invalidBindingIdHook, AssignablePrincipal, canManageRoleBindingScope(), CreateBindingResult, createRoleBindingForPrincipal(), getCallerMaxPriorityRank(), getLegacyChannelRowId(), isSupportedChannelId() (+16 more)
...
Cohesion: 0.09
Nodes (21): ConfirmPrompt, InitCodeDiff, InitEncryptionSummary, InitLogTone, InitRuntimeState, InitScreen, InitScreenTone, InitStreamingOutput (+13 more)
...
Cohesion: 0.09
Nodes (21): isRetryableDurableObjectFetchError(), ALLOWED_HEADERS, ALLOWED_METHODS, AppScopedAttachmentPath, AsyncLock, AttachmentHeadReader, encodeR2KeyForUploadLocation(), ErrorPart (+13 more)
...
Cohesion: 0.13
Nodes (16): confirmMessage(), contactSupport(), ContactSupportDeps, ContactSupportResult, fitBodyPrefix(), resetSupportUploadCacheForTests(), runContactSupport(), buildHelpMenuOptions() (+8 more)
...
Cohesion: 0.14
Nodes (20): createRSA(), loadConfig(), writeConfig(), writeConfigUpdater(), CapacitorConfig, capacitorConfigSchema, ExtConfigPairs, extConfigPairsSchema (+12 more)
...
Cohesion: 0.13
Nodes (18): streamCommandInInitPanel(), appendInitStreamingLine(), clearInitStreamingOutput(), clearPrompt(), emit(), InitCodeDiffLine, InitEncryptionPhase, InitLogEntry (+10 more)
...
Cohesion: 0.15
Nodes (15): Digester, noopDigester(), sha256Digester(), setKeyFromMetadata(), parseChecksum(), parseUploadMetadata(), UploadMetadata, Env (+7 more)
...
Cohesion: 0.15
Nodes (17): ChoiceOption, CollectField, LIVE_UPDATE_ROADMAP, LIVE_UPDATE_RULES, LiveUpdatePhase, NextAction, NextStepResult, redactSecretContext() (+9 more)
...
Cohesion: 0.27
Nodes (15): decideAdvance(), decideAtStep(), decideStart(), drive(), mergeProgress(), nextAction(), runAutoEffect(), runStart() (+7 more)
...
Cohesion: 0.17
Nodes (14): ConfirmOptions, log, PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone, TextOptions (+6 more)
...
Cohesion: 0.14
Nodes (4): clearAllSessions(), test(), test(), test()
...
Cohesion: 0.29
Nodes (6): app, invalidScopeTypeHook, roleScopeParamSchema, app, app, schema
...
Cohesion: 0.38
Nodes (6): LiveUpdateFacts, clearLiveUpdateProgress(), ensureTmpPath(), LiveUpdateProgress, loadLiveUpdateProgress(), saveLiveUpdateProgress()
...
## Knowledge Gaps
- **3874 isolated node(s):** `@upstash/context7-mcp`, `@agentdeskai/browser-tools-mcp`, `claude`, `@modelcontextprotocol/server-postgres`, `priorityPaths` (+3869 more)
...
- **Why does `Database` connect `Community 10` to `Community 128`, `Community 130`, `Community 132`, `Community 4`, `Community 11`, `Community 396`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 287`, `Community 31`, `Community 33`, `Community 41`, `Community 42`, `Community 47`, `Community 52`, `Community 65`, `Community 75`, `Community 332`, `Community 77`, `Community 211`, `Community 90`, `Community 347`, `Community 91`, `Community 362`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.024473534433693798 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.02168121947609886 - nodes in this community are weakly interconnected._
- **Should `Community 3` be split into smaller, more focused modules?**
  _Cohesion score 0.018690760917707504 - nodes in this community are weakly interconnected._