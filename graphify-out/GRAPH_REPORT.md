...
## Corpus Check
- Large corpus: 1725 files · ~3,464,103 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 8640 nodes · 18836 edges · 548 communities (462 shown, 86 thin omitted)
...
## Communities (548 total, 86 thin omitted)
...
Cohesion: 0.02
Nodes (252): checkAppIdsExist(), completePendingOnboardingApp(), ExistingOrganizationApp, findAppInOrganization(), isMissingOnboardingSchemaError(), listPendingOnboardingApps(), PendingOnboardingApp, markSnag() (+244 more)
...
Cohesion: 0.03
Nodes (116): app, appPrivate, appTriggers, app, appGlobal, app, appGlobal, app (+108 more)
...
Cohesion: 0.03
Nodes (152): filterDeviceKeys(), get(), GetDevice, publicDevice, BatchStatsResult, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION, DOWNLOAD_FAIL_FIXED_PLUGIN_VERSION_V6, parseBodyRaw() (+144 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (126): app, app, withGlobalPermissions(), apiKeyBindingsAllowOrgCreate(), ApiKeyGlobalPermissionBinding, assertApiKeyCanKeepOrgCreateGrant(), attachApiKeyGlobalPermissions(), DrizzleExecutor (+118 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (111): get(), getAll(), CreateApp, post(), put(), UpdateApp, AppWithOrg, checkEncryptedBundleEnforcement() (+103 more)
...
Cohesion: 0.07
Nodes (101): check2FAComplianceForApp(), checkAppExistsAndHasPermissionOrgErr(), getAppIconStoragePath(), checkVersionNotUsedInChannel(), CheckVersionOptions, createChannel(), delChannel(), delChannelDevices() (+93 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (89): categorizeCliError(), categorizeHttpStatus(), CliErrorCategory, getMessage(), getStatus(), OrgResolverDeps, ownerOrgCache, resolveOwnerOrgId() (+81 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (95): calcKeyId(), encryptChecksum(), encryptChecksumV3(), encryptSource(), generateSessionKey(), RSAKeys, bundleVersions, checksumPayload (+87 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (88): auditLogSchema, auditLogsSchema, bodySchema, getAuditLogs(), DeliveryMessage, assertSyncResult(), parseSchemaAsync(), safeParseSchema() (+80 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (74): DataUpload, DataUpload, checkDomainRateLimit(), app, CreditUsageAlertPayload, EVENT_BY_THRESHOLD, app, decodePathSegment() (+66 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (71): ALLOWED_ATTRIBUTE_KEYS, createBodySchema, parseAttributeMapping(), requireManageSsoPermission(), updateBodySchema, uuidSchema, ensureOrgMembership(), ensureOrgMembershipInTransaction() (+63 more)
...
Cohesion: 0.04
Nodes (67): AppContext, CompleteTopUpRequest, CostCalculationRequest, CostCalculationResponse, CreditStep, getCheckoutSessionPaymentIntentId(), getCreditTopUpProductId(), getScopedCreditSteps() (+59 more)
...
Cohesion: 0.06
Nodes (55): getInvocationSource(), checkAppExists(), createRSA(), checkAlerts(), checkVersionStatus(), VersionCheckResult, addApp(), addAppInternal() (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (48): apiFetch(), appKeyBody(), BASE_ORG_ID, deleteSeededApiKeys(), id, keyName(), orgKeyBody(), POLICY_ORG_ID (+40 more)
...
Cohesion: 0.05
Nodes (45): readInitInternalLogLines(), DependencySection, getDeclaredDependency(), PackageJsonDependencies, readInstalledPackageVersion(), readPackageJson(), UpdaterInstallState, appendBulletedSection() (+37 more)
...
Cohesion: 0.04
Nodes (44): Awaitable, ChannelInfo, ChannelsListResponse, getUniqueBaseData(), id, headers, id, TEST_ORG_ID (+36 more)
...
Cohesion: 0.07
Nodes (37): Actives, app, BuildStats, calculateChurnRevenue(), calculateConversionRate(), calculateNrr(), calculateRevenue(), CurrentDayWindow (+29 more)
...
Cohesion: 0.10
Nodes (29): streamCommandInInitPanel(), ConfirmOptions, PromptResult, SelectOption, SelectOptions, SpinnerController, SpinnerTone, TextOptions (+21 more)
...
Cohesion: 0.11
Nodes (24): AdminStatsBody, CancellationDetails, cancellationFeedbackLabels, cancellationReasonLabels, isoUtcDatetimeSchema, limitSchema, metricCategories, offsetSchema (+16 more)
...
Cohesion: 0.15
Nodes (21): assertChannelSelfIPRateLimit(), parseChannelSelfPluginRequest(), recordChannelSelfIPRateLimit(), recordChannelSelfRequestSafely(), buildIpRateRequest(), buildOperationRateRequest(), buildSameSetRequest(), ChannelSelfIPRateLimitStatus (+13 more)
...
Cohesion: 0.18
Nodes (11): setSetting(), loadConfig(), writeConfig(), AppSettingOptions, CapacitorConfig, capacitorConfigSchema, ExtConfigPairs, extConfigPairsSchema (+3 more)
...
Cohesion: 0.18
Nodes (11): inviteUserSchema, LegacyInviteRole, legacyInviteRoles, legacyRoleToRbac, RbacInviteRole, rbacInviteRoles, rbacRoleToLegacy, resolveInviteRoles() (+3 more)
...
Cohesion: 0.25
Nodes (8): PARTIALLY_REDACTED_FIELDS, partialRedact(), REMOVED_FIELDS, sanitizeSensitiveFromString(), sanitizeSensitiveHeaders(), sendDiscordAlert500(), drizzleErrorNames, filesUploadFunctionNames
...
- **Why does `Database` connect `Community 9` to `Community 1`, `Community 2`, `Community 133`, `Community 261`, `Community 10`, `Community 11`, `Community 15`, `Community 19`, `Community 21`, `Community 23`, `Community 280`, `Community 24`, `Community 29`, `Community 30`, `Community 32`, `Community 35`, `Community 36`, `Community 192`, `Community 68`, `Community 81`, `Community 82`, `Community 85`, `Community 236`, `Community 252`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `getCreditTopUpProductId()` connect `Community 20` to `Community 129`, `Community 3`, `Community 14`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `log` connect `Community 129` to `Community 1`, `Community 20`, `Community 61`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.020532514080901176 - nodes in this community are weakly interconnected._