...
// Dedicated data for SSO management tests (isolated to prevent interference with parallel tests)
export const SSO_TEST_ORG_ID = 'a8b9c0d1-e2f3-4a5b-9c6d-7e8f9a0b1c2d'
export const SSO_TEST_CUSTOMER_ID = 'cus_sso_test_123'
export const SSO_TEST_DOMAIN = 'ssotest-seeded.example.com'
export const SSO_TEST_ORG_NAME = 'SSO Test Org'
